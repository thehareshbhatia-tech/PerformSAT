...
export const mathChapters = [
  // ── Algebra ────────────────────────────────────────────────────────────────
  {
    ...
    blurb: 'Fractions, negative signs, order of operations, the number line, and the coordinate plane — the quiet arithmetic every other math question is built on.',
    readMinutes: 10,
    cbSkills: [],
  ...
  },
  {
    ...
    blurb: 'Slope, intercepts, and the equation of a line — writing, converting, and interpreting linear relationships.',
    readMinutes: 5,
  ...
  // ── Advanced Math ───────────────────────────────────────────────────────────
  {
    ...
    blurb: 'Expand, factor, and re-shape expressions — including the binomial templates, rational expressions, and coefficient-matching moves the SAT leans on.',
    readMinutes: 6,
  ...
  },
  {
    ...
    blurb: 'Solve any quadratic — factoring, the quadratic formula, completing the square — then read graphs for vertex, roots, and end behavior.',
    readMinutes: 8,
  ...
  },
  {
    ...
    readMinutes: 5,
    cbSkills: ['nonlinear-equations', 'equivalent-expressions'],
  ...
  },
  {
    ...
    unitId: 'math-problem-solving',
    title: 'Probability',
    blurb: 'Fix the pool before counting — complements, unions, two-way tables, conditional probability, and draws without replacement.',
    readMinutes: 8,
