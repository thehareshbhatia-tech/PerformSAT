 ...
 *
 * The heavy chapter BODIES live in ./rwBodies/ (source.kind 'rwBody',
 * keyed by chapter id) and are dynamic-imported by ChapterReader — keep this
 * module light and NEVER import the rwBodies corpus from here.
...
export const rwChapters = [
...

  {
    ...
    source: { kind: 'rwBody', bodyId: 'rw-central-ideas' },
  },

  {
    ...
    readMinutes: 17,
    cbSkills: ['inferences'],
    source: { kind: 'rwBody', bodyId: 'rw-inferences' },
  },

  {
    ...
    source: { kind: 'rwBody', bodyId: 'rw-command-of-evidence-textual' },
  },

  {
    ...
    source: { kind: 'rwBody', bodyId: 'rw-command-of-evidence-quantitative' },
  },
...

  {
    ...
    source: { kind: 'rwBody', bodyId: 'rw-words-in-context' },
  },

  {
    ...
    source: { kind: 'rwBody', bodyId: 'rw-text-structure-and-purpose' },
  },

  {
    ...
    source: { kind: 'rwBody', bodyId: 'rw-cross-text-connections' },
  },
...

  {
    ...
    source: { kind: 'rwBody', bodyId: 'rw-transitions' },
  },

  {
    ...
    source: { kind: 'rwBody', bodyId: 'rw-rhetorical-synthesis' },
  },
...

  {
    ...
    source: { kind: 'rwBody', bodyId: 'rw-form-structure-and-sense' },
  },
];
