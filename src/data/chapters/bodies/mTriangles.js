...
export const mTrianglesBlocks = [
  ...
  {
    type: 'text',
    content: "Figure 1 fixes the three side roles, and the direction of the algebra depends on which side is missing. Solving for the hypotenuse means adding the squared legs; solving for a leg means subtracting instead, $b^2 = c^2 - a^2$ — and under time pressure, plenty of students add by reflex either way.",
  },
  {
    type: 'aside',
    kind: 'watch',
  ...
  {
    type: 'text',
    content: "Two triangles whose angles match are **similar** — one is a scaled copy of the other, so every pair of corresponding sides shares the same ratio. Matching **two** angles is enough to establish it, because the angle sum forces the third pair to match on its own. Once similarity is established, a missing side follows from a single proportion. Figure 3 marks the matching angles and the corresponding sides.",
  },
  {
    type: 'diagramRef',
  ...
  },
  {
    type: 'list',
    items: [
      '**The parallel cut.** A line parallel to one side of a triangle crosses the other two sides and slices off a smaller triangle similar to the whole — the worked example below is this figure.',
  ...
  {
    type: 'summary',
    title: 'The whole skill in three moves',
    points: [
      '**Read what the figure provides** — two angles, a pair of equal sides, a right angle, or a shared angle with a parallel line.',
      '**Pick the one tool** that configuration calls for; a Pythagorean triple or special-triangle ratio often replaces the whole calculation.',
      '**Check the ordering facts**: the longest side lies opposite the largest angle, no leg exceeds the hypotenuse, and no side reaches the sum of the other two.',
    ],
  },
];
