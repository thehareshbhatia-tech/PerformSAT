      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            ['a₁/a₂ ≠ b₁/b₂', 'Any', '**One unique solution**'],
          ],
        },
        {
          type: 'keyInsight',
    ...
    workedExamples: {
      ...
      blocks: [
        ...
        },
        {
          ...
          steps: [
            { label: 'Condition', content: 'No solution → coefficient ratios equal, constant ratios not: **3/6 = k/(−8) ≠ 15/10**.' },
            { label: 'Solve', content: '1/2 = k/(−8) → k = **−4**.' },
            { label: 'Verify not infinite', content: 'Constant ratio: 15/10 = 3/2 ≠ 1/2. Constants differ → confirmed **no solution**.' },
            { label: 'Check', content: 'With k = −4: multiply first equation by 2 → 6x − 8y = 30 ≠ 10. Parallel lines ✓.' },
          ],
        },
      ],
    },
