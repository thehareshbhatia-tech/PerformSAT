  ...
  sections: {
    coreConcepts: {
      ...
      blocks: [
        ...
        },
        {
          type: 'formulaGrid',
          items: [
            { label: 'Percent Increase', formula: 'New = Original × (1 + r)', note: 'r = rate as decimal' },
            { label: 'Percent Decrease', formula: 'New = Original × (1 − r)', note: 'r = rate as decimal' },
            { label: 'Percent Change', formula: '(New − Old) / Old × 100%', note: 'Always divide by original' },
            { label: 'Successive Changes', formula: 'Final = Original × m₁ × m₂ × …', note: 'Multiply multipliers; never add percents' },
          ],
        },
        {
          type: 'keyInsight',
          content: 'Every percent change is a single **multiplier**. +25% → ×1.25. −40% → ×0.60. Thinking in multipliers unifies increases, decreases, reversals, and chains into one operation.',
        },
        {
          type: 'formula',
    ...
    methods: {
      ...
      blocks: [
        { type: 'heading', content: 'Method 1: Word-to-Equation Translation' },
        {
          ...
          items: [
            'Replace **"what"** with x, **"is"** with =, **"of"** with ×',
            'Convert the percent to a decimal (÷ 100)',
        ...
        },
        {
          ...
          content: 'Forward: multiply by (1 ± r). Reverse: divide. Percent change = (New − Old)/Old × 100. Always divide by **original**.',
        },
      ],
    },
    ...
    commonTraps: {
      ...
      blocks: [
        ...
        },
        {
          ...
          correction: '1.10 × 1.10 = 1.21 → **21% increase**. Successive percents multiply; they never add.',
        },
        {
          type: 'trapCard',
          title: 'Increase Then Equal Decrease Cancels',
          wrong: '+25% then −25% returns to the original.',
          correction: '1.25 × 0.75 = 0.9375 → net **6.25% decrease**. The decrease applies to the larger intermediate value.',
        },
        {
          type: 'trapCard',
      ...
      blocks: [
        {
          ...
          steps: [
            { label: 'Identify multiplier', content: '15% increase → ×1.15' },
            { label: 'Reverse it', content: 'Original = 460 / 1.15 = **400**' },
            { label: 'Verify', content: '400 × 1.15 = 460 ✓' },
          ],
        },
        {
          type: 'example',
          ...
          steps: [
            { label: 'Discount multiplier', content: '25% off → ×0.75' },
            { label: 'Tax multiplier', content: '10% tax → ×1.10' },
            { label: 'Chain them', content: '$800 × 0.75 × 1.10 = $800 × 0.825 = **$660**' },
            { label: 'Single multiplier', content: '0.75 × 1.10 = **0.825** — equivalent to a net 17.5% discount' },
          ],
        },
      ],
    },
    ...
    visualModels: {
      ...
      blocks: [
        ...
        {
          type: 'keyInsight',
          content: 'Every percent change is a multiplication, never an addition. The visual of a box growing then shrinking makes concrete why +20% then −10% yields a net 8% increase (1.20 × 0.90 = 1.08), not +10%.',
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          icon: '⚡',
          timing: '~5s',
          content: '10% = ÷10. 5% = half of 10%. 1% = ÷100. 25% = ÷4. 20% = ÷5. Build any percent from these. Example: 15% of 240 = 10%(24) + 5%(12) = 36.',
        },
        {
          type: 'strategyCard',
          ...
          icon: '🔢',
          timing: '~15s',
          content: 'When a percent problem uses only variables, set the original to 100. Every percent directly equals the number. 30% increase on 100 = 130; then 20% decrease = 130 × 0.80 = 104. Net: 4% increase.',
        },
        {
          type: 'strategyCard',
      ...
      blocks: [
        {
          ...
          answer: 'Original × 1.30 = 910 → Original = 910 / 1.30 = **700 employees**.',
        },
        {
          type: 'checkpointQuestion',
          number: 2,
          question: 'A town\'s population of 20,000 grows 5% per year. What is the population after 3 years?',
          answer: '20,000 × (1.05)³ = 20,000 × 1.157625 ≈ **23,153**.',
        },
      ],
    },
  },
