...
// prep books, or other copyrighted sources, no author or study is quoted or
// named, and no citation is invented.
...
export const practiceTest12RWM2Easy = {
  ...
  questions: [
    ...
    // ============================================================
    {
      ...
      "passage": "The playground game of four square is played without a referee, so disputed calls — whether the ball clipped a line, whether a serve was fair — fall to the players themselves. On most courts the custom is simple: rather than argue, the players ______ the disagreement by replaying the point.",
      ...
      "correctAnswer": "A",
      "explanation": "**Choice A is correct.** Replaying the point ends the disagreement so the game can go on, and to bring a dispute to an end is to \"settle\" it.\n\n**The Full Solution:**\n- How to spot it: the sentence sets up a contrast — \"rather than argue\" — so the blank must be the opposite of keeping a dispute alive.\n- With no referee, disputed calls fall to the players, and the custom gives them a way to be done with a dispute quickly.\n- Replaying the point resolves the question without anyone having to win the argument, so \"settle\" fits exactly.\n\n**Why the other choices are wrong:**\n- B: \"Record\" would mean writing the disagreement down, which nothing in the passage suggests.\n- C: \"Predict\" means to say what will happen in advance, but the disagreement has already happened.\n- D: \"Prolong\" means to stretch out, the opposite of what \"rather than argue\" calls for."
    },
    {
      "id": 1258,
      "type": "multiple-choice",
      ...
      "domain": "craft-and-structure",
      "skill": "words-in-context",
      "passage": "The student editors of a school's morning announcements receive many more submissions than a three-minute broadcast can hold, and none of the clubs that submit want their news cut entirely. Instead of dropping items, the editors ______ each one, keeping the meeting time and place while trimming everything else.",
      "question": "Which choice completes the text with the most logical and precise word or phrase?",
      "choices": [
        { "id": "A", "text": "rehearse" },
        { "id": "B", "text": "compose" },
      ...
      "correctAnswer": "D",
      "explanation": "**Choice D is correct.** The editors shorten every item instead of cutting any of them — \"keeping the meeting time and place while trimming everything else\" — and to shrink something while keeping its essentials is to \"condense\" it.\n\n**The Full Solution:**\n- How to spot it: the phrase after the blank describes the action. Keeping the core and trimming the rest is shortening, not removing.\n- The problem is too many submissions for three minutes; the constraint is that no club wants its item dropped.\n- The fix that satisfies both is making each item smaller, which is what \"condense\" means.\n\n**Why the other choices are wrong:**\n- A: \"Rehearse\" means to practice reading the items aloud, which does not make them fit the broadcast.\n- B: \"Compose\" means to write something new, but the items already exist — the clubs submitted them.\n- C: \"Repeat\" would make the broadcast longer, the opposite of the editors' problem."
    },
    {
      "id": 1255,
      "type": "multiple-choice",
    ...
    },
    {
      ...
      "domain": "craft-and-structure",
      "skill": "text-structure-and-purpose",
      "passage": "For years, schools urged families to let children walk to school, and for years the number who walked barely moved. Parents kept naming the same worry: not the distance, but the thought of a child covering it alone. Some districts responded by organizing the walk itself — a fixed route with scheduled stops, led on foot by a rotating pair of adult volunteers, that picks up children along the way like a bus. On streets with such routes, the number of children walking has climbed sharply, drawing in many families that had refused every earlier appeal.",
      "question": "Which choice best states the main purpose of the text?",
      "choices": [
        { "id": "A", "text": "To describe the surveys that school districts rely on to learn how far their students live from school and how those students travel there" },
        { "id": "B", "text": "To argue that schools should stop providing buses for students who live within walking distance" },
        { "id": "C", "text": "To explain why organizing the walk to school into a supervised route succeeded where simple encouragement had failed" },
        { "id": "D", "text": "To compare the number of adult volunteers available at different schools in a single district" }
      ],
      "correctAnswer": "C",
      "explanation": "**Choice C is correct.** The text explains why encouragement alone failed — the worry was walking alone — and why an organized, adult-led route answered that worry and raised the number of walkers.\n\n**The Full Solution:**\n- How to spot it: for a main-purpose question, find the point the passage lands on and check that the answer covers the whole arc.\n- Urging families to let children walk changed almost nothing for years.\n- The parents' stated worry was not distance but a child walking alone.\n- The organized route — fixed stops, adult leaders, pickups along the way — answers exactly that worry.\n- The result is the payoff: sharply more walkers, including families every earlier appeal had failed to move.\n\n**Why the other choices are wrong:**\n- A: No survey methods are described; the parents' worry is simply reported.\n- B: School buses appear only as a comparison for how the route works, not as something to eliminate.\n- D: Volunteers are mentioned once as route leaders; no comparison across schools is made."
    },
    {
      "id": 1259,
      "type": "multiple-choice",
    ...
    },
    {
      ...
      "domain": "information-and-ideas",
      "skill": "inferences",
      "passage": "Plywood scenery flats can be repainted and reused season after season, and the drama programs that reuse them spend their construction budgets on paint and hardware instead of new lumber. The reuse depends on one thing the flats cannot provide for themselves: somewhere to stand between productions. Programs with a storage loft or a spare closet backstage carry their flats from show to show for years. Programs without one break their flats down after the final performance, haul the pieces away, and start the next production by buying lumber all over again. Advisers reviewing drama budgets conclude that a program hoping to save money by reusing scenery ______",
      "question": "Which choice most logically completes the text?",
      "choices": [
        { "id": "A", "text": "can expect the savings from reuse whether or not the flats can be kept anywhere between productions." },
        { "id": "B", "text": "must also secure a place to store its flats, because without one the savings from reuse never arrive." },
        { "id": "C", "text": "should give up on plywood flats entirely, since scenery of any kind is too costly for most programs to build." },
        { "id": "D", "text": "needs mainly to build sturdier flats, since flimsy construction is what forces programs to discard scenery each year." }
      ],
      "correctAnswer": "B",
      "explanation": "**Choice B is correct.** The passage shows reuse paying off only where the flats have somewhere to stand between shows, so a program that wants the savings has to have the storage too.\n\n**The Full Solution:**\n- How to spot it: a finish-the-text question wants the conclusion the evidence forces. The passage gives one case that works and one that does not, so ask what separates them.\n- Reuse saves money: repainting old flats replaces buying new lumber.\n- The passage names the one dependency outright: \"somewhere to stand between productions.\"\n- Programs with a loft or closet reuse flats for years; programs without one discard theirs and buy lumber again.\n- The only difference between the two cases is storage, so storage is what the advisers must call for.\n\n**Why the other choices are wrong:**\n- A: This ignores the contrast the passage is built on — the programs without storage never see the savings.\n- C: Reuse clearly works for the programs with storage, so flats are not a dead end.\n- D: The flats are discarded for lack of space, not because they fall apart; sturdiness is never the issue."
    },
    {
      "id": 1268,
      "type": "multiple-choice",
    ...
    },
    {
      ...
      "passage": "City riders who mount a bell on their handlebars report fewer close calls with pedestrians than riders without bells do, and researchers offer two explanations. One credits the bell itself: a clear ring gives a walker a second or two to step aside before the bicycle arrives. The other credits the rider: the sort of cyclist who bothers to install a bell may simply ride more carefully in the first place. A researcher who favored the first explanation would want evidence tying the fewer close calls to the sound rather than to the rider.",
      "question": "Which finding, if true, would most directly support the first explanation?",
      "choices": [
        { "id": "A", "text": "When riders with bells were asked to leave them silent on certain trips, those trips produced about as many close calls as riders without bells experienced." },
        { "id": "B", "text": "Riders who choose to install bells were also observed to brake earlier and to pass pedestrians more slowly than other riders did, wherever and whenever they rode." },
        { "id": "C", "text": "Bells sold for bicycles vary widely in loudness from one model to the next." },
        { "id": "D", "text": "Riders with bells averaged several more years of city riding experience than riders without them." }
      ],
      "correctAnswer": "A",
      "explanation": "**Choice A is correct.** If the same riders lose their advantage the moment the bell goes silent, the advantage belongs to the sound, not to the kind of person riding — exactly what the first explanation predicts.\n\n**The Full Solution:**\n- How to spot it: pin down which explanation you must support, then keep only the finding that separates it from the rival.\n- The first explanation says the ring itself gives walkers time to step aside; the rival says bell owners are simply more careful riders.\n- Choice A holds the rider constant — the very same people, bells silenced — and the close calls return to the no-bell level.\n- With the rider unchanged and only the sound removed, the difference must have come from the sound.\n\n**Why the other choices are wrong:**\n- B: Careful braking and slow passing by bell owners supports the rival, rider-based explanation instead.\n- C: Variation in loudness says nothing about whether the sound is what prevents close calls.\n- D: More riding experience is another rider trait, which points to the rival explanation, not the bell."
    },
    {
      "id": 1270,
      "type": "multiple-choice",
    ...
    },
    {
      ...
      "choices": [
        { "id": "A", "text": "offer" },
        { "id": "B", "text": "offers" },
        { "id": "C", "text": "is offering" },
        { "id": "D", "text": "has offered" }
      ],
      "correctAnswer": "A",
      "explanation": "**Choice A is correct.** The thing doing the action is \"handles,\" which is plural, so the verb must be the plural \"offer\" (a verb has to match its subject: singular with singular, plural with plural).\n\n**The Full Solution:**\n- The rule: the verb must match the word actually doing the action, not whichever noun happens to sit closest to it.\n- How to spot it: ask what offers the surest hold. The answer is \"the handles\" (plural), so use \"offer.\"\n- A trap word, the singular \"rim,\" sits right before the blank inside the description \"that a rider grips at the platform's rim,\" but the rim is not what the sentence says does the offering.\n- The rest of the sentence is in the present (\"sets,\" \"feels\"), so a present-tense verb fits.\n\n**Why the other choices are wrong:**\n- B: \"Offers\" is singular, so it does not match the plural \"handles.\"\n- C: \"Is offering\" is also singular and does not match \"handles.\"\n- D: \"Has offered\" is singular too, and it pushes the action into the past, which the present-tense sentence does not support."
    },
    {
      "id": 1273,
      "type": "multiple-choice",
      ...
      "domain": "standard-english-conventions",
      "skill": "boundaries",
      "passage": "The first milk-carton boats the class launched came apart within a few feet of the start, their seams soaked ______ the hulls that followed, wrapped seam by seam in waxed tape before launch, crossed the pool without taking on water.",
      "question": "Which choice completes the text so that it conforms to the conventions of Standard English?",
      "choices": [
        { "id": "A", "text": "through" },
        { "id": "B", "text": "through," },
        { "id": "C", "text": "through;" },
        { "id": "D", "text": "through, so" }
      ],
      "correctAnswer": "C",
      "explanation": "**Choice C is correct.** Two complete sentences meet at the blank, and a semicolon joins them correctly without a joining word.\n\n**The Full Solution:**\n- How to spot it: check whether the words on EACH side could stand alone as their own sentence. If both can, you need strong punctuation (a period, a semicolon, or a comma plus and/but/so).\n- The two complete sentences are \"The first milk-carton boats the class launched came apart within a few feet of the start, their seams soaked through\" and \"the hulls that followed, wrapped seam by seam in waxed tape before launch, crossed the pool without taking on water.\"\n- The two halves set the early failures against the later success, and a semicolon links them while leaving that contrast intact.\n\n**Why the other choices are wrong:**\n- A: With no punctuation, the two complete sentences crash together.\n- B: A comma alone between two complete sentences is the comma-splice error.\n- D: \"So\" claims the early failures CAUSED the later hulls' success, which reverses the relationship the sentence draws."
    },
    {
      "id": 1275,
      "type": "multiple-choice",
