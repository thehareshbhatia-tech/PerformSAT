...
},
{
  ...
  difficulty: "hard",
  band: 7,
  question: "In the system of equations below, $a$ is a constant. The system has infinitely many solutions $(x, y)$. What is the value of $a$?\n\n$2x + 5y = 9$\n$8x + 20y = a$",
  correctAnswer: "36",
  explanation: "**SAT Pattern: Same Line (Infinitely Many Solutions)**\n\n**The correct answer is $36$.**\n\n**The Fast Way (~15s):** Infinitely many solutions $\\Leftrightarrow$ equation 2 is a scalar multiple of equation 1. Comparing $x$-coefficients: $\\frac{8}{2} = 4$. Multiply equation 1 by $4$: $8x + 20y = 36$. So $a = 36$.\n\n**The Full Solution:**\nFor a $2 \\times 2$ system to have infinitely many solutions, the equations must represent the SAME line — equation 2 is a scalar multiple of equation 1.\n\nThe $x$-coefficient gives the scale factor: $\\frac{8}{2} = 4$.\nVerify with the $y$-coefficient: $\\frac{20}{5} = 4$ \\checkmark.\n\nApply the same factor to the constant: $a = 4 \\cdot 9 = 36$.\n\nVerification: $4 \\cdot (2x + 5y = 9) \\Rightarrow 8x + 20y = 36$, matching equation 2 with $a = 36$ \\checkmark.\n\n**Common Mistakes to Avoid:**\n* Reporting $a = 9$ — forgetting to apply the scale factor.\n* Mixing up the direction of the ratio (using $\\frac{2}{8}$ instead of $\\frac{8}{2}$).\n\n**Test Day Takeaway:** Infinitely many solutions $\\Leftrightarrow$ ALL three ratios match: $\\frac{a_1}{a_2} = \\frac{b_1}{b_2} = \\frac{c_1}{c_2}$. Find the scale factor from the coefficients, then multiply through to find the missing constant.",
  skills: ["systems-of-equations"]
},
{
  id: 13,
