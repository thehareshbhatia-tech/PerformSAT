  ...
  modules: [
    {
      ...
      questions: [
        ...
        },
        {
          id: 'pt7-m1-q3',
          type: 'multiple-choice',
          question: 'What is the solution to √(3x + 7) = 5?',
          choices: [
            { id: 'A', text: '4' },
            { id: 'B', text: '6' },
            { id: 'C', text: '8' },
          ...
          correctAnswer: 'B',
          explanation: 'Squaring both sides: 3x + 7 = 25. Subtracting 7: 3x = 18. Dividing by 3: x = 6. Check: √(3(6) + 7) = √25 = 5 ✓'
        },
        {
          id: 'pt7-m1-q4',
          type: 'multiple-choice',
        ...
        },
        {
          ...
          correctAnswer: 'B',
          explanation: 'Area of a triangle = (1/2) × base × height = (1/2) × 12 × 8 = 48 square inches.'
        },
        {
          id: 'pt7-m1-q8',
          type: 'multiple-choice',
          ...
          correctAnswer: 'B',
          explanation: 'Factoring: x² - 6x + 9 = (x - 3)² = 0. Therefore, x - 3 = 0, so x = 3.'
        },
        {
          id: 'pt7-m1-q9',
          type: 'multiple-choice',
          question: 'The equation y = 2x² - 8x + 10 represents a parabola. What is the y-intercept?',
          choices: [
            { id: 'A', text: '2' },
            { id: 'B', text: '-8' },
            { id: 'C', text: '10' },
          ...
          correctAnswer: 'C',
          explanation: 'The y-intercept occurs when x = 0. Substituting: y = 2(0)² - 8(0) + 10 = 10.'
        },
        {
          id: 'pt7-m1-q10',
          type: 'multiple-choice',
          ...
          correctAnswer: 'C',
          explanation: 'If the original price is p, then 1.25p = 75. Dividing by 1.25: p = 75/1.25 = $60.'
        },
        {
          id: 'pt7-m1-q11',
          type: 'multiple-choice',
          question: 'The equation of a circle is (x - 4)² + (y + 2)² = 36. What is the radius of the circle?',
          choices: [
            { id: 'A', text: '4' },
            { id: 'B', text: '6' },
            { id: 'C', text: '18' },
          ...
          correctAnswer: 'B',
          explanation: 'The standard form of a circle is (x - h)² + (y - k)² = r². Here, r² = 36, so r = 6.'
        },
        {
          id: 'pt7-m1-q12',
          type: 'multiple-choice',
          question: 'In a right triangle, if sin(θ) = 5/13, what is cos(θ)?',
          choices: [
            { id: 'A', text: '5/13' },
            { id: 'B', text: '12/13' },
            { id: 'C', text: '5/12' },
          ...
          correctAnswer: 'B',
          explanation: 'Using the Pythagorean identity: sin²(θ) + cos²(θ) = 1. So (5/13)² + cos²(θ) = 1. Thus cos²(θ) = 1 - 25/169 = 144/169, and cos(θ) = 12/13.'
        },
        {
          id: 'pt7-m1-q13',
          type: 'fill-in',
        ...
        },
        {
          id: 'pt7-m1-q15',
          type: 'multiple-choice',
          question: 'If f(x) = x² + 4x - 5, for what value of x does f(x) = 0?',
          choices: [
            { id: 'A', text: 'x = 1 only' },
            { id: 'B', text: 'x = -5 only' },
          ...
          correctAnswer: 'C',
          explanation: 'Factoring: x² + 4x - 5 = (x + 5)(x - 1) = 0. So x = -5 or x = 1.'
        },
        {
          id: 'pt7-m1-q16',
          type: 'multiple-choice',
        ...
        },
        {
          id: 'pt7-m1-q18',
          type: 'multiple-choice',
          question: 'Which expression is equivalent to (2x³)²?',
          choices: [
            { id: 'A', text: '2x⁶' },
            { id: 'B', text: '4x⁵' },
            { id: 'C', text: '4x⁶' },
        ...
        },
        {
          ...
          correctAnswer: '5',
          explanation: 'Perimeter = 2(length + width). So 28 = 2(9 + width), 14 = 9 + width, width = 5 cm.'
        },
        {
          id: 'pt7-m1-q22',
          type: 'multiple-choice',
          ...
          correctAnswer: 'A',
          explanation: 'Using the difference of squares formula: (x + 3)(x - 3) = x² - 3² = x² - 9.'
        }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correctAnswer: 'B',
          explanation: 'Total marbles = 4 + 6 + 5 = 15. Probability of blue = 6/15 = 2/5.'
        },
        {
          id: 'pt7-m2-q4',
          type: 'multiple-choice',
        ...
        },
        {
          ...
          correctAnswer: 'A',
          explanation: 'Using the difference of cubes formula: a³ - b³ = (a - b)(a² + ab + b²). Here, x³ - 8 = x³ - 2³ = (x - 2)(x² + 2x + 4).'
        },
        {
          id: 'pt7-m2-q9',
          type: 'fill-in',
          ...
          correctAnswer: '40',
          explanation: 'If boys:girls = 3:5 and boys = 24, then 24/3 = 8 represents one unit. Girls = 5 × 8 = 40.'
        },
        {
          id: 'pt7-m2-q10',
          type: 'multiple-choice',
        ...
        },
        {
          ...
          correctAnswer: 'B',
          explanation: 'Using d = 55t with d = 220: 220 = 55t, so t = 220/55 = 4 hours.'
        },
        {
          id: 'pt7-m2-q12',
          type: 'multiple-choice',
        ...
        },
        {
          ...
          correctAnswer: '4',
          explanation: 'Area = (x + 5)(x - 2) = 18. Expanding: x² + 3x - 10 = 18, so x² + 3x - 28 = 0. Factoring: (x + 7)(x - 4) = 0. So x = -7 or x = 4. The positive value is x = 4. Check: (4 + 5)(4 - 2) = 9 × 2 = 18 ✓'
        },
        {
          id: 'pt7-m2-q15',
          type: 'multiple-choice',
          ...
          correctAnswer: 'B',
          explanation: 'The median of an ordered set with 7 values is the 4th value. The values in order are: 12, 15, 18, 22, 28, 35, 42. The 4th value is 22.'
        },
        {
          id: 'pt7-m2-q16',
          type: 'multiple-choice',
          question: 'A cylinder has radius 3 inches and height 8 inches. What is its volume in cubic inches? (Use π ≈ 3.14)',
          choices: [
            { id: 'A', text: '72π' },
            { id: 'B', text: '24π' },
            { id: 'C', text: '48π' },
          ...
          correctAnswer: 'A',
          explanation: 'Volume of cylinder = πr²h = π(3)²(8) = π(9)(8) = 72π cubic inches.'
        },
        {
          id: 'pt7-m2-q17',
          type: 'multiple-choice',
          ...
          correctAnswer: 'D',
          explanation: 'Perpendicular lines have slopes that are negative reciprocals. The negative reciprocal of 4 is -1/4.'
        },
        {
          id: 'pt7-m2-q18',
          type: 'multiple-choice',
          ...
          correctAnswer: 'B',
          explanation: 'Solving for y: 2y = -3x + 18, so y = -(3/2)x + 9.'
        },
        {
          id: 'pt7-m2-q19',
          type: 'fill-in',
          ...
          correctAnswer: '1.5',
          explanation: '125 = 5³, so 5^(2x) = 5³. Therefore 2x = 3, and x = 3/2 = 1.5.'
        },
        {
          id: 'pt7-m2-q20',
          type: 'multiple-choice',
          ...
          correctAnswer: 'A',
          explanation: 'Vertex form is y = a(x - h)² + k with vertex (h, k) = (3, -4). So y = a(x - 3)² - 4. Testing with point (5, 0): 0 = a(5-3)² - 4 = 4a - 4, so a = 1. Thus y = (x - 3)² - 4.'
        },
        {
          id: 'pt7-m2-q21',
          type: 'multiple-choice',
          question: 'Which expression is equivalent to (4x² - 9)/(2x + 3)?',
          choices: [
            { id: 'A', text: '2x + 3' },
            { id: 'B', text: '2x - 3' },
            { id: 'C', text: '4x - 3' },
          ...
          correctAnswer: 'B',
          explanation: 'Factor the numerator as a difference of squares: 4x² - 9 = (2x + 3)(2x - 3). Then (2x + 3)(2x - 3)/(2x + 3) = 2x - 3.'
        },
        {
          id: 'pt7-m2-q22',
          type: 'fill-in',
          ...
          correctAnswer: '68',
          explanation: 'Discount = 20% of $85 = 0.20 × 85 = $17. Sale price = $85 - $17 = $68.'
        }
      ]
    }
  ]
