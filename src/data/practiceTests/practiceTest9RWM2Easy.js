...
// (docs/TEST_RECREATION_SPEC.md). Every passage is ORIGINAL prose written for
// this variant. No topic is reused from Practice Test 9's Module 1 or its
// standard Module 2, and nothing is taken or paraphrased from College Board
...
export const practiceTest9RWM2Easy = {
  ...
  questions: [
    ...
    },
    {
      ...
      "domain": "craft-and-structure",
      "skill": "words-in-context",
      "passage": "For much of the nineteenth century, buttons were cut from seashell, whose layered surface catches the light differently at every angle. A single shell yields a dozen or more button blanks, yet no two of them show quite the same play of color once they are polished. Because the material is so ______, even a card of buttons cut from one shell offers a small range of looks to choose from.",
      "question": "Which choice completes the text with the most logical and precise word or phrase?",
      "choices": [
        { "id": "A", "text": "smooth" },
        { "id": "B", "text": "costly" },
      ...
      "correctAnswer": "C",
      "explanation": "**Choice C is correct.** The passage says no two polished buttons \"show quite the same play of color,\" so the blank needs a word meaning full of differences - \"varied.\"\n\n**The Full Solution:**\n- How to spot it: read the sentence before the blank. It is one long description of difference - the surface changes at every angle, and no two blanks come out alike.\n- The blank names the quality that all that difference adds up to.\n- The payoff in the same sentence confirms it: even buttons from a single shell offer \"a small range of looks,\" which is exactly what a varied material would produce.\n\n**Why the other choices are wrong:**\n- A: \"Smooth\" describes the feel of a polished button, not the differences in color the passage dwells on.\n- B: \"Costly\" is about price, which the passage never mentions.\n- D: \"Scarce\" would mean the shell is hard to get, but the passage says one shell yields a dozen or more blanks.",
    ...
    },
    {
      ...
      "passages": [
        {
          "label": "Text 1",
          "text": "Through the early twentieth century, most American kitchens kept food in an icebox cooled by a block of delivered ice, and the block's short life was the system's great weakness. The remedy is better handling: wagons built with double walls, blocks wrapped in canvas and sawdust between stops, and routes run in the cool hours before the sun is high. Every one of these measures can be adopted at once, by any dealer, without waiting for anything new to be invented."
        },
        {
          "label": "Text 2",
          "text": "Careful handling certainly slows the melt. But it labors to preserve a product whose nature is to disappear: however well it is wrapped, the block is always shrinking toward the day it must be replaced. An electric refrigerator makes its own cold in the kitchen, week after week, with nothing delivered at all. It does away with the wagon, the wrapping, and the morning route together - though such machines remain costly and will be slow to reach most households."
        }
      ],
    ...
    // ============================================================
    {
      ...
      "passage": "The gutters that run along a roof's edge are not set level. Installers pitch each run slightly - a drop of an inch or so over many feet - so that the water they catch keeps moving toward the downspout at the end. In a level trough, rainwater would simply stand after each storm, and standing water rusts the metal, breeds mosquitoes, and spills over the rim in the next hard rain.",
      "question": "According to the text, why are gutters installed with a slight slope?",
      "choices": [
        { "id": "A", "text": "The slope makes the gutters easier to see and clean from a ladder." },
        { "id": "B", "text": "The slope keeps captured rainwater moving toward the downspout instead of standing in the trough." },
        { "id": "C", "text": "The slope allows the gutters to be cut from shorter lengths of metal." },
        { "id": "D", "text": "The slope directs rainwater away from the downspout and back onto the surface of the roof." }
      ],
      "correctAnswer": "B",
      "explanation": "**Choice B is correct.** The text says installers pitch each run \"so that the water they catch keeps moving toward the downspout,\" rather than standing in a level trough.\n\n**The Full Solution:**\n- How to spot it: a \"why\" detail question is answered somewhere in the passage, not by your own reasoning. Find the sentence that states the purpose and read it literally.\n- The purpose is given right after the description of the pitch: the drop keeps caught water \"moving toward the downspout at the end.\"\n- The last sentence explains what the slope prevents: in a level trough water would stand, and standing water \"rusts the metal, breeds mosquitoes, and spills over the rim\" - exactly why B is the stated reason.\n\n**Why the other choices are wrong:**\n- A: Cleaning and visibility are never mentioned in the passage.\n- C: The lengths of metal the gutters are cut from never come up.\n- D: This is backward - the slope sends water toward the downspout, not away from it.",
    ...
    },
    {
      ...
      "domain": "information-and-ideas",
      "skill": "central-ideas-and-details",
      "passage": "A spelling bee runs on a single unforgiving rule: one wrong letter, and the speller sits down. There is no partial credit and no second try, so a contestant who has sailed through ten rounds can be gone one syllable into the eleventh. Because any word might end any turn, an audience holds its breath for each one - which is how a classroom exercise came to fill town halls with spectators on winter evenings.",
      "question": "Which choice best states the main idea of the text?",
      "choices": [
        { "id": "A", "text": "The all-or-nothing rule of the spelling bee keeps every turn tense, and that tension turned a school exercise into a public entertainment." },
        { "id": "B", "text": "A contestant who has already spelled ten words correctly in a spelling bee is likely to spell the eleventh word given to her correctly as well." },
        { "id": "C", "text": "Spelling bees were once held in the evening so that adults who worked during the day could attend." },
        { "id": "D", "text": "Most spelling bees end when only two contestants remain and one of them misspells a word." }
      ],
      "correctAnswer": "A",
      "explanation": "**Choice A is correct.** The passage links the bee's single unforgiving rule to the suspense of every turn, and that suspense to the bee's life as a public spectacle.\n\n**The Full Solution:**\n- How to spot it: the main idea ties the mechanism to its consequence. Look for the answer that carries both the rule and what the rule produced.\n- The rule: \"one wrong letter, and the speller sits down,\" with no partial credit and no second try.\n- The consequence: because \"any word might end any turn, an audience holds its breath for each one,\" which is how a classroom exercise \"came to fill town halls with spectators.\" Choice A states that whole chain.\n\n**Why the other choices are wrong:**\n- B: The passage says the opposite - ten good rounds are no protection, since the eleventh word can end a contestant's evening.\n- C: The passage mentions winter evenings in passing but never explains the scheduling of bees.\n- D: How a bee ends is never described; the passage is about the tension of each turn along the way.",
