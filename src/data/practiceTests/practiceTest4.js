  ...
  modules: [
    {
      ...
      questions: [
        ...
        // Question 11: Rearranging formulas
        {
          ...
          type: "multiple-choice",
          difficulty: "medium",
          question: "The area A of a triangle is given by A = ½bh, where b is the base and h is the height. Which equation correctly expresses h in terms of A and b?",
          choices: [
            { id: "A", text: "h = 2Ab" },
            { id: "B", text: "h = A/(2b)" },
            { id: "C", text: "h = 2A/b" },
          ...
          correctAnswer: "C",
          explanation: "**Choice C is correct.** Solve for h in the formula A = ½bh.\n\n• A = ½bh\n• 2A = bh (multiply both sides by 2)\n• 2A/b = h (divide both sides by b)\n• h = 2A/b\n\n**Verification:** If A = 12 and b = 4:\n• h = 2(12)/4 = 24/4 = 6\n• Check: A = ½(4)(6) = 12 ✓\n\n**Why other choices are incorrect:**\n• Choice A: h = 2Ab would give h = 2(12)(4) = 96, but ½(4)(96) ≠ 12\n• Choice B: h = A/(2b) would give h = 12/8 = 1.5, but ½(4)(1.5) = 3 ≠ 12\n• Choice D: h = Ab/2 would give h = 48/2 = 24, but ½(4)(24) = 48 ≠ 12\n\n**Key concept:** When solving for a variable, perform inverse operations systematically.",
        ...
        // Question 12: Similar triangles and trig ratios
        {
          ...
          type: "multiple-choice",
          difficulty: "medium",
          question: "Triangles PQR and XYZ are similar, where P corresponds to X and Q corresponds to Y. If cos(P) = 5/13, what is the value of cos(X)?",
          choices: [
            { id: "A", text: "5/13" },
            { id: "B", text: "12/13" },
            { id: "C", text: "13/5" },
        ...
        // Question 13: Product of roots (Vieta's formulas)
        {
          ...
          type: "fill-in",
          difficulty: "medium",
          question: "What is the product of the solutions to the equation 3x² - 7x + 2 = 0?",
          correctAnswer: "2/3",
          alternateAnswers: [0.667, 0.67, ".667", ".67"],
          explanation: "**The correct answer is 2/3.** Use Vieta's formulas or solve the equation.\n\n**Method 1: Vieta's formulas**\nFor ax² + bx + c = 0, the product of roots = c/a\n• Product = 2/3\n\n**Method 2: Solving the equation**\n• 3x² - 7x + 2 = 0\n• (3x - 1)(x - 2) = 0\n• x = 1/3 or x = 2\n• Product: (1/3)(2) = 2/3\n\n**Key concept:** For ax² + bx + c = 0:\n• Sum of roots = -b/a\n• Product of roots = c/a",
        ...
        // Question 14: System of inequalities
        {
          ...
          correctAnswer: "A",
          explanation: "**Choice A is correct.** Test each point in both inequalities.\n\n**Testing (0, 0):**\n• y ≥ 2x - 3: Is 0 ≥ 2(0) - 3? Is 0 ≥ -3? Yes ✓\n• y ≤ -x + 4: Is 0 ≤ -(0) + 4? Is 0 ≤ 4? Yes ✓\n\n**Why other choices are incorrect:**\n• Choice B (4, 0): 0 ≥ 2(4) - 3 → 0 ≥ 5 is FALSE\n• Choice C (0, -4): -4 ≥ -3 is FALSE\n• Choice D (3, 3): 3 ≥ 2(3) - 3 → 3 ≥ 3 ✓, but 3 ≤ -3 + 4 → 3 ≤ 1 is FALSE\n\n**Calculator tip:** Graph both inequalities in Desmos and find the overlapping region.",
        ...
        // Question 16: Percent calculation
        {
          ...
          explanation: "**The correct answer is 5.2.** Convert the percent to a decimal and multiply.\n\n• 8% = 0.08\n• 8% of 65 = 0.08 × 65\n• = 5.2\n\nAlternatively: 8% of 65 = (8/100) × 65 = 8 × 0.65 = 5.2\n\n**Key concept:** To find a percent of a number: percent × number = (percent/100) × number",
          skills: ["percentages"]
        },
        ...
        // Question 20: Rational expression simplification
        {
          ...
          type: "multiple-choice",
          difficulty: "hard",
          question: "Which expression is equivalent to (x² + 5x + 6)/(x² - 4)?",
          choices: [
            { id: "A", text: "(x + 3)/(x - 2)" },
            { id: "B", text: "(x + 3)/(x + 2)" },
            { id: "C", text: "(x + 2)/(x - 2)" },
        ...
        // Question 21: Poll/proportion problem
        {
          ...
          correctAnswer: "B",
          explanation: "**Choice B is correct.** Calculate the percentage.\n\n• Percent = (Part/Whole) × 100\n• Percent = (5280/8000) × 100\n• Percent = 0.66 × 100\n• Percent = 66%\n\n**Why other choices are incorrect:**\n• Choice A (52.8%): This would be 4224/8000\n• Choice C (72%): This would be 5760/8000\n• Choice D (79.2%): This would be 6336/8000\n\n**Key concept:** Percentage = (Part ÷ Whole) × 100",
        ...
        // Question 22: Circle equation - finding radius
        {
          ...
          type: "fill-in",
          difficulty: "medium",
          question: "A circle in the xy-plane has the equation (x - 3)² + (y + 2)² = 49. What is the radius of the circle?",
          correctAnswer: 7,
          explanation: "**The correct answer is 7.** Use the standard form of a circle equation.\n\nStandard form: (x - h)² + (y - k)² = r²\n\nComparing with (x - 3)² + (y + 2)² = 49:\n• Center: (h, k) = (3, -2)\n• r² = 49\n• r = √49 = 7\n\n**Key concept:** In the equation (x - h)² + (y - k)² = r²:\n• (h, k) is the center\n• r is the radius\n• The right side is r², so take the square root to find r",
    ...
    },
    {
      ...
      questions: [
        ...
        // Question 2: Quadratic minimum
        {
          ...
          type: "multiple-choice",
          difficulty: "medium",
          question: "What is the minimum value of the function f(x) = (x - 5)² + 3?",
          choices: [
            { id: "A", text: "-5" },
            { id: "B", text: "3" },
            { id: "C", text: "5" },
        ...
        // Question 3: Factoring quadratics
        {
          ...
          type: "multiple-choice",
          difficulty: "medium",
          question: "Which expression is equivalent to 4x² - 9x - 9?",
          choices: [
            { id: "A", text: "(4x + 3)(x - 3)" },
            { id: "B", text: "(4x - 3)(x + 3)" },
            { id: "C", text: "(2x + 3)(2x - 3)" },
          ...
          correctAnswer: "A",
          explanation: "**Choice A is correct.** Factor by finding two numbers whose product is 4(-9) = -36 and sum is -9.\n\n• Numbers: -12 and 3 (since -12 × 3 = -36 and -12 + 3 = -9)\n• Rewrite: 4x² - 12x + 3x - 9\n• Group: (4x² - 12x) + (3x - 9)\n• Factor: 4x(x - 3) + 3(x - 3)\n• = (4x + 3)(x - 3)\n\n**Verification:** (4x + 3)(x - 3) = 4x² - 12x + 3x - 9 = 4x² - 9x - 9 ✓\n\n**Why other choices are incorrect:**\n• Choice B: (4x - 3)(x + 3) = 4x² + 12x - 3x - 9 = 4x² + 9x - 9\n• Choice C: (2x + 3)(2x - 3) = 4x² - 9 (difference of squares)\n• Choice D: (x + 3)(4x - 3) = 4x² - 3x + 12x - 9 = 4x² + 9x - 9\n\n**Key concept:** Use factoring by grouping for quadratics with a ≠ 1.",
        ...
        // Question 4: Triangle angle sum
        {
          ...
          explanation: "**The correct answer is 125/3 ≈ 41.67.** The sum of angles in a triangle is 180°.\n\n• (2x + 10) + 45 + x = 180\n• 3x + 55 = 180\n• 3x = 125\n• x = 125/3 ≈ 41.67°\n\n**Verification:**\n• Angle A: 2(125/3) + 10 = 250/3 + 30/3 = 280/3 ≈ 93.33°\n• Angle B: 45°\n• Angle C: 125/3 ≈ 41.67°\n• Sum: 280/3 + 45 + 125/3 = 280/3 + 135/3 + 125/3 = 540/3 = 180° ✓\n\n**Key concept:** The sum of interior angles of a triangle is always 180°.",
        ...
        // Question 5: System intersection (parabola and line)
        {
          ...
          type: "fill-in",
          difficulty: "medium",
          question: "At what positive value of x do the graphs of y = x² and y = 5x - 4 intersect?",
          correctAnswer: 4,
        ...
        // Question 7: Square root function domain
        {
          ...
          type: "multiple-choice",
          difficulty: "medium",
          question: "For the function f(x) = √(x + 5), what is the least value of x for which f(x) is defined?",
          choices: [
            { id: "A", text: "-5" },
            { id: "B", text: "0" },
            { id: "C", text: "5" },
        ...
        // Question 9: Sum of solutions
        {
          ...
          type: "fill-in",
          difficulty: "medium",
          question: "What is the sum of the solutions to x² - 10x + 21 = 0?",
          correctAnswer: 10,
        ...
        // Question 14: Inequality word problem
        {
          ...
          correctAnswer: "A",
          explanation: "**Choice A is correct.** Set up the inequality.\n\n• Current weight + additional weight ≤ maximum capacity\n• 180 + w ≤ 500\n• w ≤ 500 - 180\n• w ≤ 320\n\n**Why other choices are incorrect:**\n• Choice B: w ≥ 320 means at least 320 pounds must be added\n• Choice C: 180 + 680 = 860 > 500, would exceed capacity\n• Choice D: Doesn't account for existing 180 pounds\n\n**Key concept:** \"At most\" translates to ≤ (less than or equal to).",
        ...
        // Question 17: Exponential equation
        {
          ...
          correctAnswer: "B",
          explanation: "**Choice B is correct.** Express both sides with the same base.\n\n• 4^x = 32\n• (2²)^x = 2⁵ (since 4 = 2² and 32 = 2⁵)\n• 2^(2x) = 2⁵\n• 2x = 5\n• x = 2.5\n\n**Verification:** 4^2.5 = 4² × 4^0.5 = 16 × 2 = 32 ✓\n\n**Why other choices are incorrect:**\n• Choice A (2): 4² = 16 ≠ 32\n• Choice C (3): 4³ = 64 ≠ 32\n• Choice D (8): 4⁸ is much larger than 32\n\n**Calculator tip:** Use logarithms: x = log₄(32) = log(32)/log(4) ≈ 2.5",
        ...
        // Question 18: Quadratic formula form
        {
          ...
          type: "multiple-choice",
          difficulty: "hard",
          question: "The solutions to 2x² + 6x - 5 = 0 can be written as x = (-6 ± √k)/4. What is the value of k?",
          choices: [
            { id: "A", text: "36" },
            { id: "B", text: "56" },
            { id: "C", text: "76" },
          ...
          correctAnswer: "C",
          explanation: "**Choice C is correct.** Use the quadratic formula.\n\nFor 2x² + 6x - 5 = 0, where a = 2, b = 6, c = -5:\n\n• x = (-b ± √(b² - 4ac))/(2a)\n• x = (-6 ± √(36 - 4(2)(-5)))/(2(2))\n• x = (-6 ± √(36 + 40))/4\n• x = (-6 ± √76)/4\n\nTherefore, k = 76.\n\n**Why other choices are incorrect:**\n• Choice A (36): This is just b², missing the -4ac part\n• Choice B (56): Calculation error\n• Choice D (96): Would need different coefficients\n\n**Key concept:** The discriminant is b² - 4ac, which appears under the square root in the quadratic formula.",
        ...
        // Question 20: Isosceles right triangle
        {
          ...
          explanation: "**The correct answer is 8√2 ≈ 11.31.** Use the Pythagorean theorem or the 45-45-90 pattern.\n\n**Method 1: Pythagorean theorem**\n• c² = a² + b²\n• c² = 8² + 8²\n• c² = 64 + 64 = 128\n• c = √128 = √(64 × 2) = 8√2\n\n**Method 2: 45-45-90 pattern**\nIn a 45-45-90 triangle, sides are in ratio 1:1:√2\n• Legs: 8\n• Hypotenuse: 8√2\n\n**Key concept:** In a 45-45-90 triangle with legs of length a, the hypotenuse = a√2.",
        ...
        // Question 21: Discriminant (one solution)
        {
          ...
          type: "fill-in",
          difficulty: "hard",
          question: "For what value of k does the equation x² + kx + 9 = 0 have exactly one real solution?",
          correctAnswer: 6,
          alternateAnswers: [-6],
          explanation: "**The correct answer is 6 (or -6).** For exactly one real solution, the discriminant must equal zero.\n\n• Discriminant: b² - 4ac = 0\n• For x² + kx + 9 = 0: a = 1, b = k, c = 9\n• k² - 4(1)(9) = 0\n• k² - 36 = 0\n• k² = 36\n• k = ±6\n\n**Verification for k = 6:**\n• x² + 6x + 9 = (x + 3)² = 0\n• One solution: x = -3 ✓\n\n**Key concept:** A quadratic has exactly one real solution when its discriminant b² - 4ac = 0.",
