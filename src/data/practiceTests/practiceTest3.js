    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correctAnswer: "C",
          explanation: "**SAT Pattern: Finding Two Times from a Quadratic Model and Computing Their Difference** -- This combines the vertex/projectile concept with setting the quadratic equal to a specific value and using the quadratic formula or Vieta's to find the time gap. It requires multi-step reasoning: set up the equation, solve or use a shortcut, then find the difference.\n\n**Choice C is correct.** The positive difference is $1.5$ seconds.\n\n**The Fast Way (35 seconds):** Set $-16t^2 + 40t + 5 = 21$, giving $-16t^2 + 40t - 16 = 0$, or $2t^2 - 5t + 2 = 0$. Factor: $(2t - 1)(t - 2) = 0$, so $t = 0.5$ or $t = 2$. Difference: $2 - 0.5 = 1.5$.\n\n**Solution steps:**\n1. Set height $= 21$: $-16t^2 + 40t + 5 = 21$\n2. Simplify: $-16t^2 + 40t - 16 = 0 \\Rightarrow 2t^2 - 5t + 2 = 0$\n3. Factor: $(2t - 1)(t - 2) = 0$\n4. Solutions: $t = \\frac{1}{2} = 0.5$ and $t = 2$\n5. Positive difference: $2 - 0.5 = 1.5$ seconds\n\n**Why the wrong answers are tempting:**\n- **A ($0.5$):** This is one of the two times the ball is at $21$ feet ($t = 0.5$), not the difference between them. You found half the answer and stopped.\n- **B ($1$):** A round number that feels right but doesn't match the factored equation. You may have estimated or made an arithmetic error during factoring.\n- **D ($2$):** This is the other time the ball is at $21$ feet ($t = 2$), not the difference. You reported a single time instead of the interval between the two times.\n\n**Verification:** $h(0.5) = -16(0.25) + 40(0.5) + 5 = -4 + 20 + 5 = 21$ \u2713. $h(2) = -16(4) + 40(2) + 5 = -64 + 80 + 5 = 21$ \u2713. Difference: $2 - 0.5 = 1.5$ \u2713\n\n**Test Day Takeaway:** To find the time gap at a given height, set $h(t) = k$, rearrange to standard form, and factor or use the quadratic formula. The difference between roots is $\\frac{\\sqrt{b^2-4ac}}{|a|}$ -- a powerful shortcut that avoids finding each root individually.",
          skills: ['Advanced Math', 'Quadratic Equations']
        },
        {
          id: 9,
        ...
        },
        {
          ...
          type: "multiple-choice",
          difficulty: "hard",
          question: "A movie theater charges \\$9 on weekdays and \\$14 on weekends. If the theater collected \\$46,926 in one week and a total of 3,894 people attended, how many people attended the theater during the weekend?",
          choices: [
            { id: "A", text: "$246$" },
            { id: "B", text: "$1{,}518$" },
            { id: "C", text: "$2{,}376$" },
          ...
          correctAnswer: "C",
          explanation: "**SAT Pattern: Mixture/Ticket Problem with Two Prices** -- Set up two equations: one for total people, one for total revenue. Solve by substitution.\n\n**Choice C is correct.** $2{,}376$ people attended during the weekend.\n\n**The Fast Way (30 seconds):** Let $e$ = weekend, $w = 3{,}894 - e$. Revenue: $9(3{,}894 - e) + 14e = 46{,}926$. Simplify: $35{,}046 + 5e = 46{,}926$, so $5e = 11{,}880$, $e = 2{,}376$.\n\n**Solution steps:**\n1. Let $w$ = weekday attendees, $e$ = weekend attendees\n2. $w + e = 3{,}894$\n3. $9w + 14e = 46{,}926$\n4. Substitute $w = 3{,}894 - e$: $9(3{,}894 - e) + 14e = 46{,}926$\n5. $35{,}046 + 5e = 46{,}926 \\Rightarrow 5e = 11{,}880 \\Rightarrow e = 2{,}376$\n\n**Why the wrong answers are tempting:**\n- **A ($246$):** This is $3{,}894 - 3{,}648$. Far too small -- this many weekend attendees at $\\$14$ only generates $\\$3{,}444$, which cannot account for the total revenue.\n- **B ($1{,}518$):** This is the number of weekday attendees ($3{,}894 - 2{,}376 = 1{,}518$). You solved the right system but reported the wrong variable. Always re-read which category the question asks for.\n- **D ($3{,}648$):** Nearly the entire attendance on weekends -- verify: $9(246) + 14(3{,}648) = 2{,}214 + 51{,}072 = 53{,}286 \\neq 46{,}926$.\n\n**Verification:** $w = 1{,}518$, $e = 2{,}376$. Total: $1{,}518 + 2{,}376 = 3{,}894$ \u2713. Revenue: $9(1{,}518) + 14(2{,}376) = 13{,}662 + 33{,}264 = 46{,}926$ \u2713\n\n**Test Day Takeaway:** For any problem with two categories and two totals, set up two equations and solve by substitution. Always double-check which variable the question asks for -- weekday vs. weekend is a common mix-up.",
        ...
        },
        {
          ...
          type: "fill-in",
          difficulty: "hard",
          question: "What is the largest integer value of $k$ for which the system below will have no solution?",
          questionFormula: {
            lines: [
              "$y = x^2 + 4x + 8$",
              "$y = k$"
          ...
          diagram: {
            ...
            params: {
              sets: [
                ...
                { name: "SET N", data: [4, 5, 5, 6, 6, 6, 7, 7, 7, 8, 8, 8, 9, 9, 10] }
              ],
              xRange: [3, 11],
              layout: "horizontal"
            }
