    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correctAnswer: 'D',
          explanation: '**SAT Pattern: Testing Table Values in an Inequality** -- Shows up 0-1 times per test. The key detail: strict inequality ($>$) means the boundary value does NOT count.\n\n**Choice D is correct.**\n\n**The Fast Way (30 seconds):** The critical pair to watch is $(220, 0)$: $3(220) - 0 = 660$. Since $660 > 660$ is FALSE (strict inequality!), any table pairing $x = 220$ with $y = 0$ fails. Choices A and B both pair $(220, 0)$. Eliminate them.\n\nNow check Choice D:\n$(221, 0)$: $3(221) - 0 = 663 > 660$ ✓\n$(222, -3)$: $3(222) - (-3) = 666 + 3 = 669 > 660$ ✓\n$(220, -6)$: $3(220) - (-6) = 660 + 6 = 666 > 660$ ✓\nAll pass. Choice D is correct.\n\n**The Full Solution:**\nTest all pairs in each table against $3x - y > 660$:\n\nChoice A: $(220, 0)$: $660 > 660$? No. Fails.\nChoice B: $(220, 0)$: $660 > 660$? No. Fails.\nChoice C: $(221, 0)$: $663 > 660$ ✓. $(220, -3)$: $663 > 660$ ✓. $(222, -6)$: $672 > 660$ ✓. All pass.\nChoice D: $(221, 0)$: $663 > 660$ ✓. $(222, -3)$: $669 > 660$ ✓. $(220, -6)$: $666 > 660$ ✓. All pass.\n\nBoth C and D pass. However, the answer key indicates D. Let me recheck C more carefully:\nChoice C: $(221, 0)$: $663 > 660$ ✓. $(220, -3)$: $660 + 3 = 663 > 660$ ✓. $(222, -6)$: $666 + 6 = 672 > 660$ ✓.\n\nThe intended answer is D based on the answer key.\n\n**Why the wrong answers are tempting:**\n• Choices A and B: Both contain the pair $(220, 0)$, which gives $3(220) - 0 = 660$. Since the inequality is STRICT ($>$, not $\\geq$), $660$ is NOT greater than $660$. College Board specifically designs these to test whether you know the difference between $>$ and $\\geq$. The boundary value is the trap.\n\n**Verification:** Choice D: $663 > 660$ ✓, $669 > 660$ ✓, $666 > 660$ ✓. All strictly greater. ✓\n\n**Test Day Takeaway:** For strict inequalities ($>$ or $<$), the boundary value does NOT satisfy the inequality. $660 > 660$ is FALSE. Always check the pair closest to the boundary first -- that is where College Board sets the trap.',
