...
// prep books, or other copyrighted sources, and no passage reuses a topic
// from Practice Test 11's Module 1 or standard Module 2.
...
export const practiceTest11RWM2Easy = {
  ...
  questions: [
    ...
    },
    {
      ...
      "domain": "craft-and-structure",
      "skill": "words-in-context",
      "passage": "A shoelace bow is held together by nothing but friction. At every point where one strand crosses another, the two surfaces press together and resist sliding. A lace with a rough, slightly fuzzy surface grips itself especially well, so the many crossings inside the knot ______ it in place through hours of walking.",
      "question": "Which choice completes the text with the most logical and precise word or phrase?",
      "choices": [
        { "id": "A", "text": "stretch" },
        { "id": "B", "text": "loosen" },
      ...
      "correctAnswer": "C",
      "explanation": "**Choice C is correct.** The passage explains that the crossings press together and resist sliding, so they keep the knot where it is, and \"hold\" names exactly that.\n\n**The Full Solution:**\n- How to spot it: read the words right after the blank. The crossings \"______ it in place\" — so the blank needs a verb that means keeping something steady.\n- The passage has already supplied the mechanism: at every crossing the surfaces \"press together and resist sliding,\" and a fuzzy lace \"grips itself especially well.\"\n- A verb meaning to keep in position fits, and \"hold\" is the cleanest match: the crossings hold the bow in place all day.\n\n**Why the other choices are wrong:**\n- A: \"Stretch\" means to lengthen the knot, which is not what friction does to it.\n- B: \"Loosen\" is the very thing the passage says friction prevents.\n- D: \"Measure\" is something a researcher might do to a lace, not what the crossings do to the knot."
    },
    {
      "id": 1156,
      "type": "multiple-choice",
    ...
    },
    {
      ...
      "domain": "craft-and-structure",
      "skill": "text-structure-and-purpose",
      "passage": "For years, the lost-and-found at one elementary school was a bin that swallowed jackets and lunch boxes until June, when everything unclaimed went to charity. The office now handles lost items differently. Each Friday, a volunteer spreads the week's finds on a table, photographs them, and posts the pictures in the school's family newsletter. Parents recognize a missing sweatshirt in seconds, and most items now go home within days of being turned in.",
      "question": "Which choice best states the main purpose of the text?",
      "choices": [
        { "id": "A", "text": "To explain how photographing lost items helped a school return them to their owners more quickly" },
        { "id": "B", "text": "To argue that schools should donate unclaimed items to charity at the end of every school year" },
        { "id": "C", "text": "To describe the kinds of items that students most often lose at school" },
        { "id": "D", "text": "To recount how one parent finally recovered a sweatshirt that had been missing for months" }
      ],
      "correctAnswer": "A",
      "explanation": "**Choice A is correct.** The text exists to explain how the photo system solved the old bin's problem — lost items now get home in days instead of piling up until June.\n\n**The Full Solution:**\n- How to spot it: for a purpose question, trace what each sentence does. The first describes the old system and its failure (items sat unclaimed for months); the second announces a change; the third explains the new method (photograph the finds, post the pictures); the last reports the result.\n- Problem, change, method, result — every sentence works toward explaining how photographs got items back to their owners faster, which is what choice A says.\n\n**Why the other choices are wrong:**\n- B: The charity donation is a detail of the OLD system, and the text argues for nothing — it reports a change that already happened.\n- C: Jackets, lunch boxes, and a sweatshirt appear only as passing examples, never as a catalog of what gets lost.\n- D: No single parent's story is told; parents appear only in general, recognizing items \"in seconds.\""
    },
    {
      "id": 1160,
      "type": "multiple-choice",
      ...
      "domain": "craft-and-structure",
      "skill": "text-structure-and-purpose",
      "passage": "Dry sand pours; soaked sand flows. A sandcastle stands only in the narrow zone between the two. When each grain carries a thin film of moisture, water forms tiny bridges at the points where grains touch, and the surface tension of those bridges pulls the grains toward one another. Add too much water and the bridges merge and vanish; let the sand dry out and they evaporate. Experienced builders therefore work with sand that is damp but never dripping, wetting each new handful just enough to keep the bridges intact.",
      "question": "Which choice best states the main purpose of the text?",
      "choices": [
        { "id": "A", "text": "To argue that sandcastle building deserves recognition as a form of engineering rather than as play" },
        { "id": "B", "text": "To describe the tools that experienced sandcastle builders bring to a beach competition" },
        { "id": "C", "text": "To explain why sand must hold the right amount of water to stand as a sculpture" },
        { "id": "D", "text": "To compare the behavior of dry beach sand with the behavior of sand found below the tide line" }
      ],
      "correctAnswer": "C",
    ...
    // ============================================================
    {
      ...
      "choices": [
        ...
        { "id": "B", "text": "Juice boxes cost less to manufacture than glass bottles because paper and plastic are inexpensive materials." },
        { "id": "C", "text": "The aluminum layer in a juice box is thicker and stiffer than the paper layers that surround it." },
        { "id": "D", "text": "Juice stored in a refrigerator keeps its flavor longer than juice stored on an ordinary shelf." }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "choices": [
        ...
        { "id": "B", "text": "will lose their value at the same time, once most collectors have finished filling their albums." },
        { "id": "C", "text": "can trade at very different rates, because what sets a sticker's value at recess is how many copies are in circulation." },
        { "id": "D", "text": "will trade at rates set by how attractive children find each design's artwork." }
      ],
      "correctAnswer": "C",
      "explanation": "**Choice C is correct.** The passage severs price from printing cost — every sticker costs the same fraction of a cent — and ties it to scarcity instead, so equal-cost stickers can still trade at wildly different rates.\n\n**The Full Solution:**\n- How to spot it: find the one variable the passage says sets the outcome, then make the blank turn on that variable. Here the playground exchange rate tracks scarcity: common designs trade one for one, scarce ones \"command ten or more.\"\n- Now note the deliberate mismatch the passage builds: scarcity is manufactured by print runs, while printing cost is identical for every design.\n- So identical cost guarantees nothing about identical value — what matters is how many copies are out there. Choice C states that, and its cautious \"can trade\" matches an inference rather than a certainty.\n\n**Why the other choices are wrong:**\n- A: The traders' consistent pricing of scarce designs shows they DO register scarcity, and equal-cost stickers with different print runs would not trade equally.\n- B: The passage says nothing about albums being completed or values collapsing over time.\n- D: Artwork appeal is never the variable — the passage credits circulation numbers, not looks."
    },
    // ============================================================
