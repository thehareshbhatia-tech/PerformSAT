export const algebraBank = [
  ...
  { id: 'bank-alg-186', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'easy', type: 'fill-in',
    question: 'If $x + 9 = 4$, what is the value of $x$?',
    correctAnswer: '-5',
  ...
  { id: 'bank-alg-188', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'easy', type: 'fill-in',
    question: 'If $\\dfrac{x}{6} = 4$, what is the value of $x$?',
    correctAnswer: '24',
  ...
  { id: 'bank-alg-190', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'medium', type: 'fill-in',
    question: 'If $\\dfrac{2}{3}x = 18$, what is the value of $x$?',
    correctAnswer: '27',
  ...
  { id: 'bank-alg-191', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'medium', type: 'multiple-choice',
    question: 'If $x + \\dfrac{3}{4} = \\dfrac{5}{2}$, what is the value of $x$?',
  ...
  { id: 'bank-alg-192', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'hard', type: 'fill-in',
    question: 'If $-\\dfrac{x}{4} = -3$, what is the value of $x$?',
    correctAnswer: '12',
  ...
  { id: 'bank-alg-203', domain: 'algebra', skills: ['slope-intercept-form'], difficulty: 'medium', type: 'multiple-choice',
    question: 'The line of best fit for a scatterplot of plant height (cm) vs days of growth is $\\hat{y} = 2.5x + 4$. What does the slope of $2.5$ represent?',
  ...
  { id: 'bank-alg-204', domain: 'algebra', skills: ['slope-intercept-form'], difficulty: 'medium', type: 'fill-in',
    question: 'A scatterplot of test scores vs hours studied has a best-fit line $\\hat{y} = 4.2x + 60$. By how many points does the predicted score increase for each additional hour studied?',
    correctAnswer: '4.2',
  ...
  { id: 'bank-alg-207', domain: 'algebra', skills: ['slope-intercept-form'], difficulty: 'hard', type: 'multiple-choice',
    question: 'For a scatterplot, the equation of the line of best fit is $y = -0.25x + 80$. Which of the following best describes the meaning of $-0.25$?',
  ...
  { id: 'bank-alg-215', domain: 'algebra', skills: ['slope-intercept-form'], difficulty: 'hard', type: 'multiple-choice',
    question: 'A line is graphed as $2y = 6x + 10$. What is the slope of the line?',
    choices: [{ id: 'A', text: '$3$' }, { id: 'B', text: '$6$' }, { id: 'C', text: '$5$' }, { id: 'D', text: '$10$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Reading Slope-Intercept Form**\n\n**Choice A is correct.**\n\n**The Fast Way:** Divide by $2$: $y = 3x + 5$. Slope $= 3$.\n\n**Why the wrong answers are tempting:** B doesn\'t divide; C is the new intercept; D doesn\'t divide.\n\n**Test Day Takeaway:** When $y$ has a coefficient $\\ne 1$, FIRST divide both sides to put in $y = mx + b$ form.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'reading-slope-intercept-form', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-alg-216', domain: 'algebra', skills: ['slope-intercept-form'], difficulty: 'hard', type: 'fill-in',
    question: 'What is the $y$-intercept of the line $3y - x = 15$?',
    correctAnswer: '5',
    explanation: '**SAT Pattern: Reading Slope-Intercept Form**\n\n**The correct answer is $5$.**\n\n**The Fast Way:** Solve for $y$: $3y = x + 15 \\Rightarrow y = \\dfrac{x}{3} + 5$. Intercept $= 5$.\n\n**Test Day Takeaway:** Rearrange to $y = mx + b$ FIRST, then read off.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'reading-slope-intercept-form', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  // ===== Phase 2 batch 10/1: perpendicular-slope (8 items) =====
  ...
  { id: 'bank-alg-219', domain: 'algebra', skills: ['perpendicular-negative-reciprocal'], difficulty: 'medium', type: 'multiple-choice',
    question: 'In the $xy$-plane, line $p$ has the equation $2x + 5y = 10$. What is the slope of a line perpendicular to line $p$?',
    choices: [{ id: 'A', text: '$\\dfrac{5}{2}$' }, { id: 'B', text: '$-\\dfrac{2}{5}$' }, { id: 'C', text: '$-\\dfrac{5}{2}$' }, { id: 'D', text: '$\\dfrac{2}{5}$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Perpendicular Slope**\n\n**Choice A is correct.**\n\n**The Fast Way:** Slope of $p$ = $-A/B = -2/5$. Perpendicular: $5/2$.\n\n**Test Day Takeaway:** Standard form slope: $-A/B$. Flip and negate for perpendicular.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'perpendicular-slope', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  ...
  { id: 'bank-alg-233', domain: 'algebra', skills: ['distributive-property'], difficulty: 'easy', type: 'fill-in',
    question: 'If $(x + 3)(x - 4) = x^2 + bx - 12$, what is the value of $b$?',
    correctAnswer: '-1',
  ...
  { id: 'bank-alg-234', domain: 'algebra', skills: ['distributive-property'], difficulty: 'medium', type: 'multiple-choice',
    question: 'If $(2x + 3)(x + 4) = 2x^2 + ax + 12$, what is the value of $a$?',
  ...
  { id: 'bank-alg-235', domain: 'algebra', skills: ['distributive-property'], difficulty: 'medium', type: 'fill-in',
    question: 'If $(3x - 2)(x + a) = 3x^2 + 7x - 6$, what is the value of $a$?',
    correctAnswer: '3',
  ...
  { id: 'bank-alg-237', domain: 'algebra', skills: ['distributive-property'], difficulty: 'medium', type: 'fill-in',
    question: 'If $(x + 5)^2 = x^2 + kx + 25$, what is the value of $k$?',
    correctAnswer: '10',
  ...
  { id: 'bank-alg-238', domain: 'algebra', skills: ['distributive-property'], difficulty: 'hard', type: 'multiple-choice',
    question: 'For all $x$, $(2x + a)(3x + b) = 6x^2 + 13x + 6$. What is the value of $a \\cdot b$?',
    choices: [{ id: 'A', text: '$6$' }, { id: 'B', text: '$13$' }, { id: 'C', text: '$5$' }, { id: 'D', text: '$1$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Matching Coefficients**\n\n**Choice A is correct.**\n\n**The Fast Way:** Constant: $ab = 6$.\n\n**Test Day Takeaway:** The product of the factor constants equals the trinomial constant — direct read.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'matching-coefficients', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-alg-239', domain: 'algebra', skills: ['distributive-property'], difficulty: 'hard', type: 'fill-in',
    question: 'If $(x - 3)(x + a) = x^2 + 2x - 15$, what is the value of $a$?',
    correctAnswer: '5',
  ...
  { id: 'bank-alg-284', domain: 'algebra', skills: ['system-solution-types'], difficulty: 'medium', type: 'multiple-choice',
    question: 'The equation $5(2x - 3) = 10x - 15$ is true for which value(s) of $x$?',
    choices: [{ id: 'A', text: 'All real values' }, { id: 'B', text: 'Only $x = 0$' }, { id: 'C', text: 'No real values' }, { id: 'D', text: 'Only $x = 15$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Identifying Identity / Contradiction Equations**\n\n**Choice A is correct.**\n\n**The Fast Way:** LHS $= 10x - 15 = $ RHS. Identity.\n\n**Test Day Takeaway:** Identity ⇔ true for ALL $x$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'identifying-identity-contradiction-equations', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  ...
  { id: 'bank-alg-297', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'easy', type: 'fill-in',
    question: 'If $4x - 3 = 2x + 9$, what is the value of $x$?', correctAnswer: '6',
    explanation: '**SAT Pattern: Linear Equation with Variables on Both Sides**\n\nThe correct answer is $6$. $2x = 12 ⇒ x = 6$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'linear-equation-with-variables-on-both-sides', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-alg-298', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'medium', type: 'multiple-choice',
    question: 'If $7 - 2x = x + 4$, what is $x$?',
    choices: [{ id: 'A', text: '$1$' }, { id: 'B', text: '$-1$' }, { id: 'C', text: '$11$' }, { id: 'D', text: '$3$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Linear Equation with Variables on Both Sides**\n\nThe correct answer is $1$. $7 - 4 = 3x ⇒ x = 1$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'linear-equation-with-variables-on-both-sides', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-alg-299', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'medium', type: 'fill-in',
    question: 'If $\\dfrac{x + 5}{3} = \\dfrac{x - 1}{2}$, what is $x$?', correctAnswer: '13',
    explanation: '**SAT Pattern: Linear Equation with Variables on Both Sides**\n\nThe correct answer is $13$. Cross-multiply: $2(x + 5) = 3(x - 1) ⇒ 2x + 10 = 3x - 3 ⇒ x = 13$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'linear-equation-with-variables-on-both-sides', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-alg-300', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'medium', type: 'multiple-choice',
    ...
    choices: [{ id: 'A', text: '$9$' }, { id: 'B', text: '$3$' }, { id: 'C', text: '$1$' }, { id: 'D', text: '$-1$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Linear Equation with Variables on Both Sides**\n\nThe correct answer is $9$. $5x - 10 = 3x + 8 ⇒ 2x = 18 ⇒ x = 9$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'linear-equation-with-variables-on-both-sides', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-alg-301', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'medium', type: 'fill-in',
    question: 'If $3(x + 4) = 5(x - 2)$, what is $x$?', correctAnswer: '11',
    explanation: '**SAT Pattern: Linear Equation with Variables on Both Sides**\n\nThe correct answer is $11$. $3x + 12 = 5x - 10 ⇒ -2x = -22 ⇒ x = 11$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'linear-equation-with-variables-on-both-sides', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-alg-302', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'hard', type: 'multiple-choice',
    question: 'If $\\dfrac{2x - 1}{4} = \\dfrac{x + 3}{6}$, what is $x$?',
    choices: [{ id: 'A', text: '$\\dfrac{9}{2}$' }, { id: 'B', text: '$3$' }, { id: 'C', text: '$1$' }, { id: 'D', text: '$\\dfrac{15}{4}$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Linear Equation with Variables on Both Sides**\n\nThe correct answer is $9/2$. Cross-multiply: $6(2x - 1) = 4(x + 3) ⇒ 12x - 6 = 4x + 12 ⇒ x = 9/2$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'linear-equation-with-variables-on-both-sides', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-alg-303', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'hard', type: 'fill-in',
    question: 'If $2(3x - 1) - 4 = 5x + 3$, what is $x$?', correctAnswer: '9',
    explanation: '**SAT Pattern: Linear Equation with Variables on Both Sides**\n\nThe correct answer is $9$. LHS: $6x - 6$. So $6x - 6 = 5x + 3 ⇒ x = 9$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'linear-equation-with-variables-on-both-sides', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  ...
  { id: 'bank-alg-312', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'easy', type: 'multiple-choice',
    ...
    choices: [{ id: 'A', text: '$6x$' }, { id: 'B', text: '$10x$' }, { id: 'C', text: '$5x$' }, { id: 'D', text: '$x$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Combining Like Terms**\n\nThe correct answer is $6x$. $3 + 5 - 2 = 6$.',
  ...
  { id: 'bank-alg-313', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'easy', type: 'fill-in',
    question: 'Simplify $4y - 7y + 2y$ and give the coefficient of $y$.', correctAnswer: '-1',
    explanation: '**SAT Pattern: Combining Like Terms**\n\nThe correct answer is $-1$. $4 - 7 + 2 = -1$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'combining-like-terms', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-alg-314', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Combining Like Terms**\n\nThe correct answer is $7x + 3$. Combine $x$ and constants separately.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'combining-like-terms', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-alg-315', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'medium', type: 'fill-in',
    question: 'After simplifying $2x^2 + 3x - x^2 + 4x$, what is the coefficient of $x$?', correctAnswer: '7',
    explanation: '**SAT Pattern: Combining Like Terms**\n\nThe correct answer is $7$. $3x + 4x = 7x$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'combining-like-terms', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-alg-316', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'medium', type: 'multiple-choice',
    question: 'Simplify $5(x - 2) - 3(x + 4)$.',
    choices: [{ id: 'A', text: '$2x - 22$' }, { id: 'B', text: '$2x + 2$' }, { id: 'C', text: '$8x - 22$' }, { id: 'D', text: '$2x - 6$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Combining Like Terms**\n\nThe correct answer is $2x - 22$. $5x - 10 - 3x - 12 = 2x - 22$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'combining-like-terms', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-alg-317', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'medium', type: 'fill-in',
    question: 'After simplifying $4(2x - 1) - 3(x + 2)$, what is the constant term?', correctAnswer: '-10',
    explanation: '**SAT Pattern: Combining Like Terms**\n\nThe correct answer is $-10$. $-4 - 6 = -10$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'combining-like-terms', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-alg-318', domain: 'algebra', skills: ['combining-like-terms'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Combining Like Terms**\n\nThe correct answer is $x^2 + 11x$. $2x^2 - x^2 = x^2$; $6x + 5x = 11x$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'combining-like-terms', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
