export const geometryBank = [
  ...
  { id: 'bank-geo-139', domain: 'geometry', skills: ['volume-prism'], difficulty: 'easy', type: 'multiple-choice',
    question: 'A rectangular prism has length $5$, width $3$, and height $4$. What is its volume?',
    choices: [{ id: 'A', text: '$60$' }, { id: 'B', text: '$12$' }, { id: 'C', text: '$47$' }, { id: 'D', text: '$120$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Volume of a Rectangular Prism**\n\nThe correct answer is $60$. $V = l \\cdot w \\cdot h = 5 \\cdot 3 \\cdot 4 = 60$.\n\n**Test Day Takeaway:** $V_{\\text{prism}} = l \\cdot w \\cdot h$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'volume-of-a-rectangular-prism', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-140', domain: 'geometry', skills: ['volume-prism'], difficulty: 'easy', type: 'fill-in',
    question: 'A box has dimensions $2$ ft by $3$ ft by $5$ ft. What is its volume, in cubic feet?', correctAnswer: '30',
    explanation: '**SAT Pattern: Volume of a Rectangular Prism**\n\nThe correct answer is $30$. $2 \\cdot 3 \\cdot 5 = 30$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'volume-of-a-rectangular-prism', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-141', domain: 'geometry', skills: ['volume-prism'], difficulty: 'medium', type: 'multiple-choice',
    question: 'A rectangular prism has volume $72$, length $6$, and width $4$. What is its height?',
    choices: [{ id: 'A', text: '$3$' }, { id: 'B', text: '$24$' }, { id: 'C', text: '$18$' }, { id: 'D', text: '$12$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Volume of a Rectangular Prism**\n\nThe correct answer is $3$. $h = V / (lw) = 72/24 = 3$.\n\n**Test Day Takeaway:** Reverse: $h = V/(lw)$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'volume-of-a-rectangular-prism', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-142', domain: 'geometry', skills: ['volume-prism'], difficulty: 'medium', type: 'fill-in',
    question: 'A cube has a side length of $4$ cm. What is its volume, in cubic centimeters?', correctAnswer: '64',
    explanation: '**SAT Pattern: Volume of a Rectangular Prism**\n\nThe correct answer is $64$. Cube: $V = s^3 = 4^3 = 64$.\n\n**Test Day Takeaway:** Cube is a rectangular prism with $l = w = h$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'volume-of-a-rectangular-prism', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-143', domain: 'geometry', skills: ['volume-prism'], difficulty: 'medium', type: 'multiple-choice',
    question: 'A rectangular box has a square base with side $5$ and a height of $8$. What is its volume?',
    choices: [{ id: 'A', text: '$200$' }, { id: 'B', text: '$40$' }, { id: 'C', text: '$125$' }, { id: 'D', text: '$80$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Volume of a Rectangular Prism**\n\nThe correct answer is $200$. $5 \\cdot 5 \\cdot 8 = 200$.\n\n**Test Day Takeaway:** Square base ⇒ $l = w$. Volume $= s^2 \\cdot h$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'volume-of-a-rectangular-prism', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-144', domain: 'geometry', skills: ['volume-prism'], difficulty: 'medium', type: 'fill-in',
    question: 'A box has volume $48$ cubic inches and a square base with side $4$ inches. What is its height, in inches?', correctAnswer: '3',
    explanation: '**SAT Pattern: Volume of a Rectangular Prism**\n\nThe correct answer is $3$. $h = 48/16 = 3$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'volume-of-a-rectangular-prism', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-145', domain: 'geometry', skills: ['volume-prism'], difficulty: 'hard', type: 'multiple-choice',
    question: 'If the dimensions of a rectangular prism are doubled, by what factor is its volume multiplied?',
    choices: [{ id: 'A', text: '$8$' }, { id: 'B', text: '$2$' }, { id: 'C', text: '$4$' }, { id: 'D', text: '$6$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Volume of a Rectangular Prism**\n\nThe correct answer is $8$. $(2l)(2w)(2h) = 8 lwh$.\n\n**Test Day Takeaway:** Linear scaling by $k$ ⇒ volume scaling by $k^3$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'volume-of-a-rectangular-prism', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-146', domain: 'geometry', skills: ['volume-prism'], difficulty: 'hard', type: 'fill-in',
    question: 'A cube has volume $125$ cubic inches. What is its surface area, in square inches?', correctAnswer: '150',
    explanation: '**SAT Pattern: Volume of a Rectangular Prism**\n\nThe correct answer is $150$. $s = \\sqrt[3]{125} = 5$. Surface area: $6s^2 = 6 \\cdot 25 = 150$.\n\n**Test Day Takeaway:** Cube: $V = s^3$, $SA = 6s^2$. Cube-root the volume to get the side.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'volume-of-a-rectangular-prism', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  ...
  { id: 'bank-geo-147', domain: 'geometry', skills: ['circle-equation'], difficulty: 'easy', type: 'multiple-choice',
    question: 'A circle has radius $5$. What is its area, in terms of $\\pi$?',
    choices: [{ id: 'A', text: '$25\\pi$' }, { id: 'B', text: '$10\\pi$' }, { id: 'C', text: '$5\\pi$' }, { id: 'D', text: '$50\\pi$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Area of a Circle**\n\nThe correct answer is $25\\pi$. $A = \\pi r^2 = \\pi(5)^2 = 25\\pi$.\n\n**Test Day Takeaway:** Circle area: $\\pi r^2$ (not $\\pi r$).',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'area-of-a-circle', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-148', domain: 'geometry', skills: ['circle-equation'], difficulty: 'easy', type: 'fill-in',
    question: 'A circle has radius $3$. What is its area, expressed as $k\\pi$? Give $k$.', correctAnswer: '9',
    explanation: '**SAT Pattern: Area of a Circle**\n\nThe correct answer is $9$. $A = 9\\pi$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'area-of-a-circle', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-149', domain: 'geometry', skills: ['circle-equation'], difficulty: 'medium', type: 'multiple-choice',
    question: 'A circle has area $36\\pi$. What is its radius?',
    choices: [{ id: 'A', text: '$6$' }, { id: 'B', text: '$36$' }, { id: 'C', text: '$18$' }, { id: 'D', text: '$12$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Area of a Circle**\n\nThe correct answer is $6$. $r^2 = 36 \\Rightarrow r = 6$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'area-of-a-circle', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-150', domain: 'geometry', skills: ['circle-equation'], difficulty: 'medium', type: 'fill-in',
    question: 'A circle has diameter $14$. What is its area, in terms of $\\pi$? Give the coefficient of $\\pi$.', correctAnswer: '49',
    explanation: '**SAT Pattern: Area of a Circle**\n\nThe correct answer is $49$. $r = 7$, $A = 49\\pi$.\n\n**Test Day Takeaway:** Diameter ⇒ halve to get radius FIRST.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'area-of-a-circle', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-151', domain: 'geometry', skills: ['circle-equation'], difficulty: 'medium', type: 'multiple-choice',
    question: 'If the radius of a circle is doubled, by what factor does the area change?',
    choices: [{ id: 'A', text: '$4$' }, { id: 'B', text: '$2$' }, { id: 'C', text: '$8$' }, { id: 'D', text: '$1$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Area of a Circle**\n\nThe correct answer is $4$. $\\pi(2r)^2 = 4\\pi r^2$.\n\n**Test Day Takeaway:** Radius scales by $k$ ⇒ area scales by $k^2$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'area-of-a-circle', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-152', domain: 'geometry', skills: ['circle-equation'], difficulty: 'medium', type: 'fill-in',
    question: 'A circle has area $100\\pi$. What is its circumference, in terms of $\\pi$? Give the coefficient.', correctAnswer: '20',
    explanation: '**SAT Pattern: Area of a Circle**\n\nThe correct answer is $20$. $r = 10$. $C = 2\\pi r = 20\\pi$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'area-of-a-circle', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-153', domain: 'geometry', skills: ['circle-equation'], difficulty: 'hard', type: 'multiple-choice',
    question: 'A circle has circumference $12\\pi$. What is its area, in terms of $\\pi$?',
    choices: [{ id: 'A', text: '$36\\pi$' }, { id: 'B', text: '$144\\pi$' }, { id: 'C', text: '$24\\pi$' }, { id: 'D', text: '$6\\pi$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Area of a Circle**\n\nThe correct answer is $36\\pi$. $2\\pi r = 12\\pi \\Rightarrow r = 6$. $A = 36\\pi$.\n\n**Test Day Takeaway:** Circumference $\\to$ radius $\\to$ area.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'area-of-a-circle', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-154', domain: 'geometry', skills: ['circle-equation'], difficulty: 'hard', type: 'fill-in',
    question: 'A circle is inscribed in a square of side $10$. What is the area of the circle, in terms of $\\pi$? Give the coefficient.', correctAnswer: '25',
    explanation: '**SAT Pattern: Area of a Circle**\n\nThe correct answer is $25$. Inscribed: diameter $= 10$, $r = 5$. $A = 25\\pi$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'area-of-a-circle', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  ...
  { id: 'bank-geo-155', domain: 'geometry', skills: ['triangle-area'], difficulty: 'easy', type: 'multiple-choice',
    ...
    choices: [{ id: 'A', text: '$28$' }, { id: 'B', text: '$49$' }, { id: 'C', text: '$14$' }, { id: 'D', text: '$21$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Square Perimeter**\n\nThe correct answer is $28$. $P = 4s = 28$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'square-perimeter', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-156', domain: 'geometry', skills: ['triangle-area'], difficulty: 'easy', type: 'fill-in',
    question: 'A square has area $64$. What is its perimeter?', correctAnswer: '32',
    explanation: '**SAT Pattern: Square Perimeter**\n\nThe correct answer is $32$. $s = 8$, $P = 32$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'square-perimeter', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-157', domain: 'geometry', skills: ['triangle-area'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Square Perimeter**\n\nThe correct answer is $81$. $s = 9$, area $= 81$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'square-perimeter', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-158', domain: 'geometry', skills: ['triangle-area'], difficulty: 'medium', type: 'fill-in',
    question: 'A square has diagonal $\\sqrt{50}$. What is its perimeter?', correctAnswer: '20',
    explanation: '**SAT Pattern: Square Perimeter**\n\nThe correct answer is $20$. Diagonal $= s\\sqrt{2}$, so $s = \\sqrt{50}/\\sqrt{2} = \\sqrt{25} = 5$. $P = 20$.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'square-perimeter', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-159', domain: 'geometry', skills: ['triangle-area'], difficulty: 'medium', type: 'multiple-choice',
    question: 'If a square\'s perimeter doubles, by what factor does its area change?',
    choices: [{ id: 'A', text: '$4$' }, { id: 'B', text: '$2$' }, { id: 'C', text: '$8$' }, { id: 'D', text: '$1$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Square Perimeter**\n\nThe correct answer is $4$. Side doubles, area scales by $2^2 = 4$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'square-perimeter', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-160', domain: 'geometry', skills: ['triangle-area'], difficulty: 'medium', type: 'fill-in',
    question: 'A square has side length $x$. If $x = 9$, what is the perimeter?', correctAnswer: '36',
    explanation: '**SAT Pattern: Square Perimeter**\n\nThe correct answer is $36$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'square-perimeter', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-161', domain: 'geometry', skills: ['triangle-area'], difficulty: 'hard', type: 'multiple-choice',
    question: 'A square has side length $2x + 3$. Which expression gives the perimeter?',
    choices: [{ id: 'A', text: '$8x + 12$' }, { id: 'B', text: '$4x + 12$' }, { id: 'C', text: '$8x + 3$' }, { id: 'D', text: '$2x + 12$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Square Perimeter**\n\nThe correct answer is $8x + 12$. $4(2x + 3) = 8x + 12$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'square-perimeter', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-162', domain: 'geometry', skills: ['triangle-area'], difficulty: 'hard', type: 'fill-in',
    question: 'A square has perimeter $4x + 16$ and side length $x + 4$. If the perimeter is $48$, what is the value of $x$?', correctAnswer: '8',
    explanation: '**SAT Pattern: Square Perimeter**\n\nThe correct answer is $8$. $4x + 16 = 48 \\Rightarrow x = 8$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'square-perimeter', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  ...
  { id: 'bank-geo-163', domain: 'geometry', skills: ['triangle-angle-sum'], difficulty: 'easy', type: 'multiple-choice',
    question: 'Two parallel lines are cut by a transversal. If one of the angles formed measures $65°$, what is the measure of its alternate interior angle?',
    choices: [{ id: 'A', text: '$65°$' }, { id: 'B', text: '$115°$' }, { id: 'C', text: '$25°$' }, { id: 'D', text: '$130°$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Angles with Parallel Lines and Transversals**\n\nThe correct answer is $65°$. Alternate interior angles are CONGRUENT.\n\n**Test Day Takeaway:** Parallel + transversal: corresponding & alternate angles are equal.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'angles-with-parallel-lines-and-transversals', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-164', domain: 'geometry', skills: ['triangle-angle-sum'], difficulty: 'easy', type: 'fill-in',
    question: 'When two parallel lines are cut by a transversal, two same-side interior angles measure $x°$ and $(2x + 30)°$. What is the value of $x$?', correctAnswer: '50',
    explanation: '**SAT Pattern: Angles with Parallel Lines and Transversals**\n\nThe correct answer is $50$. Same-side interior angles are SUPPLEMENTARY: $x + 2x + 30 = 180 \\Rightarrow x = 50$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'angles-with-parallel-lines-and-transversals', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-165', domain: 'geometry', skills: ['triangle-angle-sum'], difficulty: 'medium', type: 'multiple-choice',
    question: 'Two parallel lines are cut by a transversal. If one angle is $48°$, what is the corresponding angle?',
    choices: [{ id: 'A', text: '$48°$' }, { id: 'B', text: '$132°$' }, { id: 'C', text: '$42°$' }, { id: 'D', text: '$96°$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Angles with Parallel Lines and Transversals**\n\nThe correct answer is $48°$. Corresponding angles are CONGRUENT.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'angles-with-parallel-lines-and-transversals', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-166', domain: 'geometry', skills: ['triangle-angle-sum'], difficulty: 'medium', type: 'fill-in',
    question: 'Lines $\\ell_1$ and $\\ell_2$ are parallel. A transversal makes an angle of $70°$ with $\\ell_1$. What is the measure of the co-interior (consecutive interior) angle on $\\ell_2$?', correctAnswer: '110',
    explanation: '**SAT Pattern: Angles with Parallel Lines and Transversals**\n\nThe correct answer is $110$. Co-interior angles are supplementary: $180 - 70 = 110$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'angles-with-parallel-lines-and-transversals', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-167', domain: 'geometry', skills: ['triangle-angle-sum'], difficulty: 'medium', type: 'multiple-choice',
    question: 'Two parallel lines and a transversal form vertical angles. If one vertical angle is $115°$, what is the other?',
    choices: [{ id: 'A', text: '$115°$' }, { id: 'B', text: '$65°$' }, { id: 'C', text: '$45°$' }, { id: 'D', text: '$230°$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Angles with Parallel Lines and Transversals**\n\nThe correct answer is $115°$. Vertical angles are always CONGRUENT.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'angles-with-parallel-lines-and-transversals', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-168', domain: 'geometry', skills: ['triangle-angle-sum'], difficulty: 'medium', type: 'fill-in',
    question: 'Two parallel lines are cut by a transversal. One angle is $(3x + 10)°$ and its corresponding angle is $(4x - 20)°$. What is the value of $x$?', correctAnswer: '30',
    explanation: '**SAT Pattern: Angles with Parallel Lines and Transversals**\n\nThe correct answer is $30$. Corresponding angles equal: $3x + 10 = 4x - 20 \\Rightarrow x = 30$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'angles-with-parallel-lines-and-transversals', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-169', domain: 'geometry', skills: ['triangle-angle-sum'], difficulty: 'hard', type: 'multiple-choice',
    question: 'Lines $\\ell_1$ and $\\ell_2$ are parallel. A transversal forms an angle of $5x°$ on $\\ell_1$ and a same-side interior angle of $(x + 30)°$ on $\\ell_2$. What is the value of $x$?',
    choices: [{ id: 'A', text: '$25$' }, { id: 'B', text: '$30$' }, { id: 'C', text: '$35$' }, { id: 'D', text: '$45$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Angles with Parallel Lines and Transversals**\n\nThe correct answer is $25$. Supplementary: $5x + (x + 30) = 180 \\Rightarrow 6x = 150 \\Rightarrow x = 25$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'angles-with-parallel-lines-and-transversals', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
  { id: 'bank-geo-170', domain: 'geometry', skills: ['triangle-angle-sum'], difficulty: 'hard', type: 'fill-in',
    question: 'Two parallel lines are cut by a transversal forming alternate exterior angles measuring $(2x + 15)°$ and $(3x - 10)°$. What is the value of $x$?', correctAnswer: '25',
    explanation: '**SAT Pattern: Angles with Parallel Lines and Transversals**\n\nThe correct answer is $25$. Alternate exterior angles are equal: $2x + 15 = 3x - 10 \\Rightarrow x = 25$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'angles-with-parallel-lines-and-transversals', authoredBy: 'performsat-engine', createdAt: '2026-05-11' },
