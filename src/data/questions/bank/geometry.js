export const geometryBank = [
  ...
  { id: 'bank-geo-241', domain: 'geometry', skills: ['circle-area'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Circumference of a Circle**\n\n**Choice B is correct.**\n\n**The Fast Way (~15s):** One revolution = $C = 26\\pi \\approx 81.68$ in. $1040/81.68 \\approx 12.73 \\approx 13$.\n\n**Why the wrong answers are tempting:**\n* A: off-by-one underestimate.\n* C: uses radius instead of diameter for $C$.\n* D: divides by $d$ instead of $\\pi d$.\n\n**Test Day Takeaway:** Each revolution covers one circumference. Total distance / $C$ = revolutions.",
    calculatorAllowed: true, tags: [], sourceStyleRef: 'circumference-of-a-circle', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-242', domain: 'geometry', skills: ['circle-area'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Circumference of a Circle**\n\n**Choice B is correct.**\n\n**The Fast Way (~10s):** $C = 2\\pi r = 12\\pi \\Rightarrow r = 6$. $A = \\pi r^2 = 36\\pi$.\n\n**Why the wrong answers are tempting:**\n* A: forgets to square $r$.\n* C: doubles area.\n* D: uses $r = 12$ instead of $6$.\n\n**Test Day Takeaway:** Linking $C$ and $A$: solve for $r$ first, then plug into the other formula.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'circumference-of-a-circle', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-246', domain: 'geometry', skills: ['trigonometry'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Radians ↔ Degrees Conversion**\n\n**Choice C is correct.**\n\n**The Fast Way (~5s):** $\\theta_{rad} = \\theta_{deg} \\cdot \\dfrac{\\pi}{180} = 90 \\cdot \\dfrac{\\pi}{180} = \\dfrac{\\pi}{2}$.\n\n**Why the wrong answers are tempting:**\n* A: $45°$ in radians.\n* B: $60°$ in radians.\n* D: $180°$ in radians.\n\n**Test Day Takeaway:** Memorize benchmarks: $30° = \\pi/6$, $45° = \\pi/4$, $60° = \\pi/3$, $90° = \\pi/2$, $180° = \\pi$.",
  ...
  { id: 'bank-geo-247', domain: 'geometry', skills: ['trigonometry'], difficulty: 'medium', type: 'fill-in',
    ...
    correctAnswer: '150',
    explanation: "**SAT Pattern: Radians ↔ Degrees Conversion**\n\n**The correct answer is $150$.**\n\n**The Fast Way (~10s):** $\\theta_{deg} = \\dfrac{5\\pi}{6} \\cdot \\dfrac{180}{\\pi} = \\dfrac{5 \\cdot 180}{6} = 150$.\n\n**Test Day Takeaway:** Radians → degrees: multiply by $180/\\pi$. The $\\pi$'s cancel.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'radians-degrees-conversion', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-248', domain: 'geometry', skills: ['trigonometry'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Radians ↔ Degrees Conversion**\n\n**Choice B is correct.**\n\n**The Fast Way (~10s):** $135 \\cdot \\dfrac{\\pi}{180} = \\dfrac{135\\pi}{180} = \\dfrac{3\\pi}{4}$ (divide both by $45$).\n\n**Why the wrong answers are tempting:**\n* A: $45°$ in radians.\n* C: $240°$ in radians.\n* D: $225°$ in radians.\n\n**Test Day Takeaway:** Reduce $\\dfrac{\\theta_{deg}}{180}$ before attaching $\\pi$.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'radians-degrees-conversion', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-249', domain: 'geometry', skills: ['right-triangles'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: 30-60-90 Triangle**\n\n**Choice C is correct.**\n\n**The Fast Way (~5s):** Side ratio $1 : \\sqrt{3} : 2$ (opp $30°$ : opp $60°$ : hypotenuse). Hypotenuse $= 2 \\cdot 5 = 10$.\n\n**Why the wrong answers are tempting:**\n* A: copies short side.\n* B: long leg.\n* D: doubles long leg.\n\n**Test Day Takeaway:** $30$-$60$-$90$: short : long : hyp $= 1 : \\sqrt{3} : 2$. Hypotenuse is ALWAYS twice the short leg.",
  ...
  { id: 'bank-geo-250', domain: 'geometry', skills: ['right-triangles'], difficulty: 'easy', type: 'fill-in',
    ...
    explanation: "**SAT Pattern: 30-60-90 Triangle**\n\n**The correct answer is $7\\sqrt{3}$.**\n\n**The Fast Way (~10s):** Hypotenuse $= 2 \\cdot$ short leg, so short leg $= 7$. Long leg (opp $60°$) $= 7\\sqrt{3}$.\n\n**Test Day Takeaway:** Find SHORT leg first ($=$ hyp $/2$), then scale to find long leg ($\\times \\sqrt{3}$).",
    calculatorAllowed: false, tags: [], sourceStyleRef: '30-60-90-triangle', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-251', domain: 'geometry', skills: ['right-triangles'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: 30-60-90 Triangle**\n\n**Choice B is correct.**\n\n**The Fast Way (~10s):** Long leg $=$ short leg $\\cdot \\sqrt{3} = 6\\sqrt{3} \\Rightarrow$ short leg $= 6$. Hypotenuse $= 12$.\n\n**Test Day Takeaway:** Given the long leg, divide by $\\sqrt{3}$ → short leg → double for hypotenuse.",
    calculatorAllowed: false, tags: [], sourceStyleRef: '30-60-90-triangle', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-252', domain: 'geometry', skills: ['right-triangles'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: 30-60-90 Triangle**\n\n**Choice B is correct.**\n\n**The Fast Way (~10s):** Drop a height in the equilateral — it forms two $30$-$60$-$90$ triangles with hypotenuse $8$. Short leg $= 4$, long leg (the height) $= 4\\sqrt{3}$.\n\n**Test Day Takeaway:** Height of equilateral with side $s$ = $\\dfrac{s\\sqrt{3}}{2}$.",
    calculatorAllowed: false, tags: [], sourceStyleRef: '30-60-90-triangle', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-254', domain: 'geometry', skills: ['right-triangles'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: 30-60-90 Triangle**\n\n**Choice B is correct.**\n\n**The Fast Way (~10s):** Legs are $4$ and $4\\sqrt{3}$. Area $= (1/2)(4)(4\\sqrt{3}) = 8\\sqrt{3}$.\n\n**Test Day Takeaway:** Two legs of a $30$-$60$-$90$ act as the base and height of the right triangle. Area $= \\dfrac{x \\cdot x\\sqrt{3}}{2} = \\dfrac{x^2 \\sqrt{3}}{2}$ where $x$ is the short leg.",
    calculatorAllowed: false, tags: [], sourceStyleRef: '30-60-90-triangle', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-256', domain: 'geometry', skills: ['right-triangles'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: 45-45-90 Triangle**\n\n**Choice B is correct.**\n\n**The Fast Way (~5s):** Ratio is $1 : 1 : \\sqrt{2}$. Hypotenuse $= 7\\sqrt{2}$.\n\n**Why the wrong answers are tempting:**\n* A: copies leg.\n* C: doubles leg (wrong — multiplier is $\\sqrt{2}$).\n* D: doubles AND multiplies by $\\sqrt{2}$.\n\n**Test Day Takeaway:** $45$-$45$-$90$: legs equal, hypotenuse = leg $\\times \\sqrt{2}$.",
  ...
  { id: 'bank-geo-257', domain: 'geometry', skills: ['right-triangles'], difficulty: 'easy', type: 'fill-in',
    ...
    correctAnswer: '10',
    explanation: "**SAT Pattern: 45-45-90 Triangle**\n\n**The correct answer is $10$.**\n\n**The Fast Way (~5s):** Square diagonal $= s\\sqrt{2}$ ($45$-$45$-$90$ halves the square). $s = 10\\sqrt{2}/\\sqrt{2} = 10$.\n\n**Test Day Takeaway:** Square diagonal $= s\\sqrt{2}$.",
    calculatorAllowed: false, tags: [], sourceStyleRef: '45-45-90-triangle', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-258', domain: 'geometry', skills: ['right-triangles'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: 45-45-90 Triangle**\n\n**Choice B is correct.**\n\n**The Fast Way (~10s):** Leg $=$ hypotenuse $/ \\sqrt{2} = 20/\\sqrt{2} = 10\\sqrt{2}$.\n\n**Why the wrong answers are tempting:**\n* A: divides by $2$ (mixing with $30$-$60$-$90$).\n* C: multiplies by $\\sqrt{2}$ instead of dividing.\n* D: doubles hypotenuse.\n\n**Test Day Takeaway:** Hyp → leg: divide by $\\sqrt{2}$.",
    calculatorAllowed: false, tags: [], sourceStyleRef: '45-45-90-triangle', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-259', domain: 'geometry', skills: ['right-triangles'], difficulty: 'medium', type: 'fill-in',
    ...
    explanation: "**SAT Pattern: 45-45-90 Triangle**\n\n**The correct answer is $6\\sqrt{2}$.**\n\n**The Fast Way (~5s):** Square diagonal $= s\\sqrt{2} = 6\\sqrt{2}$.\n\n**Test Day Takeaway:** Diagonal of a square is the hypotenuse of a $45$-$45$-$90$ triangle.",
    calculatorAllowed: false, tags: [], sourceStyleRef: '45-45-90-triangle', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-261', domain: 'geometry', skills: ['right-triangles'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: 45-45-90 Triangle**\n\n**Choice C is correct.**\n\n**The Fast Way (~15s):** Legs $= 2\\sqrt{2}$ each. Hypotenuse $= 2\\sqrt{2} \\cdot \\sqrt{2} = 4$. Perimeter $= 2\\sqrt{2} + 2\\sqrt{2} + 4 = 4\\sqrt{2} + 4$.\n\n**Test Day Takeaway:** Add all three sides. Hypotenuse for $45$-$45$-$90$ leg $= s\\sqrt{2} = s \\cdot \\sqrt{2}$.",
    calculatorAllowed: false, tags: [], sourceStyleRef: '45-45-90-triangle', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-263', domain: 'geometry', skills: ['angles'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Vertical Angles**\n\n**Choice B is correct.**\n\n**The Fast Way (~3s):** Vertical angles are EQUAL.\n\n**Why the wrong answers are tempting:**\n* A: complement.\n* C: right angle.\n* D: supplement.\n\n**Test Day Takeaway:** At an intersection, OPPOSITE angles are congruent; ADJACENT angles sum to $180°$.",
  ...
  { id: 'bank-geo-264', domain: 'geometry', skills: ['angles'], difficulty: 'easy', type: 'fill-in',
    ...
    correctAnswer: '115',
    explanation: "**SAT Pattern: Vertical Angles**\n\n**The correct answer is $115$.**\n\n**The Fast Way (~3s):** Vertical angles are equal.\n\n**Test Day Takeaway:** The angle across from any given angle at an intersection has the same measure.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'vertical-angles', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-265', domain: 'geometry', skills: ['angles'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Vertical Angles**\n\n**Choice B is correct.**\n\n**The Fast Way (~10s):** Set vertical-angle expressions equal: $3x + 10 = 5x - 30 \\Rightarrow 40 = 2x \\Rightarrow x = 20$.\n\n**Why the wrong answers are tempting:**\n* A: small algebra slip.\n* C: random.\n* D: uses supplementary equation ($3x + 10 + 5x - 30 = 180$).\n\n**Test Day Takeaway:** Vertical-angle expressions are SET EQUAL. Adjacent expressions sum to $180°$.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'vertical-angles', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-266', domain: 'geometry', skills: ['angles'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Vertical Angles**\n\n**Choice B is correct.**\n\n**The Fast Way (~5s):** Labeled clockwise, $\\angle 1$ and $\\angle 3$ are opposite — vertical angles. $\\angle 3 = 73°$.\n\n**Why the wrong answers are tempting:**\n* A: complement.\n* C: supplement ($\\angle 2$ or $\\angle 4$).\n* D: reflex.\n\n**Test Day Takeaway:** Labeling pattern: $\\angle 1, \\angle 3$ are vertical (equal); $\\angle 2, \\angle 4$ are vertical (equal); adjacent pairs are supplementary.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'vertical-angles', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-267', domain: 'geometry', skills: ['angles'], difficulty: 'medium', type: 'fill-in',
    ...
    correctAnswer: '65',
    explanation: "**SAT Pattern: Vertical Angles**\n\n**The correct answer is $65$.**\n\n**The Fast Way (~15s):** $2x + 25 = 4x - 15 \\Rightarrow 40 = 2x \\Rightarrow x = 20$. Angle: $2(20) + 25 = 65°$.\n\n**Test Day Takeaway:** Solve for $x$, then plug back to get the angle measure.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'vertical-angles', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-268', domain: 'geometry', skills: ['angles'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'D',
    explanation: "**SAT Pattern: Vertical Angles**\n\n**Choice D is correct.**\n\n**The Fast Way (~5s):** Adjacent angles at an intersection are supplementary (linear pair). $a + b = 180°$.\n\n**Why the wrong answers are tempting:**\n* A: just $a$.\n* B: $b$ alone (supplement of $a$).\n* C: $2a$.\n\n**Test Day Takeaway:** Adjacent angles at an intersection form a straight line ⇒ sum to $180°$.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'vertical-angles', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-269', domain: 'geometry', skills: ['angles'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Vertical Angles**\n\n**Choice B is correct.**\n\n**The Fast Way (~20s):** Adjacent angles are supplementary: $(2x - 5) + (5x + 10) = 180 \\Rightarrow 7x + 5 = 180 \\Rightarrow x = 25$. Smallest angle $= 2(25) - 5 = 45°$.\n\n**Test Day Takeaway:** Adjacent angles use SUM $= 180°$, not equality. Vertical angles use equality. Read \"adjacent\" vs \"vertical\" carefully.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'vertical-angles', authoredBy: 'performsat-engine', createdAt: '2026-05-18' },
  ...
  { id: 'bank-geo-275', domain: 'geometry', skills: ['arc-length'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Arc Length**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** Arc $= (60/360)(2\\pi \\cdot 10) = (1/6)(20\\pi) = 10\\pi/3$.\n\n**Why the wrong answers are tempting:**\n* B: full circumference.\n* C: forgets the radius.\n* D: forgets the angle fraction.\n\n**Test Day Takeaway:** Arc length $= (\\theta/360) \\cdot 2\\pi r$ (degrees) or $r\\theta$ (radians).',
  ...
  { id: 'bank-geo-276', domain: 'geometry', skills: ['arc-length'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Arc Length**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** Radians formula: $s = r\\theta = 6 \\cdot \\pi/3 = 2\\pi$.\n\n**Why the wrong answers are tempting:**\n* B: drops the radius.\n* C: full circumference.\n* D: random.\n\n**Test Day Takeaway:** $s = r\\theta$ when $\\theta$ is in radians.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'arc-length', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-277', domain: 'geometry', skills: ['arc-length'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Arc Length**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $90°$ is $1/4$ of $360°$. Arc $= (1/4)(2\\pi \\cdot 12) = 6\\pi$.\n\n**Why the wrong answers are tempting:**\n* B: half-circumference (uses $180°$).\n* C: $1/8$ slip.\n* D: full circumference.\n\n**Test Day Takeaway:** Arc length scales with the angle fraction of the full circle.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'arc-length', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-278', domain: 'geometry', skills: ['arc-length'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Arc Length**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** $8\\pi = (120/360)(2\\pi r) = (2\\pi r)/3 \\Rightarrow r = 12$.\n\n**Why the wrong answers are tempting:**\n* B: copies the arc length numeral.\n* C: doubles the answer.\n* D: divides incorrectly.\n\n**Test Day Takeaway:** Rearrange $s = (\\theta/360) \\cdot 2\\pi r$ to solve for $r$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'arc-length', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-279', domain: 'geometry', skills: ['arc-length'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Arc Length**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $s = r\\theta = 5 \\cdot 5\\pi/6 = 25\\pi/6$.\n\n**Why the wrong answers are tempting:**\n* B: forgets the radius.\n* C: full perimeter slip.\n* D: doubles radius wrongly.\n\n**Test Day Takeaway:** $r\\theta$ — multiply, not just one of them.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'arc-length', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-280', domain: 'geometry', skills: ['arc-length'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Arc Length**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** $3\\pi = (45/360)(2\\pi r) = (1/8)(2\\pi r) = \\pi r / 4 \\Rightarrow r = 12$.\n\n**Why the wrong answers are tempting:**\n* B: doubles.\n* C: half.\n* D: random.\n\n**Test Day Takeaway:** $45°$ is $1/8$ of a full revolution.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'arc-length', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-281', domain: 'geometry', skills: ['circle-equation', 'completing-square-circles'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Circle in General Form**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** Complete the square: $(x - 3)^2 + (y + 2)^2 - 9 - 4 - 12 = 0 \\Rightarrow (x - 3)^2 + (y + 2)^2 = 25$. Center $(3, -2)$.\n\n**Why the wrong answers are tempting:**\n* B: negates both coordinates.\n* C/D: drops the half ($-b/2$).\n\n**Test Day Takeaway:** From $x^2 + y^2 + Dx + Ey + F = 0$: center is $(-D/2, -E/2)$.',
  ...
  { id: 'bank-geo-282', domain: 'geometry', skills: ['circle-equation', 'completing-square-circles'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Circle in General Form**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** $(x - 2)^2 + y^2 = 14 \\Rightarrow r = \\sqrt{14}$.\n\n**Why the wrong answers are tempting:**\n* B: forgets the $+4$ from completing.\n* C: copies a coefficient.\n* D: returns $r^2$.\n\n**Test Day Takeaway:** Add the squared half-coefficients to the right side when completing the square.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'circle-in-general-form', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-283', domain: 'geometry', skills: ['circle-equation', 'completing-square-circles'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Circle in General Form**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** Center $= (-D/2, -E/2) = (-4, -3)$.\n\n**Why the wrong answers are tempting:**\n* B: negates wrong.\n* C/D: drops the halving.\n\n**Test Day Takeaway:** Memorize: $(-D/2, -E/2)$ from $x^2 + y^2 + Dx + Ey + F = 0$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'circle-in-general-form', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-284', domain: 'geometry', skills: ['circle-equation', 'completing-square-circles'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Circle in General Form**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** $(x - 1)^2 + (y + 2)^2 = 25 \\Rightarrow r = 5$.\n\n**Why the wrong answers are tempting:**\n* B: forgets the completed-square constants.\n* C: returns $r^2$.\n* D: subtracts where it should add.\n\n**Test Day Takeaway:** $r = \\sqrt{(D/2)^2 + (E/2)^2 - F}$ — completing the square moves the $-F$ over.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'circle-in-general-form', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-285', domain: 'geometry', skills: ['circle-equation', 'completing-square-circles'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Circle in General Form**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** No $y$ linear term ⇒ $y$-coord is $0$. $x$-coord: $-10/2 = -5$.\n\n**Why the wrong answers are tempting:**\n* B: wrong sign.\n* C: drops the halving.\n* D: swaps coordinates.\n\n**Test Day Takeaway:** Missing linear term ⇒ center on that axis.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'circle-in-general-form', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-286', domain: 'geometry', skills: ['circle-equation', 'completing-square-circles'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Circle in General Form**\n\n**Choice A is correct.**\n\n**The Fast Way (~25s):** Center $(-D/2, -E/2) = (3, -1)$ ⇒ $D = -6$, $E = 2$. Through origin: $F = 0$. Sum: $-4$.\n\n**Why the wrong answers are tempting:**\n* B: drops a sign.\n* C: omits $D$ contribution.\n* D: sums only $D + E$ correctly but mis-arithmetic.\n\n**Test Day Takeaway:** Use BOTH center coordinates AND a known point to determine all three of $D$, $E$, $F$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'circle-in-general-form', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-287', domain: 'geometry', skills: ['circle-equation'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Circle in Standard Form**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $(x - h)^2 + (y - k)^2 = r^2$ with $(h, k) = (2, -3)$, $r^2 = 25$.\n\n**Why the wrong answers are tempting:**\n* B: signs flipped on center.\n* C: uses $r$ instead of $r^2$.\n* D: uses minus between squared terms.\n\n**Test Day Takeaway:** Signs flip when going from center coordinates to the equation: $+2 \\to (x - 2)$, $-3 \\to (y + 3)$.',
  ...
  { id: 'bank-geo-288', domain: 'geometry', skills: ['circle-equation'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Circle in Standard Form**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $(x + 1) = (x - (-1))$ ⇒ $h = -1$. $(y - 4)$ ⇒ $k = 4$. Center $(-1, 4)$.\n\n**Why the wrong answers are tempting:**\n* B/C/D: sign errors.\n\n**Test Day Takeaway:** Read the OPPOSITE of the sign inside each squared term.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'circle-in-standard-form', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-289', domain: 'geometry', skills: ['circle-equation'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Circle in Standard Form**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $r^2 = 16 \\Rightarrow r = 4$.\n\n**Why the wrong answers are tempting:**\n* B: returns $r^2$.\n* C/D: random.\n\n**Test Day Takeaway:** Take the square root of the right-hand side.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'circle-in-standard-form', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-290', domain: 'geometry', skills: ['circle-equation'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Circle in Standard Form**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** Radius from origin: $\\sqrt{9 + 16} = 5$. Equation: $x^2 + y^2 = 25$.\n\n**Why the wrong answers are tempting:**\n* B: uses $r$ instead of $r^2$.\n* C: $3 + 4$ slip.\n* D: shifts center to the given point.\n\n**Test Day Takeaway:** Distance from center to a point on the circle IS the radius.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'circle-in-standard-form', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-291', domain: 'geometry', skills: ['circle-equation'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Circle in Standard Form**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $r = \\sqrt{20} = \\sqrt{4 \\cdot 5} = 2\\sqrt{5}$.\n\n**Why the wrong answers are tempting:**\n* B: halves $20$ then takes root.\n* C: returns $r^2$.\n* D: half of $r^2$.\n\n**Test Day Takeaway:** Simplify radicals by factoring perfect squares.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'circle-in-standard-form', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-292', domain: 'geometry', skills: ['circle-equation'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Circle in Standard Form**\n\n**Choice A is correct.**\n\n**The Fast Way (~25s):** Center = midpoint = $((1+7)/2, (2+10)/2) = (4, 6)$. Radius = half the diameter = $\\sqrt{(4-1)^2 + (6-2)^2} = \\sqrt{9+16} = 5$. So $r^2 = 25$.\n\n**Why the wrong answers are tempting:**\n* B: uses $r$ instead of $r^2$.\n* C: sign error.\n* D: uses the diameter as $r$.\n\n**Test Day Takeaway:** Midpoint of diameter $=$ center. Distance center-to-endpoint $=$ radius.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'circle-in-standard-form', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-293', domain: 'geometry', skills: ['volume-prism'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Cylinder Volume**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $V = \\pi r^2 h = \\pi(9)(10) = 90\\pi$.\n\n**Why the wrong answers are tempting:**\n* B: forgets to square the radius.\n* C: uses $2\\pi r h$ (lateral area).\n* D: drops $\\pi$ then re-introduces.\n\n**Test Day Takeaway:** $V = \\pi r^2 h$. Square the radius FIRST.',
  ...
  { id: 'bank-geo-294', domain: 'geometry', skills: ['volume-prism'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Cylinder Volume**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $\\pi(25)(4) = 100\\pi$.\n\n**Why the wrong answers are tempting:**\n* B: $2\\pi r h$.\n* C: $\\pi r h$ slip.\n* D: $\\pi(2r)^2 h$.\n\n**Test Day Takeaway:** Stick to $V = \\pi r^2 h$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'cylinder-volume', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-295', domain: 'geometry', skills: ['volume-prism'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Cylinder Volume**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $48\\pi = 3\\pi r^2 \\Rightarrow r^2 = 16 \\Rightarrow r = 4$.\n\n**Why the wrong answers are tempting:**\n* B: returns $r^2$.\n* C: $48/(2 \\cdot 3)$.\n* D: unsimplified.\n\n**Test Day Takeaway:** Cancel $\\pi$ from both sides, then solve for $r^2$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'cylinder-volume', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-296', domain: 'geometry', skills: ['volume-prism'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Cylinder Volume**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $72\\pi = \\pi(9)h \\Rightarrow h = 8$.\n\n**Why the wrong answers are tempting:**\n* B: returns $r^2$.\n* C: $72/3$.\n* D: copies the radius.\n\n**Test Day Takeaway:** Divide $V$ by $\\pi r^2$ to isolate $h$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'cylinder-volume', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-297', domain: 'geometry', skills: ['volume-prism'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Cylinder Volume**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** Radius $= 4$. $V = \\pi(16)(6) = 96\\pi$.\n\n**Why the wrong answers are tempting:**\n* B: uses $d$ in place of $r$ then mis-arithmetic.\n* C: uses diameter as radius.\n* D: forgets to square.\n\n**Test Day Takeaway:** Halve the diameter FIRST to get the radius.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'cylinder-volume', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-298', domain: 'geometry', skills: ['volume-prism'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Cylinder Volume**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** $V_1/V_2 = (\\pi(9)h)/(\\pi(25)h) = 9/25$.\n\n**Why the wrong answers are tempting:**\n* B: ratio of radii (forgets to square).\n* C: inverts.\n* D: applies square root in reverse.\n\n**Test Day Takeaway:** When height is constant, volume ratio = ratio of $r^2$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'cylinder-volume', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-299', domain: 'geometry', skills: ['circle-equation'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Distance from Center as Radius**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $r = \\sqrt{9 + 16} = 5$.\n\n**Why the wrong answers are tempting:**\n* B: $3 + 4$.\n* C: $\\sqrt{3 + 4}$.\n* D: returns $r^2$.\n\n**Test Day Takeaway:** Distance from center to ANY point on the circle is the radius.',
  ...
  { id: 'bank-geo-300', domain: 'geometry', skills: ['circle-equation'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Distance from Center as Radius**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $r = \\sqrt{(4-1)^2 + (6-2)^2} = \\sqrt{9 + 16} = 5$.\n\n**Why the wrong answers are tempting:**\n* B: drops the square inside.\n* C: $3 + 4$ slip.\n* D: returns $r^2$.\n\n**Test Day Takeaway:** Distance formula: $\\sqrt{(\\Delta x)^2 + (\\Delta y)^2}$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'distance-from-center-as-radius', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-301', domain: 'geometry', skills: ['circle-equation'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Distance from Center as Radius**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $r = \\sqrt{6^2 + 8^2} = \\sqrt{100} = 10$.\n\n**Why the wrong answers are tempting:**\n* B: drops the squares.\n* C: returns $r^2 / $ slip.\n* D: copies a coordinate.\n\n**Test Day Takeaway:** $(6, 8) \\to 10$ — recognize the $3$-$4$-$5$ family.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'distance-from-center-as-radius', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-302', domain: 'geometry', skills: ['circle-equation'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Distance from Center as Radius**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** Same $x$-coord, so distance $= |4 - (-1)| = 5$.\n\n**Why the wrong answers are tempting:**\n* B/C: copies a coordinate.\n* D: applies the distance formula without noticing the simplification.\n\n**Test Day Takeaway:** When one coordinate matches, the distance is just the difference in the other coordinate.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'distance-from-center-as-radius', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-303', domain: 'geometry', skills: ['circle-equation'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Distance from Center as Radius**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $5$-$12$-$13$ triple.\n\n**Why the wrong answers are tempting:**\n* B: $5 + 12$.\n* C: $\\sqrt{17}$.\n* D: returns $r^2$.\n\n**Test Day Takeaway:** Recognize standard right-triangle triples to skip the calculation.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'distance-from-center-as-radius', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-304', domain: 'geometry', skills: ['circle-equation'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Distance from Center as Radius**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** $r = \\sqrt{3^2 + 4^2} = 5$, so $r^2 = 25$. Center $(4, 5)$.\n\n**Why the wrong answers are tempting:**\n* B: uses $r$ instead of $r^2$.\n* C: sign error on center.\n* D: uses the OTHER point as center.\n\n**Test Day Takeaway:** Center first, then plug into $(x - h)^2 + (y - k)^2 = r^2$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'distance-from-center-as-radius', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-305', domain: 'geometry', skills: ['pythagorean-theorem'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Pythagorean Triple Recognition**\n\n**Choice A is correct.**\n\n**The Fast Way (~3s):** $3$-$4$-$5$ triple.\n\n**Why the wrong answers are tempting:**\n* B: $3 + 4$.\n* C: $3^2 + 4^2$ (forgets to take square root).\n* D: $\\sqrt{3 + 4}$.\n\n**Test Day Takeaway:** Memorize $3$-$4$-$5$, $5$-$12$-$13$, $8$-$15$-$17$, $7$-$24$-$25$.',
  ...
  { id: 'bank-geo-306', domain: 'geometry', skills: ['pythagorean-theorem'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Pythagorean Triple Recognition**\n\n**Choice A is correct.**\n\n**The Fast Way (~3s):** $5$-$12$-$13$ triple.\n\n**Why the wrong answers are tempting:**\n* B: $5 + 12$.\n* C: $12^2$.\n* D: $\\sqrt{5 \\cdot 12}$.\n\n**Test Day Takeaway:** $5$-$12$-$13$ is one of the most common triples on the SAT.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'pythagorean-triple-recognition', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-307', domain: 'geometry', skills: ['pythagorean-theorem'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Pythagorean Triple Recognition**\n\n**Choice A is correct.**\n\n**The Fast Way (~3s):** $8$-$15$-$17$ triple.\n\n**Why the wrong answers are tempting:**\n* B/C: wrong triple.\n* D: doesn\'t simplify or matches no standard triple.\n\n**Test Day Takeaway:** Reverse-direction triples: given hyp and one leg, recognize the missing leg.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'pythagorean-triple-recognition', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-308', domain: 'geometry', skills: ['pythagorean-theorem'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Pythagorean Triple Recognition**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $9$-$12$-$15$ is $3$ times the $3$-$4$-$5$ triple.\n\n**Why the wrong answers are tempting:**\n* B: $9 + 12$.\n* C: copies $13$ (different triple).\n* D: unsimplified.\n\n**Test Day Takeaway:** Any multiple of a Pythagorean triple is itself a Pythagorean triple.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'pythagorean-triple-recognition', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-309', domain: 'geometry', skills: ['pythagorean-theorem'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Pythagorean Triple Recognition**\n\n**Choice A is correct.**\n\n**The Fast Way (~3s):** $7$-$24$-$25$ triple.\n\n**Why the wrong answers are tempting:**\n* B: $25 - 7$.\n* C: $25 - 2$.\n* D: unsimplified $\\sqrt{576} = 24$ (equivalent but messier).\n\n**Test Day Takeaway:** $7$-$24$-$25$ is a standard SAT triple — memorize it.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'pythagorean-triple-recognition', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-310', domain: 'geometry', skills: ['pythagorean-theorem'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Pythagorean Triple Recognition**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** Divide by $2$: $8$-$15$-$17$. Multiply back by $2$: $16$-$30$-$34$.\n\n**Why the wrong answers are tempting:**\n* B: $16 + 30$.\n* C: doubles only one leg.\n* D: unsimplified, equals $30$.\n\n**Test Day Takeaway:** Spot the common factor first to identify the underlying triple.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'pythagorean-triple-recognition', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-311', domain: 'geometry', skills: ['triangle-area'], difficulty: 'easy', type: 'multiple-choice',
    ...
    choices: [{ id: 'A', text: '$40$' }, { id: 'B', text: '$26$' }, { id: 'C', text: '$13$' }, { id: 'D', text: '$80$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Rectangle Area**\n\n**Choice A is correct.**\n\n**The Fast Way (~3s):** $A = l \\cdot w = 8 \\cdot 5 = 40$.\n\n**Why the wrong answers are tempting:**\n* B: perimeter ($2(l + w)$).\n* C: $l + w$.\n* D: doubles area.\n\n**Test Day Takeaway:** $A = l \\cdot w$ for rectangles.',
  ...
  { id: 'bank-geo-312', domain: 'geometry', skills: ['triangle-area'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Rectangle Area**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** $2l + 2w = 30 \\Rightarrow l + w = 15 \\Rightarrow w = 3$. Area $= 12 \\cdot 3 = 36$.\n\n**Why the wrong answers are tempting:**\n* B: uses $2$ as width.\n* C: copies perimeter.\n* D: $12 \\cdot 5$.\n\n**Test Day Takeaway:** Find the missing dimension from perimeter, then compute area.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'rectangle-area', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-313', domain: 'geometry', skills: ['triangle-area'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Rectangle Area**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $w = 84/12 = 7$.\n\n**Why the wrong answers are tempting:**\n* B: $84 - 78$ slip.\n* C: $84 - 12$.\n* D: halves wrongly.\n\n**Test Day Takeaway:** $w = A/l$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'rectangle-area', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-314', domain: 'geometry', skills: ['triangle-area'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Rectangle Area**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** $l = 2w$. $2w \\cdot w = 72 \\Rightarrow w^2 = 36 \\Rightarrow w = 6$. $l = 12$.\n\n**Why the wrong answers are tempting:**\n* B: returns the width.\n* C: doubles the length wrongly.\n* D: $72/2$.\n\n**Test Day Takeaway:** Set up the relationship $l = kw$ and substitute into area.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'rectangle-area', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-315', domain: 'geometry', skills: ['triangle-area'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Rectangle Area**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** For a square with diagonal $d$, side $= d/\\sqrt{2}$ and area $= d^2/2 = 100/2 = 50$.\n\n**Why the wrong answers are tempting:**\n* B: $d^2$.\n* C: $d^2/4$.\n* D: $\\sqrt{2} d$.\n\n**Test Day Takeaway:** Square area from diagonal: $d^2/2$. (Faster than computing the side.)',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'rectangle-area', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-316', domain: 'geometry', skills: ['triangle-area'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Rectangle Area**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** $l = w + 4$. $w(w + 4) = 60 \\Rightarrow w^2 + 4w - 60 = 0 \\Rightarrow (w - 6)(w + 10) = 0 \\Rightarrow w = 6$. $l = 10$.\n\n**Why the wrong answers are tempting:**\n* B: returns the width.\n* C: $60/8$ slip.\n* D: random factor.\n\n**Test Day Takeaway:** Translate relationship into algebra, then solve the resulting quadratic.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'rectangle-area', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-317', domain: 'geometry', skills: ['pythagorean-theorem'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Right Triangle Pythagorean**\n\n**Choice A is correct.**\n\n**The Fast Way (~3s):** $6$-$8$-$10$ ($2 \\times$ $3$-$4$-$5$).\n\n**Why the wrong answers are tempting:**\n* B: $6 + 8$.\n* C: $\\sqrt{14}$.\n* D: returns the squared hypotenuse.\n\n**Test Day Takeaway:** $a^2 + b^2 = c^2$.',
  ...
  { id: 'bank-geo-318', domain: 'geometry', skills: ['pythagorean-theorem'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Right Triangle Pythagorean**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $9$-$12$-$15$ ($3 \\times$ $3$-$4$-$5$).\n\n**Why the wrong answers are tempting:**\n* B: $15 - 9$.\n* C: $15 + 9$.\n* D: $\\sqrt{15^2 + 9^2}$.\n\n**Test Day Takeaway:** $b = \\sqrt{c^2 - a^2}$ when given hypotenuse and one leg.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'right-triangle-pythagorean', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-319', domain: 'geometry', skills: ['pythagorean-theorem'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Right Triangle Pythagorean**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $c^2 = 12 + 4 = 16 \\Rightarrow c = 4$.\n\n**Why the wrong answers are tempting:**\n* B: applies $\\sqrt{5}$ slip.\n* C: adds legs.\n* D: doesn\'t take square root.\n\n**Test Day Takeaway:** Square the legs before adding (and remember to square radicals).',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'right-triangle-pythagorean', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-320', domain: 'geometry', skills: ['pythagorean-theorem'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Right Triangle Pythagorean**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $c^2 = 1 + 3 = 4 \\Rightarrow c = 2$. (This is a $30$-$60$-$90$ triangle.)\n\n**Why the wrong answers are tempting:**\n* B: unsimplified.\n* C: copies a leg.\n* D: sums legs.\n\n**Test Day Takeaway:** $1, \\sqrt{3}, 2$ is the $30$-$60$-$90$ triangle.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'right-triangle-pythagorean', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-321', domain: 'geometry', skills: ['pythagorean-theorem'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Right Triangle Pythagorean**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $b^2 = 144 - 49 = 95 \\Rightarrow b = \\sqrt{95}$.\n\n**Why the wrong answers are tempting:**\n* B: $12 - 7$.\n* C: $12 + 7$.\n* D: adds instead of subtracts.\n\n**Test Day Takeaway:** Not every right triangle has a clean integer answer — leave in radical form.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'right-triangle-pythagorean', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-322', domain: 'geometry', skills: ['pythagorean-theorem'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Right Triangle Pythagorean**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** Square diagonal $d = s\\sqrt{2}$, so $s = d/\\sqrt{2} = 10/\\sqrt{2} = 5\\sqrt{2}$.\n\n**Why the wrong answers are tempting:**\n* B: halves the diagonal.\n* C: multiplies instead of divides.\n* D: $5$.\n\n**Test Day Takeaway:** $45$-$45$-$90$ triangle: sides are $s$-$s$-$s\\sqrt{2}$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'right-triangle-pythagorean', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-323', domain: 'geometry', skills: ['triangle-area'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Triangle Area**\n\n**Choice A is correct.**\n\n**The Fast Way (~3s):** $A = (1/2)(8)(5) = 20$.\n\n**Why the wrong answers are tempting:**\n* B: forgets the $1/2$.\n* C: adds.\n* D: doubles base.\n\n**Test Day Takeaway:** Triangle area $= (1/2) \\cdot$ base $\\cdot$ height.',
  ...
  { id: 'bank-geo-324', domain: 'geometry', skills: ['triangle-area'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Triangle Area**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $h = 2A/b = 60/12 = 5$.\n\n**Why the wrong answers are tempting:**\n* B: forgets to double.\n* C: $30 - 12$.\n* D: unsimplified non-doubled.\n\n**Test Day Takeaway:** Rearrange: $h = 2A/b$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'triangle-area', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-325', domain: 'geometry', skills: ['triangle-area'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Triangle Area**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $b = 2A/h = 96/8 = 12$.\n\n**Why the wrong answers are tempting:**\n* B: forgets to double.\n* C: doubles wrongly.\n* D: $48 + 8$.\n\n**Test Day Takeaway:** Both unknown of base AND height require the doubled area.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'triangle-area', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-326', domain: 'geometry', skills: ['triangle-area'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Triangle Area**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** Legs serve as base and height: $A = (1/2)(6)(8) = 24$.\n\n**Why the wrong answers are tempting:**\n* B: forgets the $1/2$.\n* C: adds legs.\n* D: returns hypotenuse.\n\n**Test Day Takeaway:** In a RIGHT triangle, the two legs are perpendicular — they ARE the base and height.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'triangle-area', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-327', domain: 'geometry', skills: ['triangle-area'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Triangle Area**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** Equilateral side $s$: $A = (s^2 \\sqrt{3})/4 = 36\\sqrt{3}/4 = 9\\sqrt{3}$.\n\n**Why the wrong answers are tempting:**\n* B: $(1/2)(6)(6)$ slip.\n* C: $s \\sqrt{3}$.\n* D: $s^2$.\n\n**Test Day Takeaway:** Equilateral area: $(s^2 \\sqrt{3})/4$. Derivable from height $= s\\sqrt{3}/2$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'triangle-area', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-328', domain: 'geometry', skills: ['triangle-area'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Triangle Area**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** Base: segment from $(0,0)$ to $(4,0)$, length $4$. Height: perpendicular distance from $(1, 3)$ to that base $= 3$. Area $= (1/2)(4)(3) = 6$.\n\n**Why the wrong answers are tempting:**\n* B: forgets the $1/2$.\n* C: drops the base scaling.\n* D: random.\n\n**Test Day Takeaway:** When two vertices are on the $x$-axis, base $=$ horizontal distance, height $=$ third vertex\'s $|y|$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'triangle-area', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-329', domain: 'geometry', skills: ['soh-cah-toa'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Trig Ratio from Perimeter**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** Triple $5$-$12$-$13$. $\\sin \\theta = $ opposite / hypotenuse $= 5/13$.\n\n**Why the wrong answers are tempting:**\n* B: $\\cos \\theta$.\n* C: $\\tan \\theta$.\n* D: inverts.\n\n**Test Day Takeaway:** When perimeter $30 = 5 + 12 + 13$, look for the standard triple.',
  ...
  { id: 'bank-geo-330', domain: 'geometry', skills: ['soh-cah-toa'], difficulty: 'medium', type: 'multiple-choice',
    ...
    choices: [{ id: 'A', text: '$\\dfrac{3}{4}$' }, { id: 'B', text: '$\\dfrac{4}{3}$' }, { id: 'C', text: '$\\dfrac{3}{5}$' }, { id: 'D', text: '$\\dfrac{4}{5}$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Trig Ratio from Perimeter**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $\\tan \\theta = $ opp / adj $= 6/8 = 3/4$.\n\n**Why the wrong answers are tempting:**\n* B: $\\cot$.\n* C: $\\sin$.\n* D: $\\cos$.\n\n**Test Day Takeaway:** $\\tan = \\sin/\\cos = $ opp/adj.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'trig-ratio-from-perimeter', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-331', domain: 'geometry', skills: ['soh-cah-toa'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Trig Ratio from Perimeter**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** Triple $8$-$15$-$17$. $\\sin \\theta = 8/17$.\n\n**Why the wrong answers are tempting:**\n* B: $\\cos$.\n* C: $\\tan$.\n* D: inverts $\\tan$.\n\n**Test Day Takeaway:** Perimeter $40 = 8 + 15 + 17$ identifies the triple.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'trig-ratio-from-perimeter', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-332', domain: 'geometry', skills: ['soh-cah-toa'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Trig Ratio from Perimeter**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** Triple $9$-$12$-$15$ ($3 \\times$ $3$-$4$-$5$). $\\cos \\theta = $ adj/hyp $= 12/15 = 4/5$.\n\n**Why the wrong answers are tempting:**\n* B: $\\sin$.\n* C: $\\tan$.\n* D: inverts.\n\n**Test Day Takeaway:** Multiples of standard triples still satisfy the same trig ratios.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'trig-ratio-from-perimeter', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-333', domain: 'geometry', skills: ['soh-cah-toa'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Trig Ratio from Perimeter**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** Triple $18$-$24$-$30$ ($6 \\times$ $3$-$4$-$5$). $\\sin \\theta = 18/30 = 3/5$.\n\n**Why the wrong answers are tempting:**\n* B: $\\cos$.\n* C: $\\tan$.\n* D: ratio of legs, not opp/hyp.\n\n**Test Day Takeaway:** Even scaled triples give the same trig ratios in simplified form.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'trig-ratio-from-perimeter', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-334', domain: 'geometry', skills: ['soh-cah-toa'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Trig Ratio from Perimeter**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** Triple $21$-$28$-$35$. $\\tan \\theta = 21/28 = 3/4$.\n\n**Why the wrong answers are tempting:**\n* B: cotangent.\n* C: $\\sin$.\n* D: $\\sin$ unsimplified.\n\n**Test Day Takeaway:** Always simplify; trig ratios scale invariantly with triple multipliers.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'trig-ratio-from-perimeter', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-335', domain: 'geometry', skills: ['soh-cah-toa'], difficulty: 'easy', type: 'multiple-choice',
    ...
    choices: [{ id: 'A', text: '$\\dfrac{5}{13}$' }, { id: 'B', text: '$\\dfrac{12}{13}$' }, { id: 'C', text: '$\\dfrac{5}{12}$' }, { id: 'D', text: '$\\dfrac{13}{5}$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Trig Ratio with Known Triple**\n\n**Choice A is correct.**\n\n**The Fast Way (~3s):** $\\sin = $ opp/hyp $= 5/13$.\n\n**Why the wrong answers are tempting:**\n* B: $\\cos$.\n* C: $\\tan$.\n* D: inverts $\\sin$.\n\n**Test Day Takeaway:** SOH: Sine is Opposite over Hypotenuse.',
  ...
  { id: 'bank-geo-336', domain: 'geometry', skills: ['soh-cah-toa'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Trig Ratio with Known Triple**\n\n**Choice A is correct.**\n\n**The Fast Way (~3s):** $\\cos = $ adj/hyp $= 15/17$.\n\n**Why the wrong answers are tempting:**\n* B: $\\sin$.\n* C: $\\tan$.\n* D: inverts.\n\n**Test Day Takeaway:** CAH: Cosine is Adjacent over Hypotenuse. "Adjacent" is the leg NOT opposite the named angle.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'trig-ratio-with-known-triple', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-337', domain: 'geometry', skills: ['soh-cah-toa'], difficulty: 'easy', type: 'multiple-choice',
    ...
    choices: [{ id: 'A', text: '$\\dfrac{3}{4}$' }, { id: 'B', text: '$\\dfrac{4}{3}$' }, { id: 'C', text: '$\\dfrac{3}{5}$' }, { id: 'D', text: '$\\dfrac{4}{5}$' }],
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Trig Ratio with Known Triple**\n\n**Choice A is correct.**\n\n**The Fast Way (~3s):** $\\tan = $ opp/adj $= 3/4$.\n\n**Why the wrong answers are tempting:**\n* B: cotangent.\n* C: $\\sin$.\n* D: $\\cos$.\n\n**Test Day Takeaway:** TOA: Tangent is Opposite over Adjacent.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'trig-ratio-with-known-triple', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-338', domain: 'geometry', skills: ['soh-cah-toa'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Trig Ratio with Known Triple**\n\n**Choice A is correct.**\n\n**The Fast Way (~3s):** $\\sin = 24/25$.\n\n**Why the wrong answers are tempting:**\n* B: $\\sin$ for the OTHER acute angle.\n* C/D: tangents (one direction or the other).\n\n**Test Day Takeaway:** Identify hypotenuse first (longest side), then opp/adj for the named angle.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'trig-ratio-with-known-triple', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-geo-339', domain: 'geometry', skills: ['soh-cah-toa'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Trig Ratio with Known Triple**\n\n**Choice A is correct.**\n\n**The Fast Way (~3s):** $\\tan = $ opp/adj $= 40/9$.\n\n**Why the wrong answers are tempting:**\n* B: $\\tan$ of the OTHER acute angle.\n* C: $\\sin$.\n* D: $\\sin$ of the other angle.\n\n**Test Day Takeaway:** The angle opposite the LARGER leg has the larger tangent.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'trig-ratio-with-known-triple', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
