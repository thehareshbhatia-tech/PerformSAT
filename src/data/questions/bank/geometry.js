export const geometryBank = [
  ...
  { id: 'bank-geo-169', domain: 'geometry', skills: ['triangle-angle-sum'], difficulty: 'medium', type: 'multiple-choice',
    ...
    choices: [{ id: 'A', text: '$30$' }, { id: 'B', text: '$20$' }, { id: 'C', text: '$50$' }, { id: 'D', text: '$130$' }],
    correctAnswer: 'A',
    explanation: "**SAT Pattern: Angles with Parallel Lines and Transversals**\n\n**Choice A is correct.**\n\n**The Fast Way (~45s):** Two equations from the two relationships. Corresponding angles are equal: $3x + 2y = 5x - y \\Rightarrow 2x = 3y$. Supplementary: $(5x - y) + (2x + 3y - 70) = 180 \\Rightarrow 7x + 2y = 250$. Substitute $x = 1.5y$: $7(1.5y) + 2y = 250 \\Rightarrow 12.5y = 250 \\Rightarrow y = 20$, so $x = 30$.\n\n**The Full Solution:**\nStep 1: Corresponding angles formed by parallel lines and a transversal are congruent: $3x + 2y = 5x - y$, which gives $2x = 3y$, or $x = 1.5y$.\nStep 2: Adjacent angles on a straight line are supplementary: $(5x - y) + (2x + 3y - 70) = 180$, which gives $7x + 2y = 250$.\nStep 3: Substitute $x = 1.5y$ into the second equation: $7(1.5y) + 2y = 250 \\Rightarrow 12.5y = 250 \\Rightarrow y = 20$.\nStep 4: $x = 1.5(20) = 30$.\n\nVerification: corresponding angles measure $3(30) + 2(20) = 130$ and $5(30) - 20 = 130$ \\checkmark; supplementary partner $= 2(30) + 3(20) - 70 = 50$ and $130 + 50 = 180$ \\checkmark.\n\n**Why the wrong answers are tempting:**\n* Choice B ($20$): reports $y$ instead of $x$ — solved the system correctly but identified the wrong variable.\n* Choice C ($50$): reports the measure of the supplementary angle ($2x + 3y - 70 = 50$) rather than $x$ — confuses an angle value with the variable.\n* Choice D ($130$): reports the measure of the corresponding angle ($5x - y = 130$) rather than $x$ — confuses an angle value with the variable.\n\n**Test Day Takeaway:** Multi-condition transversal problems require setting up TWO independent equations (one for each angle relationship), then solving the system. Always re-read the question to confirm which variable is asked for.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'angles-with-parallel-lines-and-transversals', authoredBy: 'performsat-engine', createdAt: '2026-05-12' },
