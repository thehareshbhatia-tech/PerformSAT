...
// (diagnosticEngine, studyPlanGenerator) can import them without pulling the
// bank shards. Re-exported here so existing importers are unaffected.
export { SKILL_ALIAS_MAP, DRILL_ROUTING_THRESHOLDS };
...
const TIER1_PATTERN_THRESHOLD = DRILL_ROUTING_THRESHOLDS.TIER1_PATTERN;
 ...
 *  the legacy behavior). */
const TIER2_STYLE_THRESHOLD = DRILL_ROUTING_THRESHOLDS.TIER2_STYLE;
