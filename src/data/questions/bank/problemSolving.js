export const problemSolvingBank = [
  ...
  },
  {
    ...
    difficulty: 'hard',
    type: 'fill-in',
    question: 'A company\'s revenue went from $450,000 in Q1 to $576,000 in Q2. To the nearest tenth of a percent, what is the percent increase from Q1 to Q2?',
    correctAnswer: '28',
  ...
  },
  {
    ...
    correctAnswer: 'D',
    explanation: 'The new data set has 9 values. The new median is the 5th value, which was originally the 5th value—this could be less than, equal to, or even equal to 45 depending on the data. Without the actual values, it cannot be determined.',
    calculatorAllowed: true,
    tags: [],
  ...
  },
  {
    ...
    difficulty: 'medium',
    type: 'multiple-choice',
    question: 'The table below shows the number of books read by students in a class.\n\n| Books read | 0 | 1 | 2 | 3 | 4 | 5 |\n|---|---|---|---|---|---|---|\n| Students   | 2 | 5 | 7 | 6 | 3 | 1 |\n\nWhat is the median number of books read?',
    choices: [
      { id: 'A', text: '1' },
      { id: 'B', text: '2' },
      { id: 'C', text: '2.5' },
