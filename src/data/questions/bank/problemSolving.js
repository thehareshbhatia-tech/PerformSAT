export const problemSolvingBank = [
  ...
  { id: 'bank-ps-274', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Confidence Interval Interpretation**\n\n**Choice C is correct.**\n\n**The Fast Way (~10s):** A $95\\%$ confidence interval around $58\\% \\pm 4\\%$ is $[54\\%, 62\\%]$. Interpretation: we are $95\\%$ confident the TRUE population proportion lies in this interval.\n\n**Why the wrong answers are tempting:**\n* A: treats the sample proportion as the population proportion (drops uncertainty).\n* B: confuses CI with probability of individual outcome.\n* D: reports counts instead of proportions.\n\n**Test Day Takeaway:** A CI is a statement about the POPULATION proportion, with confidence as the long-run reliability of the method. Always state the interval and the confidence level.",
  ...
  { id: 'bank-ps-275', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Confidence Interval Interpretation**\n\n**Choice B is correct.**\n\n**The Fast Way (~5s):** CI = estimate $\\pm$ MOE = $42\\% \\pm 3\\% = [39\\%, 45\\%]$.\n\n**Why the wrong answers are tempting:**\n* A: only subtracts MOE.\n* C: only adds MOE.\n* D: uses $\\pm 2\\%$ instead of the given $\\pm 3\\%$.\n\n**Test Day Takeaway:** Confidence interval $=$ point estimate $\\pm$ MOE. Two-sided, symmetric around the point estimate.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'confidence-interval-interpretation', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-276', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Confidence Interval Interpretation**\n\n**Choice B is correct.**\n\n**The Fast Way (~10s):** CI is $[49\\%, 55\\%]$. The lower bound is below $50\\%$, so the data is CONSISTENT with the true proportion being a non-majority. Cannot confidently claim majority support.\n\n**Why the wrong answers are tempting:**\n* A: treats the sample value $52\\%$ as definitive — ignores MOE.\n* C: contradicts the data.\n* D: misinterprets the $95\\%$ confidence as a per-survey error rate.\n\n**Test Day Takeaway:** When a CI STRADDLES a meaningful threshold (like $50\\%$), the data doesn't pin down which side of the threshold the truth is on.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'confidence-interval-interpretation', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-277', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Confidence Interval Interpretation**\n\n**Choice B is correct.**\n\n**The Key Distinction:** CIs are about the POPULATION PARAMETER (here, the population average), NOT about individual responses or future outcomes.\n\n**Why the wrong answers are tempting:**\n* A: applies CI to every individual — wrong scope.\n* C: confuses CI with individual prediction.\n* D: makes a trend claim with no time-series data.\n\n**Test Day Takeaway:** CIs estimate where a population PARAMETER (mean, proportion) lies. They don't make per-person predictions.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'confidence-interval-interpretation', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-278', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'medium', type: 'fill-in',
    ...
    correctAnswer: '2',
    explanation: "**SAT Pattern: Confidence Interval Interpretation**\n\n**The correct answer is $2$.**\n\n**The Fast Way (~5s):** MOE = (upper − lower) / 2 = $(34 - 30)/2 = 2$ minutes. Equivalently: half-width of the interval.\n\n**Common Mistakes:**\n* Reporting $4$: reports the full interval width (upper − lower).\n* Reporting $30$ or $34$: reports a bound.\n\n**Test Day Takeaway:** MOE is the HALF-WIDTH of a symmetric CI. CI = point ± MOE means CI width = $2 \\cdot$ MOE.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'confidence-interval-interpretation', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-279', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Confidence Interval Interpretation**\n\n**Choice B is correct.**\n\n**The Fast Way (~10s):** First CI: $[44\\%, 50\\%]$. Second CI: $[48\\%, 54\\%]$. Overlap on $[48\\%, 50\\%]$. Both consistent with a true value in that range.\n\n**Why the wrong answers are tempting:**\n* A: treats sample point estimates as definitive — ignores overlap.\n* C: no methodological evidence of error.\n* D: $51\\% - 3\\% = 48\\% < 50\\%$, so majority is not established.\n\n**Test Day Takeaway:** Two polls 'agree' when their CIs overlap. Differences in sample percentages within MOE are not statistically significant.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'confidence-interval-interpretation', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-280', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Confidence Interval Interpretation**\n\n**Choice B is correct.**\n\n**The Key Distinction:** CIs describe where a population PARAMETER (average) lies with confidence. They don't apply per-patient or describe success rates.\n\n**Why the wrong answers are tempting:**\n* A: treats sample mean as population truth for every patient.\n* C: misinterprets confidence as a hypothesis-test p-value.\n* D: misreads $95\\%$ confidence as a success rate.\n\n**Test Day Takeaway:** Be precise: 'average reduction in the studied population' is correct; 'reduction for every patient' or 'success rate of $95\\%$' is not.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'confidence-interval-interpretation', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-281', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'hard', type: 'fill-in',
    ...
    correctAnswer: '46',
    explanation: "**SAT Pattern: Confidence Interval Interpretation**\n\n**The correct answer is $46$.**\n\n**The Fast Way (~5s):** Point estimate = midpoint = $(42 + 50)/2 = 46\\%$.\n\n**The Full Solution:**\nThe CI is symmetric around the point estimate: $\\text{point} = (\\text{lower} + \\text{upper})/2 = (42 + 50)/2 = 46\\%$.\n\nVerification: MOE = $(50 - 42)/2 = 4$; point $\\pm$ MOE = $46 \\pm 4 = [42, 50]$ \\checkmark.\n\n**Test Day Takeaway:** Symmetric CI: point estimate = midpoint of interval. MOE = half-width.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'confidence-interval-interpretation', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-282', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Sample Size for Margin Reduction**\n\n**Choice C is correct.**\n\n**The Fast Way (~10s):** MOE $\\propto 1/\\sqrt{n}$. Halving MOE requires $\\sqrt{n}$ to DOUBLE, i.e., $n$ to QUADRUPLE: $4 \\cdot 400 = 1{,}600$.\n\n**The Full Solution:**\nMargin of error scales as $1/\\sqrt{n}$. To reduce MOE by factor $k$, scale $n$ by $k^2$. Here $k = 2$ (halving), so $n$ scales by $4$. New $n = 4 \\cdot 400 = 1600$.\n\n**Why the wrong answers are tempting:**\n* A: halves $n$ — would INCREASE MOE.\n* B: doubles $n$ — only reduces MOE by $\\sqrt{2} \\approx 0.71$, not by half.\n* D: arbitrary larger value.\n\n**Test Day Takeaway:** To CUT MOE by a factor of $k$, MULTIPLY sample size by $k^2$. Quadratic scaling, because MOE depends on $1/\\sqrt{n}$.",
  ...
  { id: 'bank-ps-283', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Sample Size for Margin Reduction**\n\n**Choice B is correct.**\n\n**The Fast Way (~5s):** MOE $\\propto 1/\\sqrt{n}$. Quadrupling $n$ multiplies $1/\\sqrt{n}$ by $1/\\sqrt{4} = 1/2$. So MOE is halved: $4\\% \\cdot 1/2 = 2\\%$.\n\n**Why the wrong answers are tempting:**\n* A: divides MOE by $4$ — uses linear instead of sqrt scaling.\n* C: assumes MOE doesn't change.\n* D: multiplies by $4$ — wrong direction.\n\n**Test Day Takeaway:** MOE scales as $1/\\sqrt{n}$, so $n \\to 4n$ implies MOE $\\to$ MOE $/2$. Don't use linear scaling.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'sample-size-for-margin-reduction', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-284', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Sample Size for Margin Reduction**\n\n**Choice C is correct.**\n\n**The Fast Way (~15s):** MOE reduction factor: $3.3/1.1 = 3$. Sample-size scale factor: $3^2 = 9$. New $n = 9 \\cdot 900 = 8{,}100$.\n\n**The Full Solution:**\nMOE $\\propto 1/\\sqrt{n}$. Required reduction: $1.1/3.3 = 1/3$. So $1/\\sqrt{n_{\\text{new}}} = (1/3) \\cdot 1/\\sqrt{900} \\Rightarrow \\sqrt{n_{\\text{new}}} = 3 \\sqrt{900} = 90 \\Rightarrow n_{\\text{new}} = 8100$.\n\n**Why the wrong answers are tempting:**\n* A: triples $n$ — only reduces MOE by factor $\\sqrt{3} \\approx 1.73$, not $3$.\n* B: quadruples $n$ — too small.\n* D: arbitrary.\n\n**Test Day Takeaway:** To cut MOE by factor $k$, multiply $n$ by $k^2$. Factor $3 \\Rightarrow n \\cdot 9$.",
  ...
  { id: 'bank-ps-285', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'medium', type: 'fill-in',
    ...
    correctAnswer: '9',
    explanation: "**SAT Pattern: Sample Size for Margin Reduction**\n\n**The correct answer is $9$.**\n\n**The Fast Way (~5s):** Reduction factor: $6/2 = 3$. Sample-size factor: $3^2 = 9$.\n\n**Common Mistakes:**\n* Reporting $3$: linear scaling instead of sqrt.\n* Reporting $4$: confuses with squaring the new MOE.\n* Reporting $6$ or $2$: reports an MOE value.\n\n**Test Day Takeaway:** MOE divides by $k$ $\\Rightarrow$ $n$ multiplies by $k^2$.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'sample-size-for-margin-reduction', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-286', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Sample Size for Margin Reduction**\n\n**Choice C is correct.**\n\n**The Fast Way (~10s):** $n$ multiplies by $9$, so $\\sqrt{n}$ multiplies by $3$, so MOE divides by $3$: $7/3 \\approx 2.33\\%$.\n\n**The Full Solution:**\n$1800/200 = 9$. New MOE = $7\\% / \\sqrt{9} = 7\\% / 3 \\approx 2.33\\%$.\n\n**Why the wrong answers are tempting:**\n* A: divides MOE by $9$ (linear scaling).\n* B: half of A.\n* D: halves MOE (assumes $n$ scaling by $4$).\n\n**Test Day Takeaway:** Scaling $n$ by $9$ scales MOE by $1/3$, not by $1/9$.",
    calculatorAllowed: true, tags: [], sourceStyleRef: 'sample-size-for-margin-reduction', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-287', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'medium', type: 'fill-in',
    ...
    correctAnswer: '5',
    explanation: "**SAT Pattern: Sample Size for Margin Reduction**\n\n**The correct answer is $5$.**\n\n**The Fast Way (~5s):** $400/100 = 4 \\Rightarrow$ MOE divides by $\\sqrt{4} = 2$. New MOE = $10\\% / 2 = 5\\%$.\n\n**Common Mistakes:**\n* Reporting $2.5$: divides MOE by $4$ (linear).\n* Reporting $10$: forgets the scaling.\n* Reporting $40$: incorrect multiplier.\n\n**Test Day Takeaway:** $n$ quadrupled $\\Rightarrow$ MOE halved.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'sample-size-for-margin-reduction', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-288', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'D',
    explanation: "**SAT Pattern: Sample Size for Margin Reduction**\n\n**Choice D is correct.**\n\n**The Fast Way (~5s):** MOE reduction factor $3 \\Rightarrow n$ factor $3^2 = 9$.\n\n**Why the wrong answers are tempting:**\n* A ($\\sqrt{3}$): inverse of the relation.\n* B ($3$): linear scaling.\n* C ($6$): unrelated.\n\n**Test Day Takeaway:** Reducing MOE by factor $k$ always requires multiplying $n$ by $k^2$.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'sample-size-for-margin-reduction', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-289', domain: 'problem-solving', skills: ['margin-of-error'], difficulty: 'hard', type: 'fill-in',
    ...
    correctAnswer: '9375',
    explanation: "**SAT Pattern: Sample Size for Margin Reduction**\n\n**The correct answer is $9375$.**\n\n**The Fast Way (~15s):** Required reduction factor $= 4/1 = 4$. New $n$ factor: $4^2 = 16$. New $n = 16 \\cdot 625 = 10{,}000$. Additional = $10{,}000 - 625 = 9{,}375$.\n\n**The Full Solution:**\nMOE $\\propto 1/\\sqrt{n}$. Reduce MOE by factor $4$: scale $n$ by $16$. New $n = 16 \\cdot 625 = 10000$. Question asks ADDITIONAL: $10000 - 625 = 9375$.\n\n**Common Mistakes:**\n* Reporting $10000$: gives the TOTAL new size, not the addition.\n* Reporting $2500$: scales $n$ by $4$ instead of $16$.\n\n**Test Day Takeaway:** 'Additional' means the difference, not the new total. Read the question carefully.",
    calculatorAllowed: true, tags: [], sourceStyleRef: 'sample-size-for-margin-reduction', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-290', domain: 'problem-solving', skills: ['unit-conversion'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Unit Conversion**\n\n**Choice C is correct.**\n\n**The Fast Way (~5s):** $4200 \\text{ cm} \\cdot \\dfrac{1 \\text{ m}}{100 \\text{ cm}} = 42 \\text{ m}$.\n\n**Why the wrong answers are tempting:**\n* A: divides by $10^5$ — too many zeros.\n* B: divides by $10^3$ — off by one.\n* D: multiplies instead of divides.\n\n**Test Day Takeaway:** Cancel units explicitly. cm in the numerator cancels with cm in the denominator of the conversion factor.",
  ...
  { id: 'bank-ps-291', domain: 'problem-solving', skills: ['unit-conversion'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Unit Conversion**\n\n**Choice B is correct.**\n\n**The Fast Way (~5s):** $480 \\text{ g} / 1000 = 0.48 \\text{ kg}$.\n\n**Why the wrong answers are tempting:**\n* A: divides by $10000$ — off by one.\n* C: divides by $100$ — off by one.\n* D: divides by $10$.\n\n**Test Day Takeaway:** Larger unit (kg) $\\Rightarrow$ smaller NUMBER. $480$ g is less than $1$ kg, so the answer must be < $1$.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'unit-conversion', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-292', domain: 'problem-solving', skills: ['unit-conversion'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Unit Conversion**\n\n**Choice B is correct.**\n\n**The Fast Way (~15s):** $60 \\dfrac{\\text{mi}}{\\text{hr}} \\cdot \\dfrac{5280 \\text{ ft}}{1 \\text{ mi}} \\cdot \\dfrac{1 \\text{ hr}}{3600 \\text{ s}} = \\dfrac{60 \\cdot 5280}{3600} = 88$ ft/s.\n\n**Why the wrong answers are tempting:**\n* A: same number as mph — forgets conversion.\n* C: multiplies by $5280$ without dividing.\n* D: only converts miles to feet.\n\n**Test Day Takeaway:** Chained conversions: multiply by conversion ratios so units cancel. Track which unit ends up in the numerator vs denominator.",
  ...
  { id: 'bank-ps-293', domain: 'problem-solving', skills: ['unit-conversion'], difficulty: 'medium', type: 'fill-in',
    ...
    correctAnswer: '1200',
    explanation: "**SAT Pattern: Unit Conversion**\n\n**The correct answer is $1200$.**\n\n**The Fast Way (~15s):** $1.2 \\dfrac{\\text{g}}{\\text{cm}^3} \\cdot \\dfrac{1 \\text{ kg}}{1000 \\text{ g}} \\cdot \\dfrac{10^6 \\text{ cm}^3}{1 \\text{ m}^3} = 1.2 \\cdot 10^3 = 1200$ kg/m³.\n\n**Common Mistakes:**\n* Reporting $1.2$: forgets to convert the volume unit.\n* Reporting $0.0012$: divides instead of multiplies.\n\n**Test Day Takeaway:** When units are POWERS (like cm³), the conversion factor is RAISED to the same power. $1$ m $= 100$ cm $\\Rightarrow$ $1$ m³ $= 10^6$ cm³.",
    calculatorAllowed: true, tags: [], sourceStyleRef: 'unit-conversion', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-294', domain: 'problem-solving', skills: ['unit-conversion'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'D',
    explanation: "**SAT Pattern: Unit Conversion**\n\n**Choice D is correct.**\n\n**The Fast Way (~10s):** Total ink: $0.05 \\cdot 250 = 12.5$ L. Convert to mL: $12.5 \\cdot 1000 = 12{,}500$ mL.\n\n**Why the wrong answers are tempting:**\n* A: stops at liters.\n* B: divides instead of multiplies for conversion.\n* C: off by one zero.\n\n**Test Day Takeaway:** Two-step process: compute the quantity in the original units, then convert.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'unit-conversion', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-295', domain: 'problem-solving', skills: ['unit-conversion'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Unit Conversion**\n\n**Choice C is correct.**\n\n**The Fast Way (~15s):** $0.5 \\text{ mi}^2 \\cdot (5280 \\text{ ft})^2 / \\text{mi}^2 = 0.5 \\cdot 27{,}878{,}400 = 13{,}939{,}200$ ft².\n\n**The Full Solution:**\n$1 \\text{ mi}^2 = 5280^2 \\text{ ft}^2 = 27{,}878{,}400 \\text{ ft}^2$.\n$0.5 \\text{ mi}^2 = 0.5 \\cdot 27{,}878{,}400 = 13{,}939{,}200 \\text{ ft}^2$.\n\n**Why the wrong answers are tempting:**\n* A: forgets to square the conversion factor.\n* B: squares only one factor.\n* D: forgets the $0.5$.\n\n**Test Day Takeaway:** Squared units convert with SQUARED factors. $1$ mi² $= (5280)^2$ ft², not $5280$.",
    calculatorAllowed: true, tags: [], sourceStyleRef: 'unit-conversion', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-296', domain: 'problem-solving', skills: ['unit-conversion'], difficulty: 'hard', type: 'fill-in',
    ...
    explanation: "**SAT Pattern: Unit Conversion**\n\n**The correct answer is $1077.12$.**\n\n**The Fast Way (~15s):** $2.4 \\dfrac{\\text{ft}^3}{\\text{min}} \\cdot 60 \\text{ min} \\cdot 7.48 \\dfrac{\\text{gal}}{\\text{ft}^3} = 2.4 \\cdot 60 \\cdot 7.48 = 1077.12$ gallons.\n\n**Common Mistakes:**\n* Reporting $144$: stops at $\\text{ft}^3$ ($2.4 \\cdot 60$).\n* Reporting $179.52$: forgets to multiply by time.\n* Reporting $17.952$: drops a zero.\n\n**Test Day Takeaway:** Multi-step conversions: chain conversion factors so units cancel one at a time. Verify the final unit matches the question.",
    calculatorAllowed: true, tags: [], sourceStyleRef: 'unit-conversion', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-297', domain: 'problem-solving', skills: ['unit-conversion'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Unit Conversion**\n\n**Choice C is correct.**\n\n**The Fast Way (~15s):** $3 \\dfrac{\\text{widgets}}{\\text{s}} \\cdot 3600 \\dfrac{\\text{s}}{\\text{hr}} \\cdot 40 \\text{ hr} = 3 \\cdot 3600 \\cdot 40 = 432{,}000$.\n\n**Why the wrong answers are tempting:**\n* A: $3 \\cdot 40 \\cdot 60$ — uses minutes instead of seconds.\n* B: missing one factor of $10$.\n* D: extra factor of $1000$.\n\n**Test Day Takeaway:** Multi-step: per second $\\to$ per hour $\\to$ per week. Watch for missing or extra time-unit conversions.",
    calculatorAllowed: true, tags: [], sourceStyleRef: 'unit-conversion', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-298', domain: 'problem-solving', skills: ['ratios'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Mixture Problems**\n\n**Choice C is correct.**\n\n**The Fast Way (~5s):** $40\\% \\text{ of } 10 = 0.40 \\cdot 10 = 4$ liters.\n\n**Why the wrong answers are tempting:**\n* A: drops a decimal.\n* B: divides instead of multiplies.\n* D: reports the OTHER component (water).\n\n**Test Day Takeaway:** 'X% of Y' for mixtures: multiply percent (as decimal) by total volume to get component amount.",
  ...
  { id: 'bank-ps-299', domain: 'problem-solving', skills: ['ratios'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: "**SAT Pattern: Mixture Problems**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** Total solution = $30 + 120 = 150$. Concentration = $30/150 = 0.20 = 20\\%$.\n\n**Why the wrong answers are tempting:**\n* B: divides salt by water ($30/120 = 25\\%$) instead of total.\n* C: reports salt mass.\n* D: reports water concentration.\n\n**Test Day Takeaway:** Mixture concentration uses TOTAL as the denominator, not just the other component.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'mixture-problems', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-300', domain: 'problem-solving', skills: ['ratios'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Mixture Problems**\n\n**Choice C is correct.**\n\n**The Fast Way (~15s):** Acid: $0.20 \\cdot 4 + 0.50 \\cdot 6 = 0.8 + 3 = 3.8$ L. Total: $4 + 6 = 10$ L. Concentration: $3.8/10 = 38\\%$.\n\n**Why the wrong answers are tempting:**\n* A: averages percents ($(20 + 50)/2$) — incorrect because volumes differ.\n* B: midway between average and correct.\n* D: adds percents.\n\n**Test Day Takeaway:** Weighted average: $(c_1 V_1 + c_2 V_2)/(V_1 + V_2)$. Equal volumes would give the simple average; unequal volumes weight by volume.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'mixture-problems', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-301', domain: 'problem-solving', skills: ['ratios'], difficulty: 'medium', type: 'fill-in',
    ...
    correctAnswer: '19',
    explanation: "**SAT Pattern: Mixture Problems**\n\n**The correct answer is $19$.**\n\n**The Fast Way (~10s):** Sugar: $0.10 \\cdot 200 + 0.25 \\cdot 300 = 20 + 75 = 95$ g. Total: $500$ g. Concentration: $95/500 = 0.19 = 19\\%$.\n\n**Common Mistakes:**\n* Reporting $17.5$: averages without weighting.\n* Reporting $35$: adds percents.\n\n**Test Day Takeaway:** Weighted-average concentration = (sum of component masses) / (total mass). Convert percent to decimal first.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'mixture-problems', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-302', domain: 'problem-solving', skills: ['ratios'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Mixture Problems**\n\n**Choice B is correct.**\n\n**The Fast Way (~15s):** Salt in original: $0.30 \\cdot 200 = 60$ mL. After dilution to $20\\%$: $60 = 0.20 \\cdot V_{\\text{new}} \\Rightarrow V_{\\text{new}} = 300$. Water added: $300 - 200 = 100$ mL.\n\n**The Full Solution:**\nSalt is conserved during dilution (we only ADD water). $60$ mL salt is now in $V_{\\text{new}}$ mL at $20\\%$: $V_{\\text{new}} = 60/0.20 = 300$ mL. Water added $= 300 - 200 = 100$ mL.\n\n**Why the wrong answers are tempting:**\n* A ($50$): uses incorrect dilution formula.\n* C ($150$): off by an arithmetic factor.\n* D ($200$): doubles the volume — would give a different concentration.\n\n**Test Day Takeaway:** In dilution problems, the SOLUTE amount stays constant. Solve for the new total volume to find the water added.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'mixture-problems', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-303', domain: 'problem-solving', skills: ['ratios'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Mixture Problems**\n\n**Choice C is correct.**\n\n**The Fast Way (~5s):** Brazilian = $100\\% - 40\\% = 60\\%$ of $50$ = $0.60 \\cdot 50 = 30$ lbs.\n\n**Why the wrong answers are tempting:**\n* A: $40\\%$ of $50$ — reports Colombian.\n* B: half.\n* D: reports the percent.\n\n**Test Day Takeaway:** When percents of components sum to $100\\%$, find the other component via complement.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'mixture-problems', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-304', domain: 'problem-solving', skills: ['ratios'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Mixture Problems**\n\n**Choice C is correct.**\n\n**The Fast Way (~20s):** Original acid: $0.10 \\cdot 10 = 1$ L. Add $x$ L pure acid. New acid: $1 + x$. New total: $10 + x$. Set: $(1 + x)/(10 + x) = 0.40 \\Rightarrow 1 + x = 4 + 0.40x \\Rightarrow 0.60x = 3 \\Rightarrow x = 5$.\n\n**Why the wrong answers are tempting:**\n* A ($3$): forgets that the TOTAL volume also changes.\n* B ($4$): off by one.\n* D ($6$): solves a different equation.\n\n**Test Day Takeaway:** When adding pure solute: BOTH the numerator (solute) AND the denominator (total) increase. Set up the equation carefully.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'mixture-problems', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-305', domain: 'problem-solving', skills: ['ratios'], difficulty: 'hard', type: 'fill-in',
    ...
    correctAnswer: '6',
    explanation: "**SAT Pattern: Mixture Problems**\n\n**The correct answer is $6$.**\n\n**The Fast Way (~20s):** Let $x$ = volume of $60\\%$ solution. Then $14 - x$ is the $25\\%$ solution.\nAlcohol balance: $0.25(14 - x) + 0.60 x = 0.40 \\cdot 14$\n$\\quad 3.5 - 0.25x + 0.60x = 5.6$\n$\\quad 0.35x = 2.1$\n$\\quad x = 6$ liters.\n\nVerification: $8$ L at $25\\%$ + $6$ L at $60\\%$: alcohol = $2 + 3.6 = 5.6$ = $40\\%$ of $14$ \\checkmark.\n\n**Test Day Takeaway:** Set up a balance equation for the solute. Solve for the unknown volume.",
  ...
  { id: 'bank-ps-308', domain: 'problem-solving', skills: ['find-median'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Box Plot Interpretation**\n\n**Choice C is correct.**\n\n**The Fast Way (~10s):** Box plot shows min $= 50$, so the lowest score in the data is $50$. No student scored below $50$.\n\n**Why the wrong answers are tempting:**\n* A: confuses median with mean.\n* B: 'approximately' $25\\%$ — but quartile assignment depends on data ties.\n* D: 'at least HALF' — but with ties at the median, fewer than half could be above $73$.\n\n**Test Day Takeaway:** Min is the smallest value, max is the largest. Quartiles split the data approximately into 4 equal groups, but ties at quartile boundaries can shift counts.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'box-plot-interpretation', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-310', domain: 'problem-solving', skills: ['find-median'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Box Plot Interpretation**\n\n**Choice B is correct.**\n\n**The Key Distinction:** A wider box = LARGER IQR = more spread in the MIDDLE $50\\%$ of the data.\n\n**Why the wrong answers are tempting:**\n* A: same median, so scores aren't 'higher' on average.\n* C: box plot doesn't show count.\n* D: mean is not in the box plot.\n\n**Test Day Takeaway:** IQR (width of the box) measures spread of the central half. A wider box doesn't mean larger or smaller values overall.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'box-plot-interpretation', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-312', domain: 'problem-solving', skills: ['find-median'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Box Plot Interpretation**\n\n**Choice C is correct.**\n\n**The Key Rule:** Right-skewed distributions have a long upper tail. The mean is PULLED toward the tail (UP), so mean > median.\n\n**Why the wrong answers are tempting:**\n* A: opposite — that's left-skewed.\n* B: only true for symmetric distributions.\n* D: median always splits the data in half (50-50) regardless of skew.\n\n**Test Day Takeaway:** Right-skew $\\Rightarrow$ mean > median. Left-skew $\\Rightarrow$ mean < median. Symmetric $\\Rightarrow$ mean $\\approx$ median.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'box-plot-interpretation', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-314', domain: 'problem-solving', skills: ['standard-deviation-concept'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Standard Deviation Comparison**\n\n**Choice C is correct.**\n\n**The Fast Way (~5s):** Both have mean $10$. Set A values are close to the mean ($8, 9, 10, 11, 12$). Set B values spread much further ($1, 5, 10, 15, 19$). More spread = larger standard deviation.\n\n**Why the wrong answers are tempting:**\n* A: ignores the visible spread difference.\n* B: opposite direction.\n* D: visual inspection IS a valid SD comparison when spread is clearly different.\n\n**Test Day Takeaway:** Standard deviation measures how far data spread from the mean. Visibly wider spread $\\Rightarrow$ larger SD. No computation needed for clear cases.",
  ...
  { id: 'bank-ps-315', domain: 'problem-solving', skills: ['standard-deviation-concept'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Standard Deviation Comparison**\n\n**Choice B is correct.**\n\n**The Fast Way (~5s):** Wider spread of scores $\\Rightarrow$ larger SD. The second class has much wider spread.\n\n**Test Day Takeaway:** Compare ranges/IQRs as a quick proxy: larger range usually implies larger SD (though not always — outliers can distort).",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'standard-deviation-comparison', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-316', domain: 'problem-solving', skills: ['standard-deviation-concept'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Standard Deviation Comparison**\n\n**Choice B is correct.**\n\n**The Key Distinction:** With similar distribution shape, a LARGER range typically implies a LARGER standard deviation. Set B's range is $3\\times$ Set A's, suggesting larger SD.\n\n**Why the wrong answers are tempting:**\n* A: opposite.\n* C: range and SD aren't perfectly correlated, but with similar shape, range scales with SD.\n* D: range doesn't tell us about mean.\n\n**Test Day Takeaway:** Range is a quick proxy for spread when shapes are similar. Larger range $\\Rightarrow$ likely larger SD.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'standard-deviation-comparison', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-317', domain: 'problem-solving', skills: ['standard-deviation-concept'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Standard Deviation Comparison**\n\n**Choice C is correct.**\n\n**The Fast Way (~5s):** Set X has SD = $0$ (all values equal mean). Set Y has SD > $0$ (values differ from mean). So Y > X.\n\n**Test Day Takeaway:** When ALL values equal, SD = $0$. Any spread above zero $\\Rightarrow$ SD > $0$.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'standard-deviation-comparison', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-318', domain: 'problem-solving', skills: ['standard-deviation-concept'], difficulty: 'medium', type: 'fill-in',
    ...
    correctAnswer: '20',
    explanation: "**SAT Pattern: Standard Deviation Comparison**\n\n**The correct answer is $20$.**\n\n**The Fast Way (~5s):** Multiplying all values by $5$ multiplies the SD by $5$: $4 \\cdot 5 = 20$.\n\n**The Full Solution:**\nIf $X' = 5X$, then SD$(X') = 5 \\cdot$ SD$(X) = 5 \\cdot 4 = 20$. (Multiplying scales spread directly.)\n\n**Common Mistakes:**\n* Reporting $4$: assumes SD doesn't change under multiplication.\n* Reporting $25$: squares the multiplier (variance scaling).\n\n**Test Day Takeaway:** Multiplication scales SD by the same factor. ADDITION (shifting all values) does NOT change SD.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'standard-deviation-comparison', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-319', domain: 'problem-solving', skills: ['standard-deviation-concept'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Standard Deviation Comparison**\n\n**Choice B is correct.**\n\n**The Key Distinction:** Adding a constant to every value shifts the mean by that constant but does NOT change spread (SD stays the same).\n\n**Why the wrong answers are tempting:**\n* A: mean should shift.\n* C: SD shouldn't change.\n* D: multiplication scaling instead of addition.\n\n**Test Day Takeaway:** Translation (adding a constant): mean shifts, SD unchanged. Scaling (multiplying): both scale by the same factor.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'standard-deviation-comparison', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-320', domain: 'problem-solving', skills: ['standard-deviation-concept'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: "**SAT Pattern: Standard Deviation Comparison**\n\n**Choice A is correct.**\n\n**The Key Distinction:** Uniform distribution spreads values evenly across the range $\\Rightarrow$ each value is FAR from the mean (in absolute terms). Bell-shape concentrates values near the mean $\\Rightarrow$ smaller average distance.\n\n**Why the wrong answers are tempting:**\n* B: counterintuitive — outliers do push SD up, but most values being close keeps the average squared deviation lower.\n* C: same range doesn't mean same SD.\n* D: there IS a reasonable inference here.\n\n**Test Day Takeaway:** SD is the AVERAGE distance from the mean. Concentrated-near-mean distributions have smaller SD than spread-evenly distributions, even with the same range.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'standard-deviation-comparison', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-321', domain: 'problem-solving', skills: ['standard-deviation-concept'], difficulty: 'hard', type: 'fill-in',
    ...
    correctAnswer: '12',
    explanation: "**SAT Pattern: Standard Deviation Comparison**\n\n**The correct answer is $12$.**\n\n**The Fast Way (~10s):** Multiplication by $2$: SD $\\to 6 \\cdot 2 = 12$. Adding $5$: SD unchanged. Final: $12$.\n\n**The Full Solution:**\nLinear transformation $X' = aX + b$ produces SD$(X') = |a| \\cdot$ SD$(X)$. The shift $b$ does NOT affect SD. Here $a = 2$, $b = 5$: SD = $|2| \\cdot 6 = 12$.\n\n**Common Mistakes:**\n* Reporting $17$: adds the shift to the SD.\n* Reporting $11$: adds before scaling.\n\n**Test Day Takeaway:** SD transformation rule: only the multiplicative factor matters. Translation has zero effect.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'standard-deviation-comparison', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-322', domain: 'problem-solving', skills: ['slope-from-points', 'scatterplots'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Interpret Slope of Best Fit**\n\n**Choice B is correct.**\n\n**The Fast Way (~10s):** Slope $= \\Delta y / \\Delta x$ = predicted change in cost per $1$-mile change in distance.\n\n**Why the wrong answers are tempting:**\n* A: that's the y-intercept ($3$).\n* C: confuses slope value with output.\n* D: reciprocal interpretation.\n\n**Test Day Takeaway:** Slope of $\\hat{y} = mx + b$: predicted increase in $y$ per unit increase in $x$. Always include units.",
  ...
  { id: 'bank-ps-323', domain: 'problem-solving', skills: ['slope-from-points', 'scatterplots'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: "**SAT Pattern: Interpret Slope of Best Fit**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** Slope = predicted change per unit $x$. Here: $1.8$ cm per $1$ day.\n\n**Why the wrong answers are tempting:**\n* B: that's the y-intercept ($5$).\n* C: mixes slope and y-int.\n* D: unrelated max.\n\n**Test Day Takeaway:** Slope interpretation: 'per unit $x$, $y$ is predicted to change by [slope].'",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'interpret-slope-of-best-fit', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-325', domain: 'problem-solving', skills: ['slope-from-points', 'scatterplots'], difficulty: 'medium', type: 'fill-in',
    ...
    correctAnswer: '10',
    explanation: "**SAT Pattern: Interpret Slope of Best Fit**\n\n**The correct answer is $10$.**\n\n**The Fast Way (~5s):** Slope = $-2.5$ °F per hour. Over $4$ hours: $|{-2.5}| \\cdot 4 = 10$ degree drop.\n\n**Common Mistakes:**\n* Reporting $-10$: sign confusion — the question asks for the DROP magnitude.\n* Reporting $2.5$: per hour, not per 4 hours.\n* Reporting $80$: y-intercept.\n\n**Test Day Takeaway:** Negative slope means decreasing $y$. To get total change over $\\Delta x$ units, multiply slope by $\\Delta x$.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'interpret-slope-of-best-fit', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-326', domain: 'problem-solving', skills: ['slope-from-points', 'scatterplots'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Interpret Slope of Best Fit**\n\n**Choice B is correct.**\n\n**The Fast Way (~5s):** Slope = predicted change in $y$ per unit $x$. $y$ in thousands, $x$ in years: predicted $+4.2$ thousand per year.\n\n**Test Day Takeaway:** Always speak the slope WITH UNITS: '[slope] units of $y$ per unit of $x$.'",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'interpret-slope-of-best-fit', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-327', domain: 'problem-solving', skills: ['slope-from-points', 'scatterplots'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'C',
    explanation: "**SAT Pattern: Interpret Slope of Best Fit**\n\n**Choice C is correct.**\n\n**The Fast Way (~5s):** Plug in $x = 12$: $\\hat{y} = 0.25(12) + 1 = 3 + 1 = 4$.\n\n**Why the wrong answers are tempting:**\n* A: just the slope.\n* B: forgets to add the intercept.\n* D: forgets the slope (uses $12 + 1$).\n\n**Test Day Takeaway:** For predictions, substitute $x$ and compute. Don't confuse the slope alone with the predicted value.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'interpret-slope-of-best-fit', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-328', domain: 'problem-solving', skills: ['slope-from-points', 'scatterplots'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Interpret Slope of Best Fit**\n\n**Choice B is correct.**\n\n**The Fast Way (~5s):** Change in $\\hat{y}$ = slope $\\cdot \\Delta x = -0.005 \\cdot 1000 = -5$ mpg (decrease of $5$).\n\n**Why the wrong answers are tempting:**\n* A: ignores the negative slope.\n* C/D: drops a decimal place.\n\n**Test Day Takeaway:** Sign of the slope tells you direction; magnitude tells you size. $|-0.005| \\cdot 1000 = 5$ unit drop per $1000$-pound increase.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'interpret-slope-of-best-fit', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-330', domain: 'problem-solving', skills: ['slope-from-points', 'scatterplots'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: "**SAT Pattern: Interpret Intercept of Best Fit**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** Y-intercept = predicted $y$ at $x = 0$. Here: cost when minutes $= 0 \\Rightarrow$ flat fee.\n\n**Why the wrong answers are tempting:**\n* B: that's the slope.\n* C/D: unrelated to the equation.\n\n**Test Day Takeaway:** Y-intercept of $\\hat{y} = mx + b$: the predicted $y$ when $x = 0$. In context, this is the 'starting value' or 'fixed component'.",
  ...
  { id: 'bank-ps-331', domain: 'problem-solving', skills: ['slope-from-points', 'scatterplots'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Interpret Intercept of Best Fit**\n\n**Choice B is correct.**\n\n**The Fast Way (~5s):** At $x = 0$, $\\hat{y} = 200$. That's the initial balance.\n\n**Test Day Takeaway:** Y-intercept = starting value. Slope = per-unit change.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'interpret-intercept-of-best-fit', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-332', domain: 'problem-solving', skills: ['slope-from-points', 'scatterplots'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: "**SAT Pattern: Interpret Intercept of Best Fit**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** At $x = 0$ (noon), $\\hat{y} = 75$. That's the predicted temperature at noon.\n\n**Why the wrong answers are tempting:**\n* B: that's the slope.\n* C: midnight is $x = 12$, not $0$.\n* D: 'highest' isn't given by the y-intercept directly.\n\n**Test Day Takeaway:** Y-intercept = predicted $y$ when $x = 0$. Tie the interpretation to the CONTEXT of $x = 0$.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'interpret-intercept-of-best-fit', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-333', domain: 'problem-solving', skills: ['slope-from-points', 'scatterplots'], difficulty: 'medium', type: 'fill-in',
    ...
    correctAnswer: '3',
    explanation: "**SAT Pattern: Interpret Intercept of Best Fit**\n\n**The correct answer is $3$.**\n\n**The Fast Way (~3s):** At $x = 0$ (planting), $\\hat{y} = 3$ feet.\n\n**Test Day Takeaway:** Plug $x = 0$ into the model — that's the predicted starting value.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'interpret-intercept-of-best-fit', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-334', domain: 'problem-solving', skills: ['slope-from-points', 'scatterplots'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: "**SAT Pattern: Interpret Intercept of Best Fit**\n\n**Choice A is correct.**\n\n**The Key Insight:** The y-intercept is mathematically the predicted value at $x = 0$, but at age $0$ (a newborn) the model has no realistic meaning. This is EXTRAPOLATION beyond the data range.\n\n**Why the wrong answers are tempting:**\n* B: that's the slope.\n* C: confuses intercept with a specific $x$ value.\n* D: reverses interpretation.\n\n**Test Day Takeaway:** Y-intercept is the model's predicted value at $x = 0$. When $x = 0$ is OUTSIDE the realistic range, the y-intercept may not have meaningful real-world interpretation.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'interpret-intercept-of-best-fit', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-335', domain: 'problem-solving', skills: ['slope-from-points', 'scatterplots'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'B',
    explanation: "**SAT Pattern: Interpret Intercept of Best Fit**\n\n**Choice B is correct.**\n\n**The Fast Way (~5s):** At $0$ visits, cost = y-intercept = $\\$30$ (the base fee).\n\n**Test Day Takeaway:** Fixed fee = y-intercept (cost at zero usage). Variable rate = slope.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'interpret-intercept-of-best-fit', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-336', domain: 'problem-solving', skills: ['slope-from-points', 'scatterplots'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: "**SAT Pattern: Interpret Intercept of Best Fit**\n\n**Choice A is correct.**\n\n**The Key Distinction:** The point $(0, 24)$ is the y-intercept — at the year of purchase ($x = 0$), the model predicts the car was worth $24$ thousand dollars.\n\n**Why the wrong answers are tempting:**\n* B: slope (correct value but wrong interpretation of intercept).\n* C: reverses intercept and x-intercept.\n* D: uses the wrong point.\n\n**Test Day Takeaway:** The point $(0, b)$ on a best-fit line is the y-intercept: the predicted $y$ at $x = 0$.",
    calculatorAllowed: false, tags: [], sourceStyleRef: 'interpret-intercept-of-best-fit', authoredBy: 'performsat-engine', createdAt: '2026-05-16' },
  ...
  { id: 'bank-ps-376', domain: 'problem-solving', skills: ['calculate-mean'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Mean from List**\n\n**Choice A is correct.**\n\n**The Fast Way (~20s):** Original sum: $6 \\cdot 12 = 72$. New sum: $7 \\cdot 14 = 98$. Difference is the new value: $98 - 72 = 26$.\n\n**The Full Solution:**\nUse the relationship mean × count = sum.\nOriginal total: $6 \\cdot 12 = 72$.\nNew total: $7 \\cdot 14 = 98$.\nThe new value is the difference: $98 - 72 = 26$ \\checkmark.\n\n**Why the wrong answers are tempting:**\n* B ($14$): assumes the new value equals the new mean.\n* C ($28$): doubles the difference between means ($14 - 12 = 2$, then $14 \\cdot 2$).\n* D ($2$): reports the difference between means without scaling by the new count.\n\n**Test Day Takeaway:** Mean problems with added/removed values use SUM bookkeeping: convert each mean to a sum (mean × count), then the difference IS the added/removed value.',
  ...
  { id: 'bank-ps-377', domain: 'problem-solving', skills: ['calculate-mean'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Mean from List**\n\n**Choice A is correct.**\n\n**The Fast Way (~20s):** Sum of A: $10 \\cdot 50 = 500$. Sum of B: $15 \\cdot 80 = 1200$. Combined: $1700/25 = 68$.\n\n**The Full Solution:**\nSum of List $A$: $10 \\cdot 50 = 500$.\nSum of List $B$: $15 \\cdot 80 = 1200$.\nCombined sum: $500 + 1200 = 1700$.\nCombined mean: $1700 / 25 = 68$ \\checkmark.\n\n**Why the wrong answers are tempting:**\n* B ($65$): averages the two means as if the lists had EQUAL counts ($(50 + 80)/2 = 65$). Ignores that B has more values.\n* C ($130$): adds the two means without dividing.\n* D ($60$): under-weights the larger list — wrong weighting.\n\n**Test Day Takeaway:** Combining means is NOT averaging the means unless the counts are equal. Convert each mean to a sum, ADD the sums, divide by the COMBINED count.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'mean-from-list', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-378', domain: 'problem-solving', skills: ['percent-of-value'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: "**SAT Pattern: Percent Complement**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $100\\% - 62\\% = 38\\%$.\n\n**The Full Solution:**\nEvery percent of a whole has a complement equal to $100\\%$ minus that percent.\n$100\\% - 62\\% = 38\\%$ of those polled did not favor the proposal.\n\nVerification: $62\\% + 38\\% = 100\\%$ \\checkmark.\n\n**Why the wrong answers are tempting:**\n* B ($62\\%$): returns the given percent unchanged.\n* C ($28\\%$): subtracts from $90\\%$ instead of $100\\%$ (or mis-arithmetics $100 - 72$).\n* D ($48\\%$): subtracts from $110\\%$ or mis-reads $62$ as $52$.\n\n**Test Day Takeaway:** \"Did NOT,\" \"do not,\" \"remaining\" → complement. Subtract from $100\\%$.",
  ...
  { id: 'bank-ps-379', domain: 'problem-solving', skills: ['percent-of-value'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent Complement**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $5/8 = 0.625 = 62.5\\%$ filled. Complement: $100\\% - 62.5\\% = 37.5\\%$ not filled. Or directly: $3/8 = 37.5\\%$.\n\n**The Full Solution:**\nUnfilled fraction: $1 - 5/8 = 3/8$.\nConvert: $3/8 = 0.375 = 37.5\\%$.\n\n**Why the wrong answers are tempting:**\n* B ($62.5\\%$): returns the FILLED percent, not the unfilled.\n* C ($40\\%$): rounds $3/8$ to $2/5 = 40\\%$ incorrectly.\n* D ($3\\%$): reads the numerator of $3/8$ as a percent directly, dropping the denominator.\n\n**Test Day Takeaway:** Convert fractions to percents by dividing first, then subtracting from $100\\%$. Or compute the complementary fraction ($1 - 5/8 = 3/8$) and convert it directly.',
  ...
  { id: 'bank-ps-380', domain: 'problem-solving', skills: ['slope-intercept-form'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Scatterplot Line of Best Fit**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $x = 20$ (thousands). $\\hat{y} = 0.6(20) + 12 = 12 + 12 = 24$. Revenue: $\\$24{,}000$.\n\n**The Full Solution:**\nThe units of $x$ and $y$ are both thousands of dollars. With $x = 20$ (i.e., $\\$20{,}000$ in spend):\n$\\hat{y} = 0.6(20) + 12 = 12 + 12 = 24$ (thousand dollars) $= \\$24{,}000$ \\checkmark.\n\n**Why the wrong answers are tempting:**\n* B ($\\$12{,}000$): returns the $y$-intercept (the predicted revenue when spend is $\\$0$).\n* C ($\\$26{,}000$): adds intercept to $x$ ($12 + 20 + ...$) without applying the slope coefficient.\n* D ($\\$120{,}000$): misreads $x$ as $200$ (forgets the "thousands" unit on $x$).\n\n**Test Day Takeaway:** Substitute the input INTO the model. Watch units carefully when the axes are in thousands or hundreds — match the input to the variable\'s unit.',
  ...
  { id: 'bank-ps-381', domain: 'problem-solving', skills: ['slope-intercept-form'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Scatterplot Line of Best Fit**\n\n**Choice A is correct.**\n\n**The Fast Way:** In $\\hat{y} = mx + b$, the slope $m$ is the predicted CHANGE in $y$ per UNIT change in $x$. Here: each additional year of age (unit change in $x$) is associated with a $0.3$ bpm decrease (the slope is negative).\n\n**Why the wrong answers are tempting:**\n* B: SWAPS the roles of $x$ and $y$ — slope describes change in the response per unit of the predictor, not the reverse.\n* C: confuses the slope with the $y$-intercept (which is $78$, not $-0.3$).\n* D: misreads $-0.3$ as $-30$ (off by a factor of $100$).\n\n**Test Day Takeaway:** Slope = predicted change in the $y$-variable per ONE unit increase in the $x$-variable. Sign carries direction (negative = decrease). Use the actual variable names and units when interpreting.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'scatterplot-line-of-best-fit', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-382', domain: 'problem-solving', skills: ['probability-basics'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Basic Probability**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $P(\\text{red}) = 4 / (4 + 6) = 4/10 = 2/5$.\n\n**Why the wrong answers are tempting:**\n* B: divides red by blue (ignores the total).\n* C: divides blue by red.\n* D: random fraction.\n\n**Test Day Takeaway:** Probability = favorable / TOTAL outcomes, not favorable / unfavorable.',
  ...
  { id: 'bank-ps-383', domain: 'problem-solving', skills: ['probability-basics'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Basic Probability**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $13/52 = 1/4$.\n\n**Why the wrong answers are tempting:**\n* B: subtracts hearts ($13/39$ would be hearts vs. non-hearts).\n* C: inverts the fraction.\n* D: uses $1$ as numerator.\n\n**Test Day Takeaway:** Simplify the ratio: $13/52$ shares a factor of $13$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'basic-probability', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-384', domain: 'problem-solving', skills: ['probability-basics'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Basic Probability**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** Favorable: $\\{5, 6\\}$ (2 values). Total: $6$. $P = 2/6 = 1/3$.\n\n**Why the wrong answers are tempting:**\n* B: counts only ONE favorable outcome.\n* C: complement.\n* D: $P(\\leq 4)$.\n\n**Test Day Takeaway:** "Greater than $4$" excludes $4$ — count $\\{5, 6\\}$ only.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'basic-probability', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-385', domain: 'problem-solving', skills: ['probability-basics'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Basic Probability**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** Total $= 3 + 5 + 7 = 15$. $P(\\text{green}) = 5/15 = 1/3$.\n\n**Why the wrong answers are tempting:**\n* B: divides by $12$ (forgets one color).\n* C: divides green by blue.\n* D: inverts.\n\n**Test Day Takeaway:** Sum ALL favorable outcomes — even ones you\'re not picking — to get the total.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'basic-probability', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-386', domain: 'problem-solving', skills: ['probability-basics'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Basic Probability**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $P(\\text{no glasses}) = 6/10 = 3/5$, or by complement $1 - 4/10 = 6/10$.\n\n**Why the wrong answers are tempting:**\n* B: $P(\\text{glasses})$.\n* C: uses $1/10$.\n* D: inverts.\n\n**Test Day Takeaway:** "Does NOT" → use the complement: $1 - P(\\text{does})$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'basic-probability', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-387', domain: 'problem-solving', skills: ['probability-basics'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Basic Probability**\n\n**Choice A is correct.**\n\n**The Fast Way (~20s):** Inclusion-exclusion: $|S \\cup F| = 18 + 12 - 5 = 25$. $P = 25/30 = 5/6$.\n\n**Why the wrong answers are tempting:**\n* B: assumes everyone studies at least one language.\n* C: $15/30$ random.\n* D: $20/30$.\n\n**Test Day Takeaway:** "OR" → add the counts and SUBTRACT the overlap (otherwise you double-count).',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'basic-probability', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-388', domain: 'problem-solving', skills: ['conditional-probability'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Conditional Probability with Percent**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $60 \\times 0.75 = 45$.\n\n**Why the wrong answers are tempting:**\n* B: returns the pet owners count.\n* C: returns the percent directly.\n* D: $100 - 75$.\n\n**Test Day Takeaway:** "$P$ percent of $Q$" → $Q \\times (P/100)$.',
  ...
  { id: 'bank-ps-389', domain: 'problem-solving', skills: ['conditional-probability'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Conditional Probability with Percent**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** Seniors: $200 \\times 0.30 = 60$. Of those, sports: $60 \\times 0.40 = 24$.\n\n**Why the wrong answers are tempting:**\n* B ($60$): returns the senior count.\n* C ($80$): $200 \\times 0.40$.\n* D ($70$): adds percents.\n\n**Test Day Takeaway:** Apply the percentages SEQUENTIALLY (multiply them, then by the total).',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'conditional-probability-with-percent', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-390', domain: 'problem-solving', skills: ['conditional-probability'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Conditional Probability with Percent**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** Internet: $500 \\times 0.65 = 325$. Streaming: $325 \\times 0.80 = 260$.\n\n**Why the wrong answers are tempting:**\n* B ($325$): stops at internet count.\n* C ($400$): adds the percentages incorrectly.\n* D ($208$): swaps the multipliers.\n\n**Test Day Takeaway:** "Of those who..." signals conditional — multiply the second percent by the SUBSET count, not the original total.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'conditional-probability-with-percent', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-391', domain: 'problem-solving', skills: ['conditional-probability'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Conditional Probability with Percent**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** $800 \\times 0.25 \\times 0.60 = 120$.\n\n**Why the wrong answers are tempting:**\n* B ($200$): stops at loyalty count.\n* C ($480$): $800 \\times 0.60$.\n* D ($340$): adds.\n\n**Test Day Takeaway:** Multiply the percents together to avoid intermediate rounding.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'conditional-probability-with-percent', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-392', domain: 'problem-solving', skills: ['conditional-probability'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Conditional Probability with Percent**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** $150 \\times 0.40 \\times 0.70 = 42$.\n\n**Why the wrong answers are tempting:**\n* B ($60$): stops at remote count.\n* C ($105$): $150 \\times 0.70$.\n* D ($110$): adds.\n\n**Test Day Takeaway:** Each conditional layer multiplies through.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'conditional-probability-with-percent', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-393', domain: 'problem-solving', skills: ['conditional-probability'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Conditional Probability with Percent**\n\n**Choice A is correct.**\n\n**The Fast Way (~20s):** $0.40 \\times 0.55 \\times T = 1100 \\Rightarrow 0.22 T = 1100 \\Rightarrow T = 5000$.\n\n**Why the wrong answers are tempting:**\n* B/C/D: misapply or skip steps.\n\n**Test Day Takeaway:** Reverse-direction conditionals: combine the percents, then divide.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'conditional-probability-with-percent', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-394', domain: 'problem-solving', skills: ['calculate-mean'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Finding a Missing Value Given the Mean**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** Total $= 5 \\times 14 = 70$. Sum of given: $55$. Missing: $70 - 55 = 15$.\n\n**Why the wrong answers are tempting:**\n* B: copies the mean.\n* C: returns the sum of given values.\n* D: returns the total.\n\n**Test Day Takeaway:** Mean × count = sum. Subtract known sum to isolate the unknown.',
  ...
  { id: 'bank-ps-395', domain: 'problem-solving', skills: ['calculate-mean'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Finding a Missing Value Given the Mean**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** Total $= 7 \\times 20 = 140$. Missing: $140 - 130 = 10$.\n\n**Why the wrong answers are tempting:**\n* B: copies the mean.\n* C: returns the total.\n* D: $130/10$.\n\n**Test Day Takeaway:** When given the SUM of the others, subtract directly from $n \\times \\bar{x}$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'finding-a-missing-value-given-the-mean', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-396', domain: 'problem-solving', skills: ['calculate-mean'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Finding a Missing Value Given the Mean**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** Total: $4 \\times 85 = 340$. Sum given: $80 + 92 + 78 = 250$. Missing: $90$.\n\n**Why the wrong answers are tempting:**\n* B: copies the mean.\n* C/D: mis-arithmetic.\n\n**Test Day Takeaway:** Convert mean to sum first, then subtract.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'finding-a-missing-value-given-the-mean', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-409', domain: 'problem-solving', skills: ['percent-change'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent Decrease**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $75/500 = 0.15 = 15\\%$.\n\n**Why the wrong answers are tempting:**\n* B: $425/500$.\n* C: $75/425$.\n* D: raw decrease.\n\n**Test Day Takeaway:** % decrease formula consistently uses ORIGINAL in the denominator.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'percent-decrease', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-410', domain: 'problem-solving', skills: ['percent-change'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent Decrease**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $(2400 - 2040)/2400 = 360/2400 = 0.15 = 15\\%$.\n\n**Why the wrong answers are tempting:**\n* B: $360/2040$.\n* C: $2040/2400$.\n* D: raw decrease / 10.\n\n**Test Day Takeaway:** Calculator can help — always check denominator is the original.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'percent-decrease', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-411', domain: 'problem-solving', skills: ['percent-change'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent Decrease**\n\n**Choice A is correct.**\n\n**The Fast Way (~20s):** Multiplier: $0.80 \\times 0.75 = 0.60$. Total decrease: $1 - 0.60 = 0.40 = 40\\%$.\n\n**Why the wrong answers are tempting:**\n* B ($45\\%$): adds the percents ($20 + 25$).\n* C ($50\\%$): random.\n* D ($30\\%$): averages.\n\n**Test Day Takeaway:** Successive percent changes MULTIPLY (as decimals), they do not add.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'percent-decrease', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-412', domain: 'problem-solving', skills: ['percent-of-value'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent of a Number**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $0.35 \\times 80 = 28$.\n\n**Why the wrong answers are tempting:**\n* B: $0.70 \\times 80$ (doubles).\n* C: $80 - 35$.\n* D: $0.035 \\times 80$ (decimal slip).\n\n**Test Day Takeaway:** "$X\\%$ of $Y$" = $(X/100) \\times Y$.',
  ...
  { id: 'bank-ps-413', domain: 'problem-solving', skills: ['percent-of-value'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent of a Number**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $0.12 \\times 250 = 30$.\n\n**Why the wrong answers are tempting:**\n* B: decimal slip.\n* C: drops the decimal.\n* D: $250 - 12$.\n\n**Test Day Takeaway:** Mental shortcut: $10\\%$ of $250 = 25$, then $20\\%$ more of $25$ adds $5$ → $30$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'percent-of-a-number', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-414', domain: 'problem-solving', skills: ['percent-of-value'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent of a Number**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $0.06 \\times 45 = 2.70$.\n\n**Why the wrong answers are tempting:**\n* B: decimal slip ($\\times 10$).\n* C: decimal slip ($\\div 10$).\n* D: $45 - 2.70$.\n\n**Test Day Takeaway:** Track decimals carefully — $6\\% = 0.06$.',
  ...
  { id: 'bank-ps-415', domain: 'problem-solving', skills: ['percent-of-value'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent of a Number**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $1.10 \\times 80 = 88$.\n\n**Why the wrong answers are tempting:**\n* B: decimal slip.\n* C: $80 - 10\\%$ (subtracts instead of adds the extra).\n* D: forgets to convert.\n\n**Test Day Takeaway:** A percent over $100$ produces a value LARGER than the original.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'percent-of-a-number', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-416', domain: 'problem-solving', skills: ['percent-of-value'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent of a Number**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $0.5\\% = 0.005$. $0.005 \\times 4000 = 20$.\n\n**Why the wrong answers are tempting:**\n* B: uses $0.05$ (5%) instead.\n* C: decimal slip.\n* D: uses $0.5$ (50%) instead.\n\n**Test Day Takeaway:** $0.5\\% \\neq 0.5$. Convert percent to decimal by DIVIDING BY 100.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'percent-of-a-number', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-417', domain: 'problem-solving', skills: ['percent-of-value'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent of a Number**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** $(24\\% - 16\\%) \\times 250 = 8\\% \\times 250 = 20$.\n\n**Why the wrong answers are tempting:**\n* B: half of $20$.\n* C: returns the difference in percents.\n* D: returns the A count ($60$).\n\n**Test Day Takeaway:** "How many more X than Y" → compute the difference in counts (or use the difference of percents on the total).',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'percent-of-a-number', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-418', domain: 'problem-solving', skills: ['percent-of-value'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent of a Whole**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $42/84 = 0.50 = 50\\%$.\n\n**Why the wrong answers are tempting:**\n* B: inverts the ratio.\n* C: copies the part.\n* D: copies the whole.\n\n**Test Day Takeaway:** "Part / Whole" gives the decimal; multiply by $100$ for percent.',
  ...
  { id: 'bank-ps-419', domain: 'problem-solving', skills: ['percent-of-value'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent of a Whole**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $18/60 = 0.30 = 30\\%$.\n\n**Why the wrong answers are tempting:**\n* B: decimal slip.\n* C: complement.\n* D: inverts.\n\n**Test Day Takeaway:** Make sure the smaller number is in the numerator unless the question intentionally inverts.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'percent-of-a-whole', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-420', domain: 'problem-solving', skills: ['percent-of-value'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent of a Whole**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $15/25 = 0.60 = 60\\%$.\n\n**Why the wrong answers are tempting:**\n* B: complement.\n* C: copies the part.\n* D: inverts.\n\n**Test Day Takeaway:** $15/25$ simplifies: $\\div 5$ gives $3/5 = 60\\%$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'percent-of-a-whole', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-421', domain: 'problem-solving', skills: ['percent-of-value'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent of a Whole**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $27/30 = 0.90 = 90\\%$.\n\n**Why the wrong answers are tempting:**\n* B: copies the part.\n* C: $3/30$ (incorrect).\n* D: copies the difference.\n\n**Test Day Takeaway:** "Correctly answered" is part; "total questions" is whole.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'percent-of-a-whole', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-422', domain: 'problem-solving', skills: ['percent-of-value'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent of a Whole**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** Non-defective: $80 - 60 = 20$. $20/80 = 25\\%$.\n\n**Why the wrong answers are tempting:**\n* B: $P(\\text{defective})$.\n* C: $20$ unscaled.\n* D: copies the defective count.\n\n**Test Day Takeaway:** "NOT" → compute the complementary count first, then take percent.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'percent-of-a-whole', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-423', domain: 'problem-solving', skills: ['percent-of-value'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Percent of a Whole**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** "60% off" means the price is $100\\% - 60\\% = 40\\%$ of original.\n\n**Why the wrong answers are tempting:**\n* B: copies the discount.\n* C/D: random.\n\n**Test Day Takeaway:** "$X\\%$ off" leaves $(100 - X)\\%$ of the original.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'percent-of-a-whole', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-424', domain: 'problem-solving', skills: ['unit-conversion'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Proportion Ratio**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $12/3 = 4 \\times$ as many apples ⇒ $4 \\times \\$5 = \\$20$.\n\n**Why the wrong answers are tempting:**\n* B: multiplies the count by $5$.\n* C: adds $5 \\cdot 5$.\n* D: multiplies $12 \\times 5$.\n\n**Test Day Takeaway:** Find the SCALE between the known and unknown side ($12/3 = 4$), then multiply.',
  ...
  { id: 'bank-ps-425', domain: 'problem-solving', skills: ['unit-conversion'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Proportion Ratio**\n\n**Choice A is correct.**\n\n**The Fast Way (~20s):** $60 \\text{ mi/hr} \\times 5280 \\text{ ft/mi} \\div 3600 \\text{ s/hr} = 316800/3600 = 88$ ft/s.\n\n**Why the wrong answers are tempting:**\n* B: copies mph.\n* C: copies feet/mile.\n* D: half of mph.\n\n**Test Day Takeaway:** Chain conversion factors so units cancel — $mi/hr \\cdot ft/mi \\cdot hr/s = ft/s$.',
  ...
  { id: 'bank-ps-426', domain: 'problem-solving', skills: ['unit-conversion'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Proportion Ratio**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $20$ cups per pound, $\\times 10 = 200$.\n\n**Why the wrong answers are tempting:**\n* B: $80 \\times 4$.\n* C: $20 \\times 8$.\n* D: $10 \\times 5$.\n\n**Test Day Takeaway:** Find the per-unit rate first ($80/4 = 20$ cups/lb), then scale.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'proportion-ratio', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-427', domain: 'problem-solving', skills: ['unit-conversion'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Proportion Ratio**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $2$ cups / $12$ cookies $= x / 30 \\Rightarrow x = 60/12 = 5$.\n\n**Why the wrong answers are tempting:**\n* B: $30/5$.\n* C: $2 + 1$ (mis-arithmetic).\n* D: $30/2$.\n\n**Test Day Takeaway:** Cross-multiply: $a/b = c/d \\Rightarrow ad = bc$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'proportion-ratio', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-428', domain: 'problem-solving', skills: ['unit-conversion'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Proportion Ratio**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** Rate: $270/5 = 54$ mph. $54 \\times 8 = 432$.\n\n**Why the wrong answers are tempting:**\n* B: arithmetic slip.\n* C: $270 \\times 2$.\n* D: $54 \\times 4$.\n\n**Test Day Takeaway:** Distance $=$ rate $\\times$ time.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'proportion-ratio', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-429', domain: 'problem-solving', skills: ['unit-conversion'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Proportion Ratio**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $270/90 = 3 \\times$ as many pages ⇒ $3 \\times 12 = 36$ minutes.\n\n**Why the wrong answers are tempting:**\n* B/C/D: misapply the proportion.\n\n**Test Day Takeaway:** Scale time by the same factor as the work.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'proportion-ratio', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-430', domain: 'problem-solving', skills: ['calculate-mean', 'slope-intercept-form'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Residual**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $\\hat{y}(5) = 4(5) + 3 = 23$. Residual $= 28 - 23 = 5$.\n\n**Why the wrong answers are tempting:**\n* B: swaps order — gives $\\hat{y} - y$.\n* C: returns $\\hat{y}$.\n* D: returns the observed value.\n\n**Test Day Takeaway:** Residual $= $ actual $-$ predicted. Sign matters: positive means under-prediction.',
  ...
  { id: 'bank-ps-431', domain: 'problem-solving', skills: ['calculate-mean', 'slope-intercept-form'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Residual**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $\\hat{y}(3) = -2(3) + 10 = 4$. $y - \\hat{y} = 2 - 4 = -2$.\n\n**Why the wrong answers are tempting:**\n* B: drops the sign.\n* C: returns $\\hat{y}$.\n* D: returns $\\hat{y} - y$.\n\n**Test Day Takeaway:** Negative residual = observed value is BELOW the model\'s prediction.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'residual', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-432', domain: 'problem-solving', skills: ['calculate-mean', 'slope-intercept-form'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Residual**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $\\hat{y}(10) = 15 + 8 = 23$. $20 - 23 = -3$.\n\n**Why the wrong answers are tempting:**\n* B: drops the sign.\n* C: returns $\\hat{y}$.\n* D: drops the constant.\n\n**Test Day Takeaway:** Compute $\\hat{y}$ first, then subtract from the observed $y$.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'residual', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-445', domain: 'problem-solving', skills: ['percent-of-value', 'percent-word-problems'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Reverse Percent Multi-Step**\n\n**Choice A is correct.**\n\n**The Fast Way (~20s):** $1.10 \\times 1.08 \\times \\text{orig} = 59400 \\Rightarrow 1.188 \\times \\text{orig} = 59400 \\Rightarrow \\text{orig} = 50000$.\n\n**Why the wrong answers are tempting:**\n* B/C/D: subtract or misapply factors.\n\n**Test Day Takeaway:** Multiply the factors first, then divide the final.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'reverse-percent-multi-step', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-446', domain: 'problem-solving', skills: ['percent-of-value', 'percent-word-problems'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Reverse Percent Multi-Step**\n\n**Choice A is correct.**\n\n**The Fast Way (~15s):** $1.10^2 \\times \\text{orig} = 363 \\Rightarrow 1.21 \\times \\text{orig} = 363 \\Rightarrow \\text{orig} = 300$.\n\n**Why the wrong answers are tempting:**\n* B: $363/1.10$ (only one growth).\n* C/D: arithmetic slips.\n\n**Test Day Takeaway:** Two equal-rate periods → square the factor.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'reverse-percent-multi-step', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-447', domain: 'problem-solving', skills: ['percent-of-value', 'percent-word-problems'], difficulty: 'hard', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Reverse Percent Multi-Step**\n\n**Choice A is correct.**\n\n**The Fast Way (~20s):** $0.80 \\times 1.15 \\times \\text{orig} = 46 \\Rightarrow 0.92 \\times \\text{orig} = 46 \\Rightarrow \\text{orig} = 50$.\n\n**Why the wrong answers are tempting:**\n* B: $46 \\times 1.22$.\n* C: $46/0.96$.\n* D: copies the final.\n\n**Test Day Takeaway:** Discount THEN tax: multiply $(1 - d)(1 + t)$, then divide final by that.',
    calculatorAllowed: true, tags: [], sourceStyleRef: 'reverse-percent-multi-step', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-448', domain: 'problem-solving', skills: ['word-problem-to-equation'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Sum-of-Parts Ratio**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $3 + 5 = 8$ parts; each part $= 240/8 = 30$. Larger: $5 \\times 30 = 150$.\n\n**Why the wrong answers are tempting:**\n* B ($90$): smaller group.\n* C ($120$): half of $240$.\n* D: random.\n\n**Test Day Takeaway:** Divide the total by the SUM of ratio parts to find the per-part amount.',
  ...
  { id: 'bank-ps-449', domain: 'problem-solving', skills: ['word-problem-to-equation'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Sum-of-Parts Ratio**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $2 + 7 = 9$ parts; each $= 20$. Smaller: $2 \\times 20 = 40$.\n\n**Why the wrong answers are tempting:**\n* B: larger share.\n* C: half of $180$.\n* D: copies the per-part amount.\n\n**Test Day Takeaway:** Total parts $= $ sum of ratio numbers.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'sum-of-parts-ratio', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-450', domain: 'problem-solving', skills: ['word-problem-to-equation'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Sum-of-Parts Ratio**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $1 + 2 + 3 = 6$ parts; each $= 100$. Smallest: $1 \\times 100 = 100$.\n\n**Why the wrong answers are tempting:**\n* B/C: returns the other shares.\n* D: $600/4$.\n\n**Test Day Takeaway:** Three-way ratios still use the total-parts approach.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'sum-of-parts-ratio', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-451', domain: 'problem-solving', skills: ['word-problem-to-equation'], difficulty: 'medium', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Sum-of-Parts Ratio**\n\n**Choice A is correct.**\n\n**The Fast Way (~10s):** $9$ parts total; each $= 500$. Larger: $5 \\times 500 = 2500$.\n\n**Why the wrong answers are tempting:**\n* B: smaller share.\n* C: half of total.\n* D: random.\n\n**Test Day Takeaway:** "Larger share" → multiply the largest ratio number by the per-part amount.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'sum-of-parts-ratio', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
  ...
  { id: 'bank-ps-452', domain: 'problem-solving', skills: ['word-problem-to-equation'], difficulty: 'easy', type: 'multiple-choice',
    ...
    correctAnswer: 'A',
    explanation: '**SAT Pattern: Sum-of-Parts Ratio**\n\n**Choice A is correct.**\n\n**The Fast Way (~5s):** $5$ parts total; each $= 12$. Longer: $4 \\times 12 = 48$.\n\n**Why the wrong answers are tempting:**\n* B: shorter piece.\n* C/D: random.\n\n**Test Day Takeaway:** Cut into ratio $a : b$ means $a + b$ parts total.',
    calculatorAllowed: false, tags: [], sourceStyleRef: 'sum-of-parts-ratio', authoredBy: 'performsat-engine', createdAt: '2026-05-21' },
