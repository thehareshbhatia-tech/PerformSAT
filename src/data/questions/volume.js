...
export const volumeQuestions = {
  ...
  "Fundamentals": [
    {
      ...
      choices: [
        ...
        { id: "B", text: "$Square units (cm^2, m^2)$" },
        { id: "C", text: "$Cubic units (cm^3, m^3)$" },
        { id: "D", text: "No units" }
      ],
      correctAnswer: "C",
    ...
    },
    {
      ...
      choices: [
        { id: "A", text: "$V = lwh$" },
        { id: "B", text: "V = πr²h" },
        { id: "C", text: "$V = Bh (base area \times height)$" },
    ...
    },
    {
      ...
      choices: [
        { id: "A", text: "$2 cm^3$" },
        { id: "B", text: "$200 cm^3$" },
        { id: "C", text: "$2,000 cm^3$" },
        { id: "D", text: "$20,000 cm^3$" }
      ],
      correctAnswer: "C",
  ...
  "Cube": [
    ...
    },
    {
      ...
      correctAnswer: "A",
      hint: "To reverse $V = s^3$, take the cube root of the volume. What number cubed equals 125?",
  ...
  "Cylinder": [
    {
      ...
      correctAnswer: "C",
      hint: "Use $V = \pi r^2h$. First square the radius, then multiply by the height.",
    ...
    },
    {
      ...
      correctAnswer: "B",
      hint: "Rearrange $V = \pi r^2h$ to solve for h. Divide the volume by πr².",
    ...
    },
    {
      ...
      correctAnswer: "C",
      hint: "The glass is cylindrical. Apply $V = \pi r^2h$ with the given radius and water height.",
  ...
  "Sphere": [
    {
      ...
      correctAnswer: "B",
      hint: "Use $V = (4/3)\pi r^3$. Cube the radius first, then multiply by 4/3.",
    ...
    },
    {
      ...
      correctAnswer: "B",
      hint: "Set up the equation $(4/3)\pi r^3 = 288\pi$. Solve for r³ first, then take the cube root.",
    ...
    },
    {
      ...
      correctAnswer: "A",
      hint: "The radius is half the diameter. Then use $V = (4/3)\pi r^3$.",
    ...
    },
    {
      ...
      correctAnswer: "C",
      hint: "Since V involves $r^3$, think about what (3r)³ equals compared to $r^3$.",
    ...
    },
    {
      ...
      choices: [
        { id: "A", text: "$1,809 cm^3$" },
        { id: "B", text: "$7,235 cm^3$" },
        { id: "C", text: "$21,704 cm^3$" },
        { id: "D", text: "$28,939 cm^3$" }
      ],
      correctAnswer: "B",
  ...
  "Cone": [
    {
      ...
      correctAnswer: "A",
      hint: "A cone's volume is one-third of a cylinder with the same base and height. Use $V = (1/3)\pi r^2h$.",
    ...
    },
    {
      ...
      correctAnswer: "A",
      hint: "Apply $V = (1/3)\pi r^2h$. Square the radius first, then multiply by height and 1/3.",
    ...
    },
    {
      ...
      correctAnswer: "B",
      hint: "Use $V = (1/3)\pi r^2h$ to solve for $r^2$. Then take the square root to find r.",
    ...
    },
    {
      ...
      correctAnswer: "D",
      hint: "In $V = (1/3)\pi r^2h$, the radius is squared and appears once, height appears once. Count the total power of the scale factor.",
