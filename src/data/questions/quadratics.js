...
export const quadraticsQuestions = {
  ...
  "Overview": [
    ...
    },
    {
      id: 2,
      difficulty: "easy",
      question: "In the quadratic function $f(x) = 2x^2 - 4x + 7$, what is the value of 'a'?",
      choices: [
        { id: "A", text: "$-4$" },
        { id: "B", text: "2" },
        { id: "C", text: "7" },
      ...
      correctAnswer: "B",
      hint: "In standard form $f(x) = ax^2 + bx + c$, the coefficient 'a' is the number multiplying the x² term.",
    ...
    },
    {
      ...
      correctAnswer: "C",
      hint: "Think of the U-shaped curve you see when graphing $y = x^2$. This shape has a specific name in mathematics.",
    ...
    },
    {
      id: 4,
      difficulty: "medium",
      question: "If $a > 0$ in $f(x) = ax^2 + bx + c$, the parabola:",
      choices: [
    ...
    },
    {
      id: 5,
      difficulty: "hard",
      question: "What is the y-intercept of $f(x) = 3x^2 - 2x + 5$?",
      choices: [
        { id: "A", text: "3" },
        { id: "B", text: "$-2$" },
        { id: "C", text: "5" },
  ...
  "Roots": [
    ...
    },
    {
      id: 2,
      difficulty: "easy",
      question: "If $x = -4$ is a root of $x^2 + 7x + k = 0$, what is the value of k?",
      choices: [
        { id: "A", text: "$-12$" },
        { id: "B", text: "12" },
        { id: "C", text: "$-28$" },
    ...
    },
    {
      id: 3,
      difficulty: "medium",
      question: "The equation $x^2 - 9 = 0$ has roots at:",
      choices: [
        { id: "A", text: "$x = 9 only$" },
        { id: "B", text: "$x = 3 only$" },
      ...
      correctAnswer: "C",
      hint: "This is a difference of squares. Remember that $x^2 = 9$ has two solutions: one positive and one negative.",
    ...
    },
    {
      ...
      choices: [
        { id: "A", text: "$x^2 - 6x + 5 = 0$" },
        { id: "B", text: "$x^2 + 6x + 5 = 0$" },
        { id: "C", text: "$x^2 - 4x + 5 = 0$" },
        { id: "D", text: "$x^2 - 6x - 5 = 0$" }
      ],
      correctAnswer: "A",
    ...
    },
    {
      id: 5,
      difficulty: "hard",
      question: "For what value of x does $2x^2 - 8x = 0$?",
      choices: [
        { id: "A", text: "$x = 0 only$" },
        { id: "B", text: "$x = 4 only$" },
  ...
  "Vertex": [
    {
      id: 1,
      difficulty: "easy",
      question: "What is the x-coordinate of the vertex of $f(x) = x^2 - 6x + 5$?",
      choices: [
        { id: "A", text: "$-6$" },
        { id: "B", text: "$-3$" },
        { id: "C", text: "3" },
    ...
    },
    {
      id: 2,
      difficulty: "easy",
      question: "The vertex of $f(x) = (x - 2)^2 + 3$ is at:",
      choices: [
        { id: "A", text: "(2, 3)" },
        { id: "B", text: "$(-2, 3)$" },
        { id: "C", text: "$(2, -3)$" },
      ...
      correctAnswer: "A",
      hint: "This is already in vertex form $f(x) = a(x - h)^2 + k$. The vertex is at (h, k). Be careful with the sign inside the parentheses.",
    ...
    },
    {
      id: 3,
      difficulty: "medium",
      question: "For $f(x) = -2x^2 + 8x - 3$, does the vertex represent a maximum or minimum?",
      choices: [
      ...
      correctAnswer: "A",
      hint: "Look at the coefficient of $x^2$. If it's negative, the parabola opens downward, making the vertex the highest point.",
    ...
    },
    {
      id: 5,
      difficulty: "hard",
      question: "The axis of symmetry of $f(x) = 2x^2 + 12x - 5$ is:",
      choices: [
        { id: "A", text: "$x = 3$" },
        { id: "B", text: "$x = -3$" },
        { id: "C", text: "$x = 6$" },
  ...
  "Discriminant": [
    ...
    },
    {
      id: 3,
      difficulty: "medium",
      question: "How many x-intercepts does $y = x^2 + 2x + 5$ have?",
      choices: [
        { id: "A", text: "0" },
        { id: "B", text: "1" },
        { id: "C", text: "2" },
    ...
    },
    {
      id: 4,
      difficulty: "medium",
      question: "For what value of k does $x^2 + kx + 9 = 0$ have exactly one solution?",
      choices: [
        { id: "A", text: "$k = 3 only$" },
        { id: "B", text: "$k = 6 only$" },
        { id: "C", text: "k = ±6" },
      ...
      correctAnswer: "C",
      hint: "One solution means the discriminant equals zero. Set $b^2 - 4ac = 0$ and solve for k. Remember that k² has two square roots.",
    ...
    },
    {
      id: 5,
      difficulty: "hard",
      question: "The equation $2x^2 - 5x + 1 = 0$ has:",
      choices: [
  ...
  "Deriving Standard Form": [
    {
      id: 1,
      difficulty: "easy",
      question: "Convert $f(x) = (x + 3)^2 - 4$ to standard form.",
      choices: [
        { id: "A", text: "$f(x) = x^2 + 6x + 5$" },
        { id: "B", text: "$f(x) = x^2 + 6x + 9$" },
        { id: "C", text: "$f(x) = x^2 - 6x + 5$" },
        { id: "D", text: "$f(x) = x^2 + 3x - 4$" }
      ],
      correctAnswer: "A",
      hint: "Expand (x + 3)² using FOIL or the pattern $(a + b)^2 = a^2 + 2ab + b^2$, then combine with the -4.",
    ...
    },
    {
      id: 2,
      difficulty: "easy",
      question: "If a parabola has vertex (2, -1) and passes through (0, 3), what is the value of 'a' in $f(x) = a(x - 2)^2 - 1$?",
      choices: [
        { id: "A", text: "1" },
        { id: "B", text: "$-1$" },
        { id: "C", text: "2" },
    ...
    },
    {
      ...
      choices: [
        { id: "A", text: "$y = 2x^2 + 2x - 12$" },
        { id: "B", text: "$y = x^2 + x - 6$" },
        { id: "C", text: "$y = 2x^2 - 2x - 12$" },
        { id: "D", text: "$y = -2x^2 - 2x + 12$" }
      ],
      correctAnswer: "A",
    ...
    },
    {
      id: 5,
      difficulty: "hard",
      question: "Convert $f(x) = -2(x - 1)^2 + 8$ to standard form.",
      choices: [
        { id: "A", text: "$f(x) = -2x^2 + 4x + 6$" },
        { id: "B", text: "$f(x) = -2x^2 - 4x + 6$" },
        { id: "C", text: "$f(x) = -2x^2 + 4x - 6$" },
        { id: "D", text: "$f(x) = 2x^2 - 4x + 6$" }
      ],
      correctAnswer: "A",
