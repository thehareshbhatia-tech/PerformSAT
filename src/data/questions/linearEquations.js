...
export const linearEquationsQuestions = {
  ...
  "Deriving Equations": [
    ...
    },
    {
      ...
      skills: ['function-evaluation', 'slope-from-points', 'slope-intercept-form']
    },
    {
      id: 5,
      difficulty: "hard",
  ...
  "Parallel Lines": [
    {
      ...
      choices: [
        { id: "A", text: "y = -4x + 5" },
        { id: "B", text: "y = ", fraction: { numerator: "1", denominator: "4" }, textAfter: "x − 3" },
        { id: "C", text: "y = 4x + 7" },
        { id: "D", text: "y = −", fraction: { numerator: "1", denominator: "4" }, textAfter: "x + 2" }
      ],
      correctAnswer: "C",
    ...
    },
    {
      ...
      choices: [
        { id: "A", text: "y = 2x + 3" },
        { id: "B", text: "y = -2x + 5" },
        { id: "C", text: "y = ", fraction: { numerator: "1", denominator: "2" }, textAfter: "x − 1" },
      ...
      skills: ['parallel-line-slope', 'slope-intercept-form']
    },
    {
      id: 3,
      difficulty: "medium",
      ...
      choices: [
        ...
        { id: "B", text: "y = 3x - 2" },
        { id: "C", text: "y = -3x + 8" },
        { id: "D", text: "y = ", fraction: { numerator: "1", denominator: "3" }, textAfter: "x + 5" }
      ],
      correctAnswer: "A",
    ...
    },
    {
      ...
      skills: ['parallel-line-slope', 'system-solution-types']
    },
    {
      id: 5,
      difficulty: "hard",
      ...
      skills: ['slope-from-points', 'parallel-line-slope']
    }
  ],
