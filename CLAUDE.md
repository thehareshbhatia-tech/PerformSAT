...
|------------|-------|-------|
| Question banks (math + R&W) | `src/data/questions/bank/index.js` (math, **1252 hand-authored items** after the 2026-05-16 CB gap-closure batches v3.2 + v3.3) and `src/data/questions/rwBank/index.js` (R&W, 648 items, flattened from 12 test bundles) | Both production. Section-tag weakness contract dispatches by `weakness.section`. CB-skill coverage: **19 healthy / 0 thin / 0 empty** — every CB math skill meets the 20-item threshold (was 8/10/1 at the start of 2026-05-16). |
